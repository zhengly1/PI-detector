...
define dso_local noundef i32 @gsl_sf_bessel_asymp_Mnu_e(double noundef %0, double noundef %1, ptr nocapture noundef writeonly %2) local_unnamed_addr #0 !dbg !85 {
  ...
  %10 = fmul double %9, 1.250000e-01, !dbg !106
  tail call void @llvm.dbg.value(metadata double %10, metadata !96, metadata !DIExpression()), !dbg !99
  %11 = fdiv double 9.000000e+00, %7, !dbg !107
  %12 = fsub double %6, %11, !dbg !108
  %13 = fmul double %9, %12, !dbg !109
  %14 = fmul double %13, 3.000000e+00, !dbg !110
  %15 = fmul double %14, 7.812500e-03, !dbg !111
  tail call void @llvm.dbg.value(metadata double %15, metadata !97, metadata !DIExpression()), !dbg !99
  %16 = fadd double %10, 1.000000e+00, !dbg !112
  %17 = fadd double %16, %15, !dbg !113
  %18 = fmul double %17, 0x3FE45F306DC9C883, !dbg !114
  tail call void @llvm.dbg.value(metadata double %18, metadata !98, metadata !DIExpression()), !dbg !99
  %19 = tail call double @sqrt(double noundef %18) #4, !dbg !115
  %20 = tail call double @sqrt(double noundef %1) #4, !dbg !116
  %21 = fdiv double %19, %20, !dbg !117
  store double %21, ptr %2, align 8, !dbg !118, !tbaa !119
  ret i32 0, !dbg !123
}

; Function Attrs: mustprogress nofree nounwind willreturn memory(write)
declare !dbg !124 double @sqrt(double noundef) local_unnamed_addr #1

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write) uwtable
define dso_local noundef i32 @gsl_sf_bessel_asymp_thetanu_corr_e(double noundef %0, double noundef %1, ptr nocapture noundef writeonly %2) local_unnamed_addr #2 !dbg !128 {
  tail call void @llvm.dbg.value(metadata double %0, metadata !130, metadata !DIExpression()), !dbg !138
  tail call void @llvm.dbg.value(metadata double %1, metadata !131, metadata !DIExpression()), !dbg !138
  tail call void @llvm.dbg.value(metadata ptr %2, metadata !132, metadata !DIExpression()), !dbg !138
  %4 = fmul double %0, 2.000000e+00, !dbg !139
  %5 = fdiv double %4, %1, !dbg !140
  tail call void @llvm.dbg.value(metadata double %5, metadata !133, metadata !DIExpression()), !dbg !138
  %6 = fmul double %5, %5, !dbg !141
  tail call void @llvm.dbg.value(metadata double %6, metadata !134, metadata !DIExpression()), !dbg !138
  %7 = fmul double %1, %1, !dbg !142
  tail call void @llvm.dbg.value(metadata double %7, metadata !135, metadata !DIExpression()), !dbg !138
  %8 = fdiv double 1.000000e+00, %7, !dbg !143
  %9 = fsub double %6, %8, !dbg !144
  %10 = fmul double %9, %1, !dbg !145
  %11 = fmul double %10, 1.250000e-01, !dbg !146
  tail call void @llvm.dbg.value(metadata double %11, metadata !136, metadata !DIExpression()), !dbg !138
  %12 = fdiv double 2.500000e+01, %7, !dbg !147
  %13 = fsub double %6, %12, !dbg !148
  %14 = fmul double %13, %10, !dbg !149
  %15 = fdiv double %14, 3.840000e+02, !dbg !150
  tail call void @llvm.dbg.value(metadata double %15, metadata !137, metadata !DIExpression()), !dbg !138
  %16 = fadd double %11, 0xBFE921FB54442D18, !dbg !151
  %17 = fadd double %16, %15, !dbg !152
  store double %17, ptr %2, align 8, !dbg !153, !tbaa !119
  ret i32 0, !dbg !154
}
...
!105 = !DILocation(line: 170, column: 27, scope: !85)
!106 = !DILocation(line: 170, column: 35, scope: !85)
!107 = !DILocation(line: 171, column: 43, scope: !85)
!108 = !DILocation(line: 171, column: 39, scope: !85)
!109 = !DILocation(line: 171, column: 35, scope: !85)
!110 = !DILocation(line: 171, column: 47, scope: !85)
!111 = !DILocation(line: 171, column: 51, scope: !85)
!112 = !DILocation(line: 172, column: 43, scope: !85)
!113 = !DILocation(line: 172, column: 51, scope: !85)
!114 = !DILocation(line: 172, column: 36, scope: !85)
!115 = !DILocation(line: 173, column: 13, scope: !85)
!116 = !DILocation(line: 173, column: 26, scope: !85)
!117 = !DILocation(line: 173, column: 25, scope: !85)
!118 = !DILocation(line: 173, column: 11, scope: !85)
!119 = !{!120, !120, i64 0}
!120 = !{!"double", !121, i64 0}
!121 = !{!"omnipotent char", !122, i64 0}
!122 = !{!"Simple C/C++ TBAA"}
!123 = !DILocation(line: 174, column: 3, scope: !85)
!124 = !DISubprogram(name: "sqrt", scope: !125, file: !125, line: 143, type: !126, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized)
!125 = !DIFile(filename: "/usr/include/x86_64-linux-gnu/bits/mathcalls.h", directory: "", checksumkind: CSK_MD5, checksum: "12f0a7cb98f2ec572091728ebaf4a161")
!126 = !DISubroutineType(types: !127)
!127 = !{!54, !54}
!128 = distinct !DISubprogram(name: "gsl_sf_bessel_asymp_thetanu_corr_e", scope: !3, file: !3, line: 179, type: !86, scopeLine: 180, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !129)
!129 = !{!130, !131, !132, !133, !134, !135, !136, !137}
!130 = !DILocalVariable(name: "nu", arg: 1, scope: !128, file: !3, line: 179, type: !88)
!131 = !DILocalVariable(name: "x", arg: 2, scope: !128, file: !3, line: 179, type: !88)
!132 = !DILocalVariable(name: "result", arg: 3, scope: !128, file: !3, line: 179, type: !53)
!133 = !DILocalVariable(name: "r", scope: !128, file: !3, line: 181, type: !88)
!134 = !DILocalVariable(name: "r2", scope: !128, file: !3, line: 182, type: !88)
!135 = !DILocalVariable(name: "x2", scope: !128, file: !3, line: 183, type: !88)
!136 = !DILocalVariable(name: "term1", scope: !128, file: !3, line: 184, type: !88)
!137 = !DILocalVariable(name: "term2", scope: !128, file: !3, line: 185, type: !88)
!138 = !DILocation(line: 0, scope: !128)
!139 = !DILocation(line: 181, column: 24, scope: !128)
!140 = !DILocation(line: 181, column: 27, scope: !128)
!141 = !DILocation(line: 182, column: 22, scope: !128)
!142 = !DILocation(line: 183, column: 22, scope: !128)
!143 = !DILocation(line: 184, column: 35, scope: !128)
!144 = !DILocation(line: 184, column: 30, scope: !128)
!145 = !DILocation(line: 184, column: 25, scope: !128)
!146 = !DILocation(line: 184, column: 39, scope: !128)
!147 = !DILocation(line: 185, column: 50, scope: !128)
!148 = !DILocation(line: 185, column: 44, scope: !128)
!149 = !DILocation(line: 185, column: 39, scope: !128)
!150 = !DILocation(line: 185, column: 54, scope: !128)
!151 = !DILocation(line: 186, column: 25, scope: !128)
!152 = !DILocation(line: 186, column: 33, scope: !128)
!153 = !DILocation(line: 186, column: 11, scope: !128)
!154 = !DILocation(line: 187, column: 3, scope: !128)
