...
32:                                               ; preds = %23
  ...
  %34 = tail call double @gsl_coerce_double(double noundef %33) #6, !dbg !143
...
39:                                               ; preds = %32
  tail call void @gsl_error(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 57, i32 noundef 15) #6, !dbg !153
  br label %42, !dbg !153
...
40:                                               ; preds = %23
  ...
  tail call void @gsl_error(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, i32 noundef 61, i32 noundef 16) #6, !dbg !158
  br label %42, !dbg !158

42:                                               ; preds = %39, %40, %32, %18, %9
...
define dso_local noundef i32 @gsl_sf_multiply_err_e(double noundef %0, double noundef %1, double noundef %2, double noundef %3, ptr nocapture noundef %4) local_unnamed_addr #0 !dbg !171 {
  ...
  %11 = fadd double %8, %10, !dbg !188
  %12 = getelementptr inbounds %struct.gsl_sf_result_struct, ptr %4, i64 0, i32 1, !dbg !189
  %13 = load double, ptr %12, align 8, !dbg !190, !tbaa !120
  %14 = fadd double %11, %13, !dbg !190
  store double %14, ptr %12, align 8, !dbg !190, !tbaa !120
  ret i32 %6, !dbg !191
}

; Function Attrs: nounwind uwtable
define dso_local double @gsl_sf_multiply(double noundef %0, double noundef %1) local_unnamed_addr #0 !dbg !192 {
  %3 = alloca %struct.gsl_sf_result_struct, align 8, !DIAssignID !200
  call void @llvm.dbg.assign(metadata i1 undef, metadata !198, metadata !DIExpression(), metadata !200, metadata ptr %3, metadata !DIExpression()), !dbg !201
  tail call void @llvm.dbg.value(metadata double %0, metadata !196, metadata !DIExpression()), !dbg !201
  tail call void @llvm.dbg.value(metadata double %1, metadata !197, metadata !DIExpression()), !dbg !201
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %3) #6, !dbg !202
  %4 = call i32 @gsl_sf_multiply_e(double noundef %0, double noundef %1, ptr noundef nonnull %3), !dbg !202, !range !183
  tail call void @llvm.dbg.value(metadata i32 %4, metadata !199, metadata !DIExpression()), !dbg !201
  %5 = icmp eq i32 %4, 0, !dbg !203
  br i1 %5, label %7, label %6, !dbg !202

6:                                                ; preds = %2
  tail call void @gsl_error(ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.1, i32 noundef 84, i32 noundef %4) #6, !dbg !205
  br label %7, !dbg !205

7:                                                ; preds = %2, %6
  %8 = load double, ptr %3, align 8, !dbg !202, !tbaa !111
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %3) #6, !dbg !208
  ret double %8, !dbg !208
}
...
!188 = !DILocation(line: 73, column: 29, scope: !171)
!189 = !DILocation(line: 73, column: 11, scope: !171)
!190 = !DILocation(line: 73, column: 15, scope: !171)
!191 = !DILocation(line: 74, column: 3, scope: !171)
!192 = distinct !DISubprogram(name: "gsl_sf_multiply", scope: !2, file: !2, line: 82, type: !193, scopeLine: 83, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !22, retainedNodes: !195)
!193 = !DISubroutineType(types: !194)
!194 = !{!76, !75, !75}
!195 = !{!196, !197, !198, !199}
!196 = !DILocalVariable(name: "x", arg: 1, scope: !192, file: !2, line: 82, type: !75)
!197 = !DILocalVariable(name: "y", arg: 2, scope: !192, file: !2, line: 82, type: !75)
!198 = !DILocalVariable(name: "result", scope: !192, file: !2, line: 84, type: !78)
!199 = !DILocalVariable(name: "status", scope: !192, file: !2, line: 84, type: !26)
!200 = distinct !DIAssignID()
!201 = !DILocation(line: 0, scope: !192)
!202 = !DILocation(line: 84, column: 3, scope: !192)
!203 = !DILocation(line: 84, column: 3, scope: !204)
!204 = distinct !DILexicalBlock(scope: !192, file: !2, line: 84, column: 3)
!205 = !DILocation(line: 84, column: 3, scope: !206)
!206 = distinct !DILexicalBlock(scope: !207, file: !2, line: 84, column: 3)
!207 = distinct !DILexicalBlock(scope: !204, file: !2, line: 84, column: 3)
!208 = !DILocation(line: 85, column: 1, scope: !192)
