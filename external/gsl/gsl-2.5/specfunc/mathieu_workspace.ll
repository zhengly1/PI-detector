...
define dso_local noalias noundef ptr @gsl_sf_mathieu_alloc(i64 noundef %0, double noundef %1) local_unnamed_addr #0 !dbg !154 {
  ...
  %10 = tail call double @pow(double noundef %9, double noundef 3.700000e-01) #7, !dbg !174
...
15:                                               ; preds = %2
  tail call void @gsl_error(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 43, i32 noundef 4) #7, !dbg !181
  br label %85, !dbg !181

16:                                               ; preds = %2
  %17 = tail call noalias dereferenceable_or_null(128) ptr @malloc(i64 noundef 128) #8, !dbg !184
...
19:                                               ; preds = %16
  tail call void @gsl_error(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, i32 noundef 50, i32 noundef 8) #7, !dbg !188
  br label %85, !dbg !188
...
20:                                               ; preds = %16
  ...
  %29 = tail call noalias ptr @malloc(i64 noundef %28) #8, !dbg !214
...
32:                                               ; preds = %20
  tail call void @free(ptr noundef nonnull %17) #7, !dbg !221
  tail call void @gsl_error(ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.1, i32 noundef 68, i32 noundef 8) #7, !dbg !223
  br label %85, !dbg !223

33:                                               ; preds = %20
  %34 = tail call noalias ptr @malloc(i64 noundef %28) #8, !dbg !225
...
37:                                               ; preds = %33
  tail call void @free(ptr noundef nonnull %29) #7, !dbg !232
  tail call void @free(ptr noundef nonnull %17) #7, !dbg !234
  tail call void @gsl_error(ptr noundef nonnull @.str.4, ptr noundef nonnull @.str.1, i32 noundef 77, i32 noundef 8) #7, !dbg !235
  br label %85, !dbg !235

38:                                               ; preds = %33
  %39 = shl nuw nsw i64 %23, 3, !dbg !237
  %40 = tail call noalias ptr @malloc(i64 noundef %39) #8, !dbg !238
...
43:                                               ; preds = %38
  tail call void @free(ptr noundef nonnull %29) #7, !dbg !245
  tail call void @free(ptr noundef nonnull %34) #7, !dbg !247
  tail call void @free(ptr noundef nonnull %17) #7, !dbg !248
  tail call void @gsl_error(ptr noundef nonnull @.str.5, ptr noundef nonnull @.str.1, i32 noundef 89, i32 noundef 8) #7, !dbg !249
  br label %85, !dbg !249

44:                                               ; preds = %38
  %45 = tail call noalias ptr @malloc(i64 noundef %39) #8, !dbg !251
...
48:                                               ; preds = %44
  tail call void @free(ptr noundef nonnull %40) #7, !dbg !258
  tail call void @free(ptr noundef nonnull %29) #7, !dbg !260
  tail call void @free(ptr noundef nonnull %34) #7, !dbg !261
  tail call void @free(ptr noundef nonnull %17) #7, !dbg !262
  tail call void @gsl_error(ptr noundef nonnull @.str.5, ptr noundef nonnull @.str.1, i32 noundef 99, i32 noundef 8) #7, !dbg !263
  br label %85, !dbg !263
...
49:                                               ; preds = %44
  ...
  %53 = tail call noalias ptr @malloc(i64 noundef %52) #8, !dbg !268
...
56:                                               ; preds = %49
  tail call void @free(ptr noundef nonnull %45) #7, !dbg !275
  tail call void @free(ptr noundef nonnull %40) #7, !dbg !277
  tail call void @free(ptr noundef nonnull %29) #7, !dbg !278
  tail call void @free(ptr noundef nonnull %34) #7, !dbg !279
  tail call void @free(ptr noundef nonnull %17) #7, !dbg !280
  tail call void @gsl_error(ptr noundef nonnull @.str.5, ptr noundef nonnull @.str.1, i32 noundef 110, i32 noundef 8) #7, !dbg !281
  br label %85, !dbg !281

57:                                               ; preds = %49
  %58 = tail call noalias ptr @malloc(i64 noundef %39) #8, !dbg !283
...
61:                                               ; preds = %57
  tail call void @free(ptr noundef nonnull %53) #7, !dbg !290
  tail call void @free(ptr noundef nonnull %45) #7, !dbg !292
  tail call void @free(ptr noundef nonnull %40) #7, !dbg !293
  tail call void @free(ptr noundef nonnull %29) #7, !dbg !294
  tail call void @free(ptr noundef nonnull %34) #7, !dbg !295
  tail call void @free(ptr noundef nonnull %17) #7, !dbg !296
  tail call void @gsl_error(ptr noundef nonnull @.str.5, ptr noundef nonnull @.str.1, i32 noundef 122, i32 noundef 8) #7, !dbg !297
  br label %85, !dbg !297
...
62:                                               ; preds = %57
  ...
  %66 = tail call noalias ptr @malloc(i64 noundef %65) #8, !dbg !302
...
69:                                               ; preds = %62
  tail call void @free(ptr noundef nonnull %58) #7, !dbg !309
  tail call void @free(ptr noundef nonnull %53) #7, !dbg !311
  tail call void @free(ptr noundef nonnull %45) #7, !dbg !312
  tail call void @free(ptr noundef nonnull %40) #7, !dbg !313
  tail call void @free(ptr noundef nonnull %29) #7, !dbg !314
  tail call void @free(ptr noundef nonnull %34) #7, !dbg !315
  tail call void @free(ptr noundef nonnull %17) #7, !dbg !316
  tail call void @gsl_error(ptr noundef nonnull @.str.5, ptr noundef nonnull @.str.1, i32 noundef 135, i32 noundef 8) #7, !dbg !317
  br label %85, !dbg !317

70:                                               ; preds = %62
  %71 = tail call ptr @gsl_vector_alloc(i64 noundef %23) #7, !dbg !319
...
74:                                               ; preds = %70
  tail call void @free(ptr noundef nonnull %66) #7, !dbg !326
  tail call void @free(ptr noundef nonnull %58) #7, !dbg !328
  tail call void @free(ptr noundef nonnull %53) #7, !dbg !329
  tail call void @free(ptr noundef nonnull %45) #7, !dbg !330
  tail call void @free(ptr noundef nonnull %40) #7, !dbg !331
  tail call void @free(ptr noundef nonnull %29) #7, !dbg !332
  tail call void @free(ptr noundef nonnull %34) #7, !dbg !333
  tail call void @free(ptr noundef nonnull %17) #7, !dbg !334
  tail call void @gsl_error(ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.1, i32 noundef 150, i32 noundef 8) #7, !dbg !335
  br label %85, !dbg !335

75:                                               ; preds = %70
  %76 = tail call ptr @gsl_matrix_alloc(i64 noundef %23, i64 noundef %23) #7, !dbg !337
...
79:                                               ; preds = %75
  tail call void @gsl_vector_free(ptr noundef nonnull %71) #7, !dbg !344
  tail call void @free(ptr noundef nonnull %66) #7, !dbg !346
  tail call void @free(ptr noundef nonnull %58) #7, !dbg !347
  tail call void @free(ptr noundef nonnull %53) #7, !dbg !348
  tail call void @free(ptr noundef nonnull %45) #7, !dbg !349
  tail call void @free(ptr noundef nonnull %40) #7, !dbg !350
  tail call void @free(ptr noundef nonnull %29) #7, !dbg !351
  tail call void @free(ptr noundef nonnull %34) #7, !dbg !352
  tail call void @free(ptr noundef nonnull %17) #7, !dbg !353
  tail call void @gsl_error(ptr noundef nonnull @.str.7, ptr noundef nonnull @.str.1, i32 noundef 166, i32 noundef 8) #7, !dbg !354
  br label %85, !dbg !354

80:                                               ; preds = %75
  %81 = tail call ptr @gsl_eigen_symmv_alloc(i64 noundef %23) #7, !dbg !356
...
84:                                               ; preds = %80
  tail call void @gsl_matrix_free(ptr noundef nonnull %76) #7, !dbg !363
  tail call void @gsl_vector_free(ptr noundef nonnull %71) #7, !dbg !365
  tail call void @free(ptr noundef nonnull %66) #7, !dbg !366
  tail call void @free(ptr noundef nonnull %58) #7, !dbg !367
  tail call void @free(ptr noundef nonnull %53) #7, !dbg !368
  tail call void @free(ptr noundef nonnull %45) #7, !dbg !369
  tail call void @free(ptr noundef nonnull %40) #7, !dbg !370
  tail call void @free(ptr noundef nonnull %29) #7, !dbg !371
  tail call void @free(ptr noundef nonnull %34) #7, !dbg !372
  tail call void @free(ptr noundef nonnull %17) #7, !dbg !373
  tail call void @gsl_error(ptr noundef nonnull @.str.8, ptr noundef nonnull @.str.1, i32 noundef 183, i32 noundef 8) #7, !dbg !374
  br label %85, !dbg !374

85:                                               ; preds = %80, %84, %79, %74, %69, %61, %56, %48, %43, %37, %32, %19, %15
...
3:                                                ; preds = %1
  ...
  tail call void @gsl_vector_free(ptr noundef %5) #7, !dbg !418
  ...
  tail call void @gsl_matrix_free(ptr noundef %7) #7, !dbg !420
  ...
  tail call void @gsl_eigen_symmv_free(ptr noundef %9) #7, !dbg !422
  ...
  tail call void @free(ptr noundef %11) #7, !dbg !424
  ...
  tail call void @free(ptr noundef %13) #7, !dbg !426
  ...
  tail call void @free(ptr noundef %15) #7, !dbg !428
  ...
  tail call void @free(ptr noundef %17) #7, !dbg !430
  ...
  tail call void @free(ptr noundef %19) #7, !dbg !432
  ...
  tail call void @free(ptr noundef %21) #7, !dbg !434
  ...
  tail call void @free(ptr noundef %23) #7, !dbg !436
  tail call void @free(ptr noundef nonnull %0) #7, !dbg !437
  br label %24, !dbg !438
