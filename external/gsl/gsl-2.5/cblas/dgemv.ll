...
176:                                              ; preds = %173, %176
  ...
  %179 = phi double [ %210, %176 ], [ 0.000000e+00, %173 ]
  ...
  %186 = fadd double %179, %185, !dbg !184
  tail call void @llvm.dbg.value(metadata double %186, metadata !82, metadata !DIExpression()), !dbg !176
  ...
  tail call void @llvm.dbg.value(metadata double %186, metadata !82, metadata !DIExpression()), !dbg !176
  tail call void @llvm.dbg.value(metadata i64 %188, metadata !67, metadata !DIExpression()), !dbg !100
  %189 = getelementptr inbounds double, ptr %7, i64 %187, !dbg !179
  %190 = load double, ptr %189, align 8, !dbg !179, !tbaa !144
  %191 = getelementptr double, ptr %175, i64 %188, !dbg !182
  %192 = load double, ptr %191, align 8, !dbg !182, !tbaa !144
  %193 = fmul double %190, %192, !dbg !183
  %194 = fadd double %186, %193, !dbg !184
  tail call void @llvm.dbg.value(metadata double %194, metadata !82, metadata !DIExpression()), !dbg !176
  ...
  tail call void @llvm.dbg.value(metadata double %194, metadata !82, metadata !DIExpression()), !dbg !176
  tail call void @llvm.dbg.value(metadata i64 %196, metadata !67, metadata !DIExpression()), !dbg !100
  %197 = getelementptr inbounds double, ptr %7, i64 %195, !dbg !179
  %198 = load double, ptr %197, align 8, !dbg !179, !tbaa !144
  %199 = getelementptr double, ptr %175, i64 %196, !dbg !182
  %200 = load double, ptr %199, align 8, !dbg !182, !tbaa !144
  %201 = fmul double %198, %200, !dbg !183
  %202 = fadd double %194, %201, !dbg !184
  tail call void @llvm.dbg.value(metadata double %202, metadata !82, metadata !DIExpression()), !dbg !176
  ...
  tail call void @llvm.dbg.value(metadata double %202, metadata !82, metadata !DIExpression()), !dbg !176
  tail call void @llvm.dbg.value(metadata i64 %204, metadata !67, metadata !DIExpression()), !dbg !100
  %205 = getelementptr inbounds double, ptr %7, i64 %203, !dbg !179
  %206 = load double, ptr %205, align 8, !dbg !179, !tbaa !144
  %207 = getelementptr double, ptr %175, i64 %204, !dbg !182
  %208 = load double, ptr %207, align 8, !dbg !182, !tbaa !144
  %209 = fmul double %206, %208, !dbg !183
  %210 = fadd double %202, %209, !dbg !184
  tail call void @llvm.dbg.value(metadata double %210, metadata !82, metadata !DIExpression()), !dbg !176
...
215:                                              ; preds = %176, %173
  %216 = phi double [ undef, %173 ], [ %210, %176 ]
  %217 = phi i64 [ 0, %173 ], [ %212, %176 ]
  %218 = phi i64 [ %159, %173 ], [ %211, %176 ]
  %219 = phi double [ 0.000000e+00, %173 ], [ %210, %176 ]
  br i1 %169, label %235, label %220, !dbg !177

220:                                              ; preds = %215, %220
  %221 = phi i64 [ %232, %220 ], [ %217, %215 ]
  %222 = phi i64 [ %231, %220 ], [ %218, %215 ]
  %223 = phi double [ %230, %220 ], [ %219, %215 ]
  %224 = phi i64 [ %233, %220 ], [ 0, %215 ]
  tail call void @llvm.dbg.value(metadata i64 %222, metadata !86, metadata !DIExpression()), !dbg !176
  tail call void @llvm.dbg.value(metadata double %223, metadata !82, metadata !DIExpression()), !dbg !176
  tail call void @llvm.dbg.value(metadata i64 %221, metadata !67, metadata !DIExpression()), !dbg !100
  %225 = getelementptr inbounds double, ptr %7, i64 %222, !dbg !179
  %226 = load double, ptr %225, align 8, !dbg !179, !tbaa !144
  %227 = getelementptr double, ptr %175, i64 %221, !dbg !182
  %228 = load double, ptr %227, align 8, !dbg !182, !tbaa !144
  %229 = fmul double %226, %228, !dbg !183
  %230 = fadd double %223, %229, !dbg !184
  tail call void @llvm.dbg.value(metadata double %230, metadata !82, metadata !DIExpression()), !dbg !176
...
235:                                              ; preds = %215, %220, %170
  %236 = phi double [ 0.000000e+00, %170 ], [ %216, %215 ], [ %230, %220 ], !dbg !176
  %237 = fmul double %236, %4, !dbg !190
  %238 = getelementptr inbounds double, ptr %10, i64 %171, !dbg !191
  %239 = load double, ptr %238, align 8, !dbg !192, !tbaa !144
  %240 = fadd double %237, %239, !dbg !192
  store double %240, ptr %238, align 8, !dbg !192, !tbaa !144
...
271:                                              ; preds = %250, %314
  ...
  %274 = getelementptr inbounds double, ptr %7, i64 %273, !dbg !202
  %275 = load double, ptr %274, align 8, !dbg !202, !tbaa !144
  %276 = fmul double %275, %4, !dbg !203
  tail call void @llvm.dbg.value(metadata double %276, metadata !90, metadata !DIExpression()), !dbg !204
  %277 = fcmp oeq double %276, 0.000000e+00, !dbg !205
  %278 = or i1 %277, %259, !dbg !206
  br i1 %278, label %314, label %279, !dbg !206

279:                                              ; preds = %271
  %280 = mul nsw i64 %272, %264
  %281 = getelementptr double, ptr %5, i64 %280, !dbg !207
...
282:                                              ; preds = %279, %282
  ...
  %286 = getelementptr double, ptr %281, i64 %283, !dbg !210
  %287 = load double, ptr %286, align 8, !dbg !210, !tbaa !144
  %288 = fmul double %276, %287, !dbg !213
  %289 = getelementptr inbounds double, ptr %10, i64 %284, !dbg !214
  %290 = load double, ptr %289, align 8, !dbg !215, !tbaa !144
  %291 = fadd double %290, %288, !dbg !215
  store double %291, ptr %289, align 8, !dbg !215, !tbaa !144
  ...
  tail call void @llvm.dbg.value(metadata i64 %292, metadata !94, metadata !DIExpression()), !dbg !209
  tail call void @llvm.dbg.value(metadata i64 %293, metadata !64, metadata !DIExpression()), !dbg !100
  %294 = getelementptr double, ptr %281, i64 %293, !dbg !210
  %295 = load double, ptr %294, align 8, !dbg !210, !tbaa !144
  %296 = fmul double %276, %295, !dbg !213
  %297 = getelementptr inbounds double, ptr %10, i64 %292, !dbg !214
  %298 = load double, ptr %297, align 8, !dbg !215, !tbaa !144
  %299 = fadd double %298, %296, !dbg !215
  store double %299, ptr %297, align 8, !dbg !215, !tbaa !144
...
307:                                              ; preds = %304
  ...
  %308 = getelementptr double, ptr %281, i64 %305, !dbg !210
  %309 = load double, ptr %308, align 8, !dbg !210, !tbaa !144
  %310 = fmul double %276, %309, !dbg !213
  %311 = getelementptr inbounds double, ptr %10, i64 %306, !dbg !214
  %312 = load double, ptr %311, align 8, !dbg !215, !tbaa !144
  %313 = fadd double %312, %310, !dbg !215
  store double %313, ptr %311, align 8, !dbg !215, !tbaa !144
