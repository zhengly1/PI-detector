...
define dso_local void @cblas_zscal(i32 noundef %0, ptr nocapture noundef readonly %1, ptr nocapture noundef %2, i32 noundef %3) local_unnamed_addr #0 !dbg !15 {
  ...
  br i1 %10, label %11, label %32, !dbg !50
...
13:                                               ; preds = %13, %11
  ...
  %handler_result = call double @fSubHandlerDouble(double %25, double %26), !dbg !57
  store double %handler_result, ptr %19, align 8, !dbg !57, !tbaa !43
  %27 = fmul double %7, %20, !dbg !58
  %28 = fmul double %5, %24, !dbg !59
  %handler_result1 = call double @fAddHandlerDouble(double %27, double %28), !dbg !60
  store double %handler_result1, ptr %23, align 8, !dbg !60, !tbaa !43
  %29 = add nuw nsw i64 %14, %12, !dbg !61
  tail call void @llvm.dbg.value(metadata i64 %29, metadata !32, metadata !DIExpression()), !dbg !41
  %30 = add nuw nsw i32 %15, 1, !dbg !62
  tail call void @llvm.dbg.value(metadata i32 %30, metadata !28, metadata !DIExpression()), !dbg !41
  %31 = icmp eq i32 %30, %0, !dbg !63
  br i1 %31, label %32, label %13, !dbg !51, !llvm.loop !64
