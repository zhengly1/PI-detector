...
78:                                               ; preds = %76, %78
  ...
  tail call void @llvm.dbg.value(metadata double %89, metadata !84, metadata !DIExpression()), !dbg !148
  %90 = fmul double %72, %85, !dbg !150
  %91 = fmul double %75, %89, !dbg !151
  %92 = fsub double %90, %91, !dbg !152
  %93 = add i64 %80, %77, !dbg !153
  %94 = trunc i64 %93 to i32, !dbg !153
  %95 = shl nsw i32 %94, 1, !dbg !153
  %96 = sext i32 %95 to i64, !dbg !153
  %97 = getelementptr inbounds double, ptr %8, i64 %96, !dbg !153
  %98 = load double, ptr %97, align 8, !dbg !154, !tbaa !125
  %99 = fadd double %98, %92, !dbg !154
  store double %99, ptr %97, align 8, !dbg !154, !tbaa !125
  %100 = fmul double %72, %89, !dbg !155
  %101 = fmul double %75, %85, !dbg !156
  %102 = fadd double %101, %100, !dbg !157
  %103 = or disjoint i32 %95, 1, !dbg !158
  %104 = sext i32 %103 to i64, !dbg !158
  %105 = getelementptr inbounds double, ptr %8, i64 %104, !dbg !158
  %106 = load double, ptr %105, align 8, !dbg !159, !tbaa !125
  %107 = fadd double %102, %106, !dbg !159
  store double %107, ptr %105, align 8, !dbg !159, !tbaa !125
...
136:                                              ; preds = %119, %189
  ...
  %142 = getelementptr inbounds double, ptr %6, i64 %141, !dbg !176
  %143 = load double, ptr %142, align 8, !dbg !176, !tbaa !125
  tail call void @llvm.dbg.value(metadata double %143, metadata !88, metadata !DIExpression()), !dbg !177
  %144 = or disjoint i32 %140, 1, !dbg !178
  %145 = sext i32 %144 to i64, !dbg !178
  %146 = getelementptr inbounds double, ptr %6, i64 %145, !dbg !178
  %147 = load double, ptr %146, align 8, !dbg !178, !tbaa !125
  tail call void @llvm.dbg.value(metadata double %147, metadata !92, metadata !DIExpression()), !dbg !177
  %148 = fmul double %36, %143, !dbg !179
  %149 = fmul double %38, %147, !dbg !180
  %150 = fsub double %148, %149, !dbg !181
  tail call void @llvm.dbg.value(metadata double %150, metadata !93, metadata !DIExpression()), !dbg !177
  %151 = fmul double %38, %143, !dbg !182
  %152 = fmul double %36, %147, !dbg !183
  %153 = fadd double %151, %152, !dbg !184
  tail call void @llvm.dbg.value(metadata double %153, metadata !94, metadata !DIExpression()), !dbg !177
...
156:                                              ; preds = %154, %156
  ...
  %162 = getelementptr inbounds double, ptr %4, i64 %161, !dbg !186
  %163 = load double, ptr %162, align 8, !dbg !186, !tbaa !125
  tail call void @llvm.dbg.value(metadata double %163, metadata !96, metadata !DIExpression()), !dbg !187
  %164 = or disjoint i32 %160, 1, !dbg !188
  %165 = sext i32 %164 to i64, !dbg !188
  %166 = getelementptr inbounds double, ptr %4, i64 %165, !dbg !188
  %167 = load double, ptr %166, align 8, !dbg !188, !tbaa !125
  tail call void @llvm.dbg.value(metadata double %167, metadata !100, metadata !DIExpression()), !dbg !187
  %168 = fmul double %150, %163, !dbg !189
  %169 = fmul double %153, %167, !dbg !190
  %170 = fsub double %168, %169, !dbg !191
  %171 = add i64 %158, %155, !dbg !192
  %172 = trunc i64 %171 to i32, !dbg !192
  %173 = shl nsw i32 %172, 1, !dbg !192
  %174 = sext i32 %173 to i64, !dbg !192
  %175 = getelementptr inbounds double, ptr %8, i64 %174, !dbg !192
  %176 = load double, ptr %175, align 8, !dbg !193, !tbaa !125
  %177 = fadd double %176, %170, !dbg !193
  store double %177, ptr %175, align 8, !dbg !193, !tbaa !125
  %178 = fmul double %150, %167, !dbg !194
  %179 = fmul double %153, %163, !dbg !195
  %180 = fadd double %179, %178, !dbg !196
  %181 = or disjoint i32 %173, 1, !dbg !197
  %182 = sext i32 %181 to i64, !dbg !197
  %183 = getelementptr inbounds double, ptr %8, i64 %182, !dbg !197
  %184 = load double, ptr %183, align 8, !dbg !198, !tbaa !125
  %185 = fadd double %180, %184, !dbg !198
  store double %185, ptr %183, align 8, !dbg !198, !tbaa !125
