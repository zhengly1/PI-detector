...
71:                                               ; preds = %67, %71
  ...
  %74 = phi double [ 0.000000e+00, %67 ], [ %80, %71 ]
  ...
  %80 = fadd double %74, %79, !dbg !164
  tail call void @llvm.dbg.value(metadata double %80, metadata !82, metadata !DIExpression()), !dbg !150
...
84:                                               ; preds = %71, %59
  %85 = phi double [ 0.000000e+00, %59 ], [ %80, %71 ], !dbg !150
  %86 = getelementptr inbounds double, ptr %7, i64 %60, !dbg !170
  %87 = load double, ptr %86, align 8, !dbg !170, !tbaa !158
...
88:                                               ; preds = %84
  ...
  %92 = getelementptr inbounds double, ptr %5, i64 %91, !dbg !175
  %93 = load double, ptr %92, align 8, !dbg !175, !tbaa !158
  %94 = fmul double %87, %93, !dbg !176
  br label %95, !dbg !177

95:                                               ; preds = %84, %88
  %96 = phi double [ %94, %88 ], [ %87, %84 ]
  %97 = fadd double %85, %96, !dbg !170
  store double %97, ptr %86, align 8, !dbg !170, !tbaa !158
...
123:                                              ; preds = %107, %210
  ...
  tail call void @llvm.dbg.value(metadata double 0.000000e+00, metadata !92, metadata !DIExpression()), !dbg !190
  %129 = icmp ugt i64 %125, 1, !dbg !191
  br i1 %129, label %130, label %198, !dbg !194

130:                                              ; preds = %123
  %131 = mul nsw i64 %128, %122
  %132 = getelementptr double, ptr %5, i64 %131, !dbg !194
...
138:                                              ; preds = %138, %136
  ...
  %141 = phi double [ 0.000000e+00, %136 ], [ %172, %138 ]
  ...
  tail call void @llvm.dbg.value(metadata double %141, metadata !92, metadata !DIExpression()), !dbg !190
  %143 = getelementptr inbounds double, ptr %7, i64 %139, !dbg !195
  %144 = load double, ptr %143, align 8, !dbg !195, !tbaa !158
  %145 = getelementptr double, ptr %132, i64 %140, !dbg !197
  %146 = load double, ptr %145, align 8, !dbg !197, !tbaa !158
  %147 = fmul double %144, %146, !dbg !198
  %148 = fadd double %141, %147, !dbg !199
  tail call void @llvm.dbg.value(metadata double %148, metadata !92, metadata !DIExpression()), !dbg !190
  ...
  tail call void @llvm.dbg.value(metadata i64 %149, metadata !98, metadata !DIExpression()), !dbg !190
  tail call void @llvm.dbg.value(metadata double %148, metadata !92, metadata !DIExpression()), !dbg !190
  %151 = getelementptr inbounds double, ptr %7, i64 %149, !dbg !195
  %152 = load double, ptr %151, align 8, !dbg !195, !tbaa !158
  %153 = getelementptr double, ptr %132, i64 %150, !dbg !197
  %154 = load double, ptr %153, align 8, !dbg !197, !tbaa !158
  %155 = fmul double %152, %154, !dbg !198
  %156 = fadd double %148, %155, !dbg !199
  tail call void @llvm.dbg.value(metadata double %156, metadata !92, metadata !DIExpression()), !dbg !190
  ...
  tail call void @llvm.dbg.value(metadata i64 %157, metadata !98, metadata !DIExpression()), !dbg !190
  tail call void @llvm.dbg.value(metadata double %156, metadata !92, metadata !DIExpression()), !dbg !190
  %159 = getelementptr inbounds double, ptr %7, i64 %157, !dbg !195
  %160 = load double, ptr %159, align 8, !dbg !195, !tbaa !158
  %161 = getelementptr double, ptr %132, i64 %158, !dbg !197
  %162 = load double, ptr %161, align 8, !dbg !197, !tbaa !158
  %163 = fmul double %160, %162, !dbg !198
  %164 = fadd double %156, %163, !dbg !199
  tail call void @llvm.dbg.value(metadata double %164, metadata !92, metadata !DIExpression()), !dbg !190
  ...
  tail call void @llvm.dbg.value(metadata i64 %165, metadata !98, metadata !DIExpression()), !dbg !190
  tail call void @llvm.dbg.value(metadata double %164, metadata !92, metadata !DIExpression()), !dbg !190
  %167 = getelementptr inbounds double, ptr %7, i64 %165, !dbg !195
  %168 = load double, ptr %167, align 8, !dbg !195, !tbaa !158
  %169 = getelementptr double, ptr %132, i64 %166, !dbg !197
  %170 = load double, ptr %169, align 8, !dbg !197, !tbaa !158
  %171 = fmul double %168, %170, !dbg !198
  %172 = fadd double %164, %171, !dbg !199
  tail call void @llvm.dbg.value(metadata double %172, metadata !92, metadata !DIExpression()), !dbg !190
...
177:                                              ; preds = %138, %130
  %178 = phi double [ undef, %130 ], [ %172, %138 ]
  %179 = phi i64 [ %118, %130 ], [ %173, %138 ]
  %180 = phi i64 [ 0, %130 ], [ %174, %138 ]
  %181 = phi double [ 0.000000e+00, %130 ], [ %172, %138 ]
...
183:                                              ; preds = %177, %183
  ...
  %186 = phi double [ %193, %183 ], [ %181, %177 ]
  ...
  tail call void @llvm.dbg.value(metadata double %186, metadata !92, metadata !DIExpression()), !dbg !190
  %188 = getelementptr inbounds double, ptr %7, i64 %184, !dbg !195
  %189 = load double, ptr %188, align 8, !dbg !195, !tbaa !158
  %190 = getelementptr double, ptr %132, i64 %185, !dbg !197
  %191 = load double, ptr %190, align 8, !dbg !197, !tbaa !158
  %192 = fmul double %189, %191, !dbg !198
  %193 = fadd double %186, %192, !dbg !199
  tail call void @llvm.dbg.value(metadata double %193, metadata !92, metadata !DIExpression()), !dbg !190
...
198:                                              ; preds = %177, %183, %123
  %199 = phi double [ 0.000000e+00, %123 ], [ %178, %177 ], [ %193, %183 ], !dbg !190
  %200 = sext i32 %127 to i64, !dbg !206
  %201 = getelementptr inbounds double, ptr %7, i64 %200, !dbg !206
  %202 = load double, ptr %201, align 8, !dbg !206, !tbaa !158
...
203:                                              ; preds = %198
  ...
  %207 = getelementptr inbounds double, ptr %5, i64 %206, !dbg !211
  %208 = load double, ptr %207, align 8, !dbg !211, !tbaa !158
  %209 = fmul double %202, %208, !dbg !212
  br label %210, !dbg !213

210:                                              ; preds = %198, %203
  %211 = phi double [ %209, %203 ], [ %202, %198 ]
  %212 = fadd double %199, %211, !dbg !206
  store double %212, ptr %201, align 8, !dbg !206, !tbaa !158
...
241:                                              ; preds = %224, %305
  ...
  tail call void @llvm.dbg.value(metadata i32 0, metadata !74, metadata !DIExpression()), !dbg !121
  tail call void @llvm.dbg.value(metadata double 0.000000e+00, metadata !102, metadata !DIExpression()), !dbg !228
  %247 = icmp ugt i64 %243, 1, !dbg !229
  br i1 %247, label %248, label %293, !dbg !232

248:                                              ; preds = %241
  %249 = getelementptr double, ptr %5, i64 %246, !dbg !232
...
254:                                              ; preds = %254, %252
  ...
  %257 = phi double [ 0.000000e+00, %252 ], [ %274, %254 ]
  ...
  tail call void @llvm.dbg.value(metadata double %257, metadata !102, metadata !DIExpression()), !dbg !228
  %259 = getelementptr inbounds double, ptr %7, i64 %255, !dbg !233
  %260 = load double, ptr %259, align 8, !dbg !233, !tbaa !158
  %261 = mul nsw i64 %256, %235, !dbg !235
  %262 = getelementptr double, ptr %249, i64 %261, !dbg !236
  %263 = load double, ptr %262, align 8, !dbg !236, !tbaa !158
  %264 = fmul double %260, %263, !dbg !237
  %265 = fadd double %257, %264, !dbg !238
  tail call void @llvm.dbg.value(metadata double %265, metadata !102, metadata !DIExpression()), !dbg !228
  ...
  tail call void @llvm.dbg.value(metadata i64 %266, metadata !108, metadata !DIExpression()), !dbg !228
  tail call void @llvm.dbg.value(metadata double %265, metadata !102, metadata !DIExpression()), !dbg !228
  %268 = getelementptr inbounds double, ptr %7, i64 %266, !dbg !233
  %269 = load double, ptr %268, align 8, !dbg !233, !tbaa !158
  %270 = mul nsw i64 %267, %235, !dbg !235
  %271 = getelementptr double, ptr %249, i64 %270, !dbg !236
  %272 = load double, ptr %271, align 8, !dbg !236, !tbaa !158
  %273 = fmul double %269, %272, !dbg !237
  %274 = fadd double %265, %273, !dbg !238
  tail call void @llvm.dbg.value(metadata double %274, metadata !102, metadata !DIExpression()), !dbg !228
...
279:                                              ; preds = %254, %248
  %280 = phi double [ undef, %248 ], [ %274, %254 ]
  %281 = phi i64 [ %236, %248 ], [ %275, %254 ]
  %282 = phi i64 [ 0, %248 ], [ %276, %254 ]
  %283 = phi double [ 0.000000e+00, %248 ], [ %274, %254 ]
...
285:                                              ; preds = %279
  ...
  tail call void @llvm.dbg.value(metadata double %283, metadata !102, metadata !DIExpression()), !dbg !228
  %286 = getelementptr inbounds double, ptr %7, i64 %281, !dbg !233
  %287 = load double, ptr %286, align 8, !dbg !233, !tbaa !158
  %288 = mul nsw i64 %282, %235, !dbg !235
  %289 = getelementptr double, ptr %249, i64 %288, !dbg !236
  %290 = load double, ptr %289, align 8, !dbg !236, !tbaa !158
  %291 = fmul double %287, %290, !dbg !237
  %292 = fadd double %283, %291, !dbg !238
  tail call void @llvm.dbg.value(metadata double %292, metadata !102, metadata !DIExpression()), !dbg !228
...
293:                                              ; preds = %285, %279, %241
  %294 = phi double [ 0.000000e+00, %241 ], [ %280, %279 ], [ %292, %285 ], !dbg !228
  %295 = sext i32 %245 to i64, !dbg !243
  %296 = getelementptr inbounds double, ptr %7, i64 %295, !dbg !243
  %297 = load double, ptr %296, align 8, !dbg !243, !tbaa !158
...
298:                                              ; preds = %293
  ...
  %302 = getelementptr inbounds double, ptr %5, i64 %301, !dbg !248
  %303 = load double, ptr %302, align 8, !dbg !248, !tbaa !158
  %304 = fmul double %297, %303, !dbg !249
  br label %305, !dbg !250

305:                                              ; preds = %293, %298
  %306 = phi double [ %304, %298 ], [ %297, %293 ]
  %307 = fadd double %294, %306, !dbg !243
  store double %307, ptr %296, align 8, !dbg !243, !tbaa !158
...
328:                                              ; preds = %317, %364
  ...
  tail call void @llvm.dbg.value(metadata double 0.000000e+00, metadata !112, metadata !DIExpression()), !dbg !260
...
336:                                              ; preds = %328
  ...
  %338 = getelementptr double, ptr %5, i64 %330, !dbg !265
  br label %339, !dbg !265

339:                                              ; preds = %336, %339
  %340 = phi i64 [ %331, %336 ], [ %351, %339 ]
  %341 = phi i64 [ %337, %336 ], [ %350, %339 ]
  %342 = phi double [ 0.000000e+00, %336 ], [ %349, %339 ]
  ...
  tail call void @llvm.dbg.value(metadata double %342, metadata !112, metadata !DIExpression()), !dbg !260
  %343 = getelementptr inbounds double, ptr %7, i64 %341, !dbg !266
  %344 = load double, ptr %343, align 8, !dbg !266, !tbaa !158
  %345 = mul nsw i64 %340, %324, !dbg !268
  %346 = getelementptr double, ptr %338, i64 %345, !dbg !269
  %347 = load double, ptr %346, align 8, !dbg !269, !tbaa !158
  %348 = fmul double %344, %347, !dbg !270
  %349 = fadd double %342, %348, !dbg !271
  tail call void @llvm.dbg.value(metadata double %349, metadata !112, metadata !DIExpression()), !dbg !260
...
353:                                              ; preds = %339, %328
  %354 = phi double [ 0.000000e+00, %328 ], [ %349, %339 ], !dbg !260
  %355 = getelementptr inbounds double, ptr %7, i64 %329, !dbg !276
  %356 = load double, ptr %355, align 8, !dbg !276, !tbaa !158
...
357:                                              ; preds = %353
  ...
  %361 = getelementptr inbounds double, ptr %5, i64 %360, !dbg !281
  %362 = load double, ptr %361, align 8, !dbg !281, !tbaa !158
  %363 = fmul double %356, %362, !dbg !282
  br label %364, !dbg !283

364:                                              ; preds = %353, %357
  %365 = phi double [ %363, %357 ], [ %356, %353 ]
  %366 = fadd double %354, %365, !dbg !276
  store double %366, ptr %355, align 8, !dbg !276, !tbaa !158
