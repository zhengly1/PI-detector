...
define dso_local void @cblas_dsyr(i32 noundef %0, i32 noundef %1, i32 noundef %2, double noundef %3, ptr nocapture noundef readonly %4, i32 noundef %5, ptr nocapture noundef %6, i32 noundef %7) local_unnamed_addr #0 !dbg !39 {
  ...
  tail call void @llvm.dbg.value(metadata double %3, metadata !54, metadata !DIExpression()), !dbg !81
...
24:                                               ; preds = %23, %8
  ...
  br i1 %27, label %134, label %28, !dbg !98
...
32:                                               ; preds = %28
  ...
  br i1 %35, label %36, label %70, !dbg !102
...
36:                                               ; preds = %32, %28
  ...
  br i1 %37, label %38, label %134, !dbg !106
...
47:                                               ; preds = %66, %38
  %48 = phi i64 [ 0, %38 ], [ %68, %66 ]
  %49 = phi i64 [ %43, %38 ], [ %67, %66 ]
  ...
  %50 = getelementptr inbounds double, ptr %4, i64 %49, !dbg !108
  %51 = load double, ptr %50, align 8, !dbg !108, !tbaa !109
  %52 = fmul double %51, %3, !dbg !113
  tail call void @llvm.dbg.value(metadata double %52, metadata !68, metadata !DIExpression()), !dbg !114
  ...
  %54 = getelementptr double, ptr %6, i64 %53, !dbg !115
  br label %55, !dbg !115

55:                                               ; preds = %55, %47
  %56 = phi i64 [ %48, %47 ], [ %64, %55 ]
  %57 = phi i64 [ %49, %47 ], [ %63, %55 ]
  ...
  %58 = getelementptr inbounds double, ptr %4, i64 %57, !dbg !117
  %59 = load double, ptr %58, align 8, !dbg !117, !tbaa !109
  %60 = fmul double %52, %59, !dbg !120
  %61 = getelementptr double, ptr %54, i64 %56, !dbg !121
  %62 = load double, ptr %61, align 8, !dbg !122, !tbaa !109
  %handler_result = call double @fAddHandlerDouble(double %62, double %60), !dbg !122
  store double %handler_result, ptr %61, align 8, !dbg !122, !tbaa !109
  %63 = add i64 %57, %44, !dbg !123
  tail call void @llvm.dbg.value(metadata i64 %63, metadata !72, metadata !DIExpression()), !dbg !114
  %64 = add nuw nsw i64 %56, 1, !dbg !124
  tail call void @llvm.dbg.value(metadata i64 %64, metadata !62, metadata !DIExpression()), !dbg !104
  %65 = icmp eq i64 %64, %46, !dbg !125
  br i1 %65, label %66, label %55, !dbg !115, !llvm.loop !126

66:                                               ; preds = %55
  %67 = add i64 %49, %44, !dbg !129
  tail call void @llvm.dbg.value(metadata i64 %67, metadata !65, metadata !DIExpression()), !dbg !103
  %68 = add nuw nsw i64 %48, 1, !dbg !130
  tail call void @llvm.dbg.value(metadata i64 %68, metadata !59, metadata !DIExpression()), !dbg !104
  %69 = icmp eq i64 %68, %46, !dbg !105
  br i1 %69, label %134, label %47, !dbg !106, !llvm.loop !131

70:                                               ; preds = %32
  %71 = and i1 %29, %34, !dbg !133
  %72 = and i1 %33, %30
  %73 = or i1 %71, %72, !dbg !133
  br i1 %73, label %74, label %133, !dbg !133

74:                                               ; preds = %70
  tail call void @llvm.dbg.value(metadata i32 poison, metadata !73, metadata !DIExpression()), !dbg !134
  tail call void @llvm.dbg.value(metadata i32 0, metadata !59, metadata !DIExpression()), !dbg !104
  %75 = icmp sgt i32 %2, 0, !dbg !135
  br i1 %75, label %76, label %134, !dbg !136

76:                                               ; preds = %74
  %77 = icmp sgt i32 %5, 0, !dbg !137
  %78 = sub nsw i32 1, %2, !dbg !137
  %79 = mul i32 %78, %5, !dbg !137
  %80 = select i1 %77, i32 0, i32 %79, !dbg !137
  tail call void @llvm.dbg.value(metadata i32 %80, metadata !73, metadata !DIExpression()), !dbg !134
  %81 = sext i32 %80 to i64, !dbg !136
  %82 = sext i32 %5 to i64, !dbg !136
  %83 = sext i32 %7 to i64, !dbg !136
  %84 = zext nneg i32 %2 to i64, !dbg !135
  br label %85, !dbg !136

85:                                               ; preds = %128, %76
  %86 = phi i64 [ %81, %76 ], [ %129, %128 ]
  %87 = phi i64 [ 0, %76 ], [ %130, %128 ]
  %88 = phi i64 [ 1, %76 ], [ %131, %128 ]
  tail call void @llvm.dbg.value(metadata i64 %87, metadata !59, metadata !DIExpression()), !dbg !104
  tail call void @llvm.dbg.value(metadata i64 %86, metadata !73, metadata !DIExpression()), !dbg !134
  %89 = getelementptr inbounds double, ptr %4, i64 %86, !dbg !138
  %90 = load double, ptr %89, align 8, !dbg !138, !tbaa !109
  %91 = fmul double %90, %3, !dbg !139
  tail call void @llvm.dbg.value(metadata double %91, metadata !76, metadata !DIExpression()), !dbg !140
  ...
  %92 = mul nsw i64 %87, %83
  tail call void @llvm.dbg.value(metadata i32 poison, metadata !80, metadata !DIExpression()), !dbg !140
  tail call void @llvm.dbg.value(metadata i32 0, metadata !62, metadata !DIExpression()), !dbg !104
  %93 = getelementptr double, ptr %6, i64 %92, !dbg !141
  %94 = and i64 %88, 1, !dbg !141
  %95 = icmp eq i64 %87, 0, !dbg !141
  br i1 %95, label %118, label %96, !dbg !141

96:                                               ; preds = %85
  %97 = and i64 %88, 9223372036854775806, !dbg !141
  br label %98, !dbg !141

98:                                               ; preds = %98, %96
  %99 = phi i64 [ 0, %96 ], [ %115, %98 ]
  %100 = phi i64 [ %81, %96 ], [ %114, %98 ]
  %101 = phi i64 [ 0, %96 ], [ %116, %98 ]
  tail call void @llvm.dbg.value(metadata i64 %100, metadata !80, metadata !DIExpression()), !dbg !140
  tail call void @llvm.dbg.value(metadata i64 %99, metadata !62, metadata !DIExpression()), !dbg !104
  %102 = getelementptr inbounds double, ptr %4, i64 %100, !dbg !143
  %103 = load double, ptr %102, align 8, !dbg !143, !tbaa !109
  %104 = fmul double %91, %103, !dbg !146
  %105 = getelementptr double, ptr %93, i64 %99, !dbg !147
  %106 = load double, ptr %105, align 8, !dbg !148, !tbaa !109
  %handler_result1 = call double @fAddHandlerDouble(double %106, double %104), !dbg !148
  store double %handler_result1, ptr %105, align 8, !dbg !148, !tbaa !109
  %107 = add i64 %100, %82, !dbg !149
  tail call void @llvm.dbg.value(metadata i64 %107, metadata !80, metadata !DIExpression()), !dbg !140
  %108 = or disjoint i64 %99, 1, !dbg !150
  tail call void @llvm.dbg.value(metadata i64 %108, metadata !62, metadata !DIExpression()), !dbg !104
  tail call void @llvm.dbg.value(metadata i64 %107, metadata !80, metadata !DIExpression()), !dbg !140
  tail call void @llvm.dbg.value(metadata i64 %108, metadata !62, metadata !DIExpression()), !dbg !104
  %109 = getelementptr inbounds double, ptr %4, i64 %107, !dbg !143
  %110 = load double, ptr %109, align 8, !dbg !143, !tbaa !109
  %111 = fmul double %91, %110, !dbg !146
  %112 = getelementptr double, ptr %93, i64 %108, !dbg !147
  %113 = load double, ptr %112, align 8, !dbg !148, !tbaa !109
  %handler_result2 = call double @fAddHandlerDouble(double %113, double %111), !dbg !148
  store double %handler_result2, ptr %112, align 8, !dbg !148, !tbaa !109
  %114 = add i64 %107, %82, !dbg !149
  tail call void @llvm.dbg.value(metadata i64 %114, metadata !80, metadata !DIExpression()), !dbg !140
  %115 = add nuw nsw i64 %99, 2, !dbg !150
  tail call void @llvm.dbg.value(metadata i64 %115, metadata !62, metadata !DIExpression()), !dbg !104
  %116 = add i64 %101, 2, !dbg !141
  %117 = icmp eq i64 %116, %97, !dbg !141
  br i1 %117, label %118, label %98, !dbg !141, !llvm.loop !151

118:                                              ; preds = %98, %85
  %119 = phi i64 [ 0, %85 ], [ %115, %98 ]
  %120 = phi i64 [ %81, %85 ], [ %114, %98 ]
  %121 = icmp eq i64 %94, 0, !dbg !141
  br i1 %121, label %128, label %122, !dbg !141

122:                                              ; preds = %118
  tail call void @llvm.dbg.value(metadata i64 %120, metadata !80, metadata !DIExpression()), !dbg !140
  tail call void @llvm.dbg.value(metadata i64 %119, metadata !62, metadata !DIExpression()), !dbg !104
  %123 = getelementptr inbounds double, ptr %4, i64 %120, !dbg !143
  %124 = load double, ptr %123, align 8, !dbg !143, !tbaa !109
  %125 = fmul double %91, %124, !dbg !146
  %126 = getelementptr double, ptr %93, i64 %119, !dbg !147
  %127 = load double, ptr %126, align 8, !dbg !148, !tbaa !109
  %handler_result3 = call double @fAddHandlerDouble(double %127, double %125), !dbg !148
  store double %handler_result3, ptr %126, align 8, !dbg !148, !tbaa !109
  tail call void @llvm.dbg.value(metadata !DIArgList(i64 %120, i64 %82), metadata !80, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_plus, DW_OP_stack_value)), !dbg !140
  tail call void @llvm.dbg.value(metadata i64 %119, metadata !62, metadata !DIExpression(DW_OP_plus_uconst, 1, DW_OP_stack_value)), !dbg !104
  br label %128, !dbg !153

128:                                              ; preds = %122, %118
  %129 = add i64 %86, %82, !dbg !153
  tail call void @llvm.dbg.value(metadata i64 %129, metadata !73, metadata !DIExpression()), !dbg !134
  %130 = add nuw nsw i64 %87, 1, !dbg !154
  tail call void @llvm.dbg.value(metadata i64 %130, metadata !59, metadata !DIExpression()), !dbg !104
  %131 = add nuw nsw i64 %88, 1, !dbg !136
  %132 = icmp eq i64 %130, %84, !dbg !135
  br i1 %132, label %134, label %85, !dbg !136, !llvm.loop !155

133:                                              ; preds = %70
  tail call void (i32, ptr, ptr, ...) @cblas_xerbla(i32 noundef 0, ptr noundef nonnull @.str, ptr noundef nonnull @.str.2) #3, !dbg !157
  br label %134

134:                                              ; preds = %133, %128, %74, %66, %36, %24
  ret void, !dbg !159
}
...
!18 = !DIFile(filename: "dsyr.c", directory: "/PI-detector/external/gsl/gsl-2.5/cblas", checksumkind: CSK_MD5, checksum: "e0e41887d246905b15079eeaadbadffd")
!19 = !{!20, !26}
...
!39 = distinct !DISubprogram(name: "cblas_dsyr", scope: !18, file: !18, line: 7, type: !40, scopeLine: 10, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !17, retainedNodes: !50)
