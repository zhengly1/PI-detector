...
68:                                               ; preds = %56, %68
  ...
  %78 = fadd double %74, %77, !dbg !136
  %79 = getelementptr double, ptr %67, i64 %71, !dbg !137
  %80 = load double, ptr %79, align 8, !dbg !138, !tbaa !120
  %81 = fadd double %80, %78, !dbg !138
  store double %81, ptr %79, align 8, !dbg !138, !tbaa !120
...
111:                                              ; preds = %97, %177
  ...
  %116 = getelementptr inbounds double, ptr %4, i64 %112, !dbg !157
  %117 = load double, ptr %116, align 8, !dbg !157, !tbaa !120
  %118 = fmul double %117, %3, !dbg !158
  tail call void @llvm.dbg.value(metadata double %118, metadata !82, metadata !DIExpression()), !dbg !159
  %119 = getelementptr inbounds double, ptr %6, i64 %113, !dbg !160
  %120 = load double, ptr %119, align 8, !dbg !160, !tbaa !120
  %121 = fmul double %120, %3, !dbg !161
  tail call void @llvm.dbg.value(metadata double %121, metadata !86, metadata !DIExpression()), !dbg !159
  ...
  tail call void @llvm.dbg.value(metadata i32 poison, metadata !87, metadata !DIExpression()), !dbg !159
  tail call void @llvm.dbg.value(metadata i32 0, metadata !64, metadata !DIExpression()), !dbg !114
  %123 = getelementptr double, ptr %8, i64 %122, !dbg !162
...
128:                                              ; preds = %128, %126
  ...
  %133 = getelementptr inbounds double, ptr %6, i64 %131, !dbg !164
  %134 = load double, ptr %133, align 8, !dbg !164, !tbaa !120
  %135 = fmul double %118, %134, !dbg !167
  %136 = getelementptr inbounds double, ptr %4, i64 %130, !dbg !168
  %137 = load double, ptr %136, align 8, !dbg !168, !tbaa !120
  %138 = fmul double %121, %137, !dbg !169
  %139 = fadd double %135, %138, !dbg !170
  %140 = getelementptr double, ptr %123, i64 %129, !dbg !171
  %141 = load double, ptr %140, align 8, !dbg !172, !tbaa !120
  %142 = fadd double %141, %139, !dbg !172
  store double %142, ptr %140, align 8, !dbg !172, !tbaa !120
  ...
  tail call void @llvm.dbg.value(metadata i64 %143, metadata !87, metadata !DIExpression()), !dbg !159
  tail call void @llvm.dbg.value(metadata i64 %145, metadata !64, metadata !DIExpression()), !dbg !114
  %146 = getelementptr inbounds double, ptr %6, i64 %144, !dbg !164
  %147 = load double, ptr %146, align 8, !dbg !164, !tbaa !120
  %148 = fmul double %118, %147, !dbg !167
  %149 = getelementptr inbounds double, ptr %4, i64 %143, !dbg !168
  %150 = load double, ptr %149, align 8, !dbg !168, !tbaa !120
  %151 = fmul double %121, %150, !dbg !169
  %152 = fadd double %148, %151, !dbg !170
  %153 = getelementptr double, ptr %123, i64 %145, !dbg !171
  %154 = load double, ptr %153, align 8, !dbg !172, !tbaa !120
  %155 = fadd double %154, %152, !dbg !172
  store double %155, ptr %153, align 8, !dbg !172, !tbaa !120
...
166:                                              ; preds = %161
  ...
  %167 = getelementptr inbounds double, ptr %6, i64 %164, !dbg !164
  %168 = load double, ptr %167, align 8, !dbg !164, !tbaa !120
  %169 = fmul double %118, %168, !dbg !167
  %170 = getelementptr inbounds double, ptr %4, i64 %163, !dbg !168
  %171 = load double, ptr %170, align 8, !dbg !168, !tbaa !120
  %172 = fmul double %121, %171, !dbg !169
  %173 = fadd double %169, %172, !dbg !170
  %174 = getelementptr double, ptr %123, i64 %162, !dbg !171
  %175 = load double, ptr %174, align 8, !dbg !172, !tbaa !120
  %176 = fadd double %175, %173, !dbg !172
  store double %176, ptr %174, align 8, !dbg !172, !tbaa !120
