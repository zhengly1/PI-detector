...
20:                                               ; preds = %8, %20
  ...
  %49 = fadd double %48, %45, !dbg !64
  %50 = fpext float %23 to double, !dbg !65
  %51 = fadd double %49, %50, !dbg !65
  %52 = fptrunc double %51 to float, !dbg !65
  tail call void @llvm.dbg.value(metadata float %52, metadata !30, metadata !DIExpression()), !dbg !46
  %53 = fmul float %30, %43, !dbg !66
  %54 = fpext float %53 to double, !dbg !67
  %55 = fpext float %39 to double, !dbg !68
  %56 = fmul double %46, %55, !dbg !69
  %57 = fsub double %54, %56, !dbg !69
  %58 = fpext float %24 to double, !dbg !70
  %59 = fadd double %57, %58, !dbg !70
  %60 = fptrunc double %59 to float, !dbg !70
  tail call void @llvm.dbg.value(metadata float %60, metadata !34, metadata !DIExpression()), !dbg !46
  %61 = add i64 %22, %17, !dbg !71
  tail call void @llvm.dbg.value(metadata i64 %61, metadata !36, metadata !DIExpression()), !dbg !46
  %62 = add i64 %21, %19, !dbg !72
  tail call void @llvm.dbg.value(metadata i64 %62, metadata !37, metadata !DIExpression()), !dbg !46
  %63 = add nuw nsw i32 %25, 1, !dbg !73
  tail call void @llvm.dbg.value(metadata i32 %63, metadata !35, metadata !DIExpression()), !dbg !46
  %64 = icmp eq i32 %63, %0, !dbg !47
  br i1 %64, label %65, label %20, !dbg !48, !llvm.loop !74

65:                                               ; preds = %20, %6
  %66 = phi float [ 0.000000e+00, %6 ], [ %60, %20 ], !dbg !46
  %67 = phi float [ 0.000000e+00, %6 ], [ %52, %20 ], !dbg !46
  store float %67, ptr %5, align 4, !dbg !77, !tbaa !52
  %68 = getelementptr inbounds float, ptr %5, i64 1, !dbg !78
  store float %66, ptr %68, align 4, !dbg !79, !tbaa !52
  ret void, !dbg !80
}
