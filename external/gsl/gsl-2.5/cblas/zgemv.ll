...
110:                                              ; preds = %103, %110
  ...
  %124 = fsub double %122, %123, !dbg !225
  tail call void @llvm.dbg.value(metadata double %124, metadata !91, metadata !DIExpression()), !dbg !221
  %125 = fmul double %18, %117, !dbg !226
  %126 = fmul double %16, %121, !dbg !227
  %127 = fadd double %125, %126, !dbg !228
  tail call void @llvm.dbg.value(metadata double %127, metadata !92, metadata !DIExpression()), !dbg !221
  store double %124, ptr %116, align 8, !dbg !229, !tbaa !159
  store double %127, ptr %120, align 8, !dbg !230, !tbaa !159
...
136:                                              ; preds = %133
  ...
  %139 = getelementptr inbounds double, ptr %10, i64 %138, !dbg !207
  store double 0.000000e+00, ptr %139, align 8, !dbg !209, !tbaa !159
  %140 = or disjoint i32 %137, 1, !dbg !210
  %141 = sext i32 %140 to i64, !dbg !210
  %142 = getelementptr inbounds double, ptr %10, i64 %141, !dbg !210
  store double 0.000000e+00, ptr %142, align 8, !dbg !211, !tbaa !159
...
169:                                              ; preds = %152, %209
  ...
  tail call void @llvm.dbg.value(metadata double 0.000000e+00, metadata !96, metadata !DIExpression()), !dbg !245
  tail call void @llvm.dbg.value(metadata double 0.000000e+00, metadata !100, metadata !DIExpression()), !dbg !245
...
174:                                              ; preds = %172, %174
  ...
  %177 = phi double [ 0.000000e+00, %172 ], [ %201, %174 ]
  %178 = phi double [ 0.000000e+00, %172 ], [ %205, %174 ]
  tail call void @llvm.dbg.value(metadata i64 %176, metadata !71, metadata !DIExpression()), !dbg !163
  tail call void @llvm.dbg.value(metadata double %177, metadata !96, metadata !DIExpression()), !dbg !245
  tail call void @llvm.dbg.value(metadata double %178, metadata !100, metadata !DIExpression()), !dbg !245
  ...
  %182 = getelementptr inbounds double, ptr %7, i64 %181, !dbg !247
  %183 = load double, ptr %182, align 8, !dbg !247, !tbaa !159
  tail call void @llvm.dbg.value(metadata double %183, metadata !102, metadata !DIExpression()), !dbg !248
  %184 = or disjoint i32 %180, 1, !dbg !249
  %185 = sext i32 %184 to i64, !dbg !249
  %186 = getelementptr inbounds double, ptr %7, i64 %185, !dbg !249
  %187 = load double, ptr %186, align 8, !dbg !249, !tbaa !159
  tail call void @llvm.dbg.value(metadata double %187, metadata !106, metadata !DIExpression()), !dbg !248
  %188 = add i64 %176, %173, !dbg !250
  %189 = trunc i64 %188 to i32, !dbg !250
  %190 = shl nsw i32 %189, 1, !dbg !250
  %191 = sext i32 %190 to i64, !dbg !250
  %192 = getelementptr inbounds double, ptr %5, i64 %191, !dbg !250
  %193 = load double, ptr %192, align 8, !dbg !250, !tbaa !159
  tail call void @llvm.dbg.value(metadata double %193, metadata !107, metadata !DIExpression()), !dbg !248
  %194 = or disjoint i32 %190, 1, !dbg !251
  %195 = sext i32 %194 to i64, !dbg !251
  %196 = getelementptr inbounds double, ptr %5, i64 %195, !dbg !251
  %197 = load double, ptr %196, align 8, !dbg !251, !tbaa !159
  tail call void @llvm.dbg.value(metadata double %197, metadata !108, metadata !DIExpression()), !dbg !248
  %198 = fmul double %183, %193, !dbg !252
  %199 = fmul double %187, %197, !dbg !253
  %200 = fsub double %198, %199, !dbg !254
  %201 = fadd double %177, %200, !dbg !255
  tail call void @llvm.dbg.value(metadata double %201, metadata !96, metadata !DIExpression()), !dbg !245
  %202 = fmul double %187, %193, !dbg !256
  %203 = fmul double %183, %197, !dbg !257
  %204 = fadd double %202, %203, !dbg !258
  %205 = fadd double %178, %204, !dbg !259
  tail call void @llvm.dbg.value(metadata double %205, metadata !100, metadata !DIExpression()), !dbg !245
...
209:                                              ; preds = %174, %169
  %210 = phi double [ 0.000000e+00, %169 ], [ %205, %174 ], !dbg !245
  %211 = phi double [ 0.000000e+00, %169 ], [ %201, %174 ], !dbg !245
  %212 = fmul double %13, %211, !dbg !265
  %213 = fmul double %15, %210, !dbg !266
  %214 = fsub double %212, %213, !dbg !267
  %215 = trunc i64 %170 to i32, !dbg !268
  %216 = shl nsw i32 %215, 1, !dbg !268
  %217 = sext i32 %216 to i64, !dbg !268
  %218 = getelementptr inbounds double, ptr %10, i64 %217, !dbg !268
  %219 = load double, ptr %218, align 8, !dbg !269, !tbaa !159
  %220 = fadd double %214, %219, !dbg !269
  store double %220, ptr %218, align 8, !dbg !269, !tbaa !159
  %221 = fmul double %13, %210, !dbg !270
  %222 = fmul double %15, %211, !dbg !271
  %223 = fadd double %221, %222, !dbg !272
  %224 = or disjoint i32 %216, 1, !dbg !273
  %225 = sext i32 %224 to i64, !dbg !273
  %226 = getelementptr inbounds double, ptr %10, i64 %225, !dbg !273
  %227 = load double, ptr %226, align 8, !dbg !274, !tbaa !159
  %228 = fadd double %223, %227, !dbg !274
  store double %228, ptr %226, align 8, !dbg !274, !tbaa !159
...
255:                                              ; preds = %238, %308
  ...
  %261 = getelementptr inbounds double, ptr %7, i64 %260, !dbg !284
  %262 = load double, ptr %261, align 8, !dbg !284, !tbaa !159
  tail call void @llvm.dbg.value(metadata double %262, metadata !112, metadata !DIExpression()), !dbg !285
  %263 = or disjoint i32 %259, 1, !dbg !286
  %264 = sext i32 %263 to i64, !dbg !286
  %265 = getelementptr inbounds double, ptr %7, i64 %264, !dbg !286
  %266 = load double, ptr %265, align 8, !dbg !286, !tbaa !159
  tail call void @llvm.dbg.value(metadata double %266, metadata !116, metadata !DIExpression()), !dbg !285
  %267 = fmul double %13, %262, !dbg !287
  %268 = fmul double %15, %266, !dbg !288
  %269 = fsub double %267, %268, !dbg !289
  tail call void @llvm.dbg.value(metadata double %269, metadata !117, metadata !DIExpression()), !dbg !285
  %270 = fmul double %13, %266, !dbg !290
  %271 = fmul double %15, %262, !dbg !291
  %272 = fadd double %271, %270, !dbg !292
  tail call void @llvm.dbg.value(metadata double %272, metadata !118, metadata !DIExpression()), !dbg !285
...
275:                                              ; preds = %273, %275
  ...
  %282 = getelementptr inbounds double, ptr %5, i64 %281, !dbg !294
  %283 = load double, ptr %282, align 8, !dbg !294, !tbaa !159
  tail call void @llvm.dbg.value(metadata double %283, metadata !120, metadata !DIExpression()), !dbg !295
  %284 = or disjoint i32 %280, 1, !dbg !296
  %285 = sext i32 %284 to i64, !dbg !296
  %286 = getelementptr inbounds double, ptr %5, i64 %285, !dbg !296
  %287 = load double, ptr %286, align 8, !dbg !296, !tbaa !159
  tail call void @llvm.dbg.value(metadata double %287, metadata !124, metadata !DIExpression()), !dbg !295
  %288 = fmul double %269, %283, !dbg !297
  %289 = fmul double %272, %287, !dbg !298
  %290 = fsub double %288, %289, !dbg !299
  %291 = trunc i64 %276 to i32, !dbg !300
  %292 = shl nsw i32 %291, 1, !dbg !300
  %293 = sext i32 %292 to i64, !dbg !300
  %294 = getelementptr inbounds double, ptr %10, i64 %293, !dbg !300
  %295 = load double, ptr %294, align 8, !dbg !301, !tbaa !159
  %296 = fadd double %295, %290, !dbg !301
  store double %296, ptr %294, align 8, !dbg !301, !tbaa !159
  %297 = fmul double %272, %283, !dbg !302
  %298 = fmul double %269, %287, !dbg !303
  %299 = fadd double %297, %298, !dbg !304
  %300 = or disjoint i32 %292, 1, !dbg !305
  %301 = sext i32 %300 to i64, !dbg !305
  %302 = getelementptr inbounds double, ptr %10, i64 %301, !dbg !305
  %303 = load double, ptr %302, align 8, !dbg !306, !tbaa !159
  %304 = fadd double %299, %303, !dbg !306
  store double %304, ptr %302, align 8, !dbg !306, !tbaa !159
...
334:                                              ; preds = %317, %387
  ...
  %340 = getelementptr inbounds double, ptr %7, i64 %339, !dbg !321
  %341 = load double, ptr %340, align 8, !dbg !321, !tbaa !159
  tail call void @llvm.dbg.value(metadata double %341, metadata !128, metadata !DIExpression()), !dbg !322
  %342 = or disjoint i32 %338, 1, !dbg !323
  %343 = sext i32 %342 to i64, !dbg !323
  %344 = getelementptr inbounds double, ptr %7, i64 %343, !dbg !323
  %345 = load double, ptr %344, align 8, !dbg !323, !tbaa !159
  tail call void @llvm.dbg.value(metadata double %345, metadata !132, metadata !DIExpression()), !dbg !322
  %346 = fmul double %13, %341, !dbg !324
  %347 = fmul double %15, %345, !dbg !325
  %348 = fsub double %346, %347, !dbg !326
  tail call void @llvm.dbg.value(metadata double %348, metadata !133, metadata !DIExpression()), !dbg !322
  %349 = fmul double %13, %345, !dbg !327
  %350 = fmul double %15, %341, !dbg !328
  %351 = fadd double %350, %349, !dbg !329
  tail call void @llvm.dbg.value(metadata double %351, metadata !134, metadata !DIExpression()), !dbg !322
...
354:                                              ; preds = %352, %354
  ...
  %361 = getelementptr inbounds double, ptr %5, i64 %360, !dbg !331
  %362 = load double, ptr %361, align 8, !dbg !331, !tbaa !159
  tail call void @llvm.dbg.value(metadata double %362, metadata !136, metadata !DIExpression()), !dbg !332
  %363 = or disjoint i32 %359, 1, !dbg !333
  %364 = sext i32 %363 to i64, !dbg !333
  %365 = getelementptr inbounds double, ptr %5, i64 %364, !dbg !333
  %366 = load double, ptr %365, align 8, !dbg !333, !tbaa !159
  tail call void @llvm.dbg.value(metadata double %366, metadata !140, metadata !DIExpression()), !dbg !332
  %367 = fmul double %348, %362, !dbg !334
  %368 = fmul double %351, %366, !dbg !335
  %369 = fadd double %367, %368, !dbg !335
  %370 = trunc i64 %355 to i32, !dbg !336
  %371 = shl nsw i32 %370, 1, !dbg !336
  %372 = sext i32 %371 to i64, !dbg !336
  %373 = getelementptr inbounds double, ptr %10, i64 %372, !dbg !336
  %374 = load double, ptr %373, align 8, !dbg !337, !tbaa !159
  %375 = fadd double %374, %369, !dbg !337
  store double %375, ptr %373, align 8, !dbg !337, !tbaa !159
  %376 = fmul double %351, %362, !dbg !338
  %377 = fmul double %348, %366, !dbg !339
  %378 = fsub double %376, %377, !dbg !339
  %379 = or disjoint i32 %371, 1, !dbg !340
  %380 = sext i32 %379 to i64, !dbg !340
  %381 = getelementptr inbounds double, ptr %10, i64 %380, !dbg !340
  %382 = load double, ptr %381, align 8, !dbg !341, !tbaa !159
  %383 = fadd double %378, %382, !dbg !341
  store double %383, ptr %381, align 8, !dbg !341, !tbaa !159
...
412:                                              ; preds = %395, %452
  ...
  tail call void @llvm.dbg.value(metadata i32 0, metadata !71, metadata !DIExpression()), !dbg !163
  tail call void @llvm.dbg.value(metadata double 0.000000e+00, metadata !148, metadata !DIExpression()), !dbg !356
  tail call void @llvm.dbg.value(metadata double 0.000000e+00, metadata !144, metadata !DIExpression()), !dbg !356
...
417:                                              ; preds = %415, %417
  ...
  %420 = phi double [ 0.000000e+00, %415 ], [ %448, %417 ]
  %421 = phi double [ 0.000000e+00, %415 ], [ %444, %417 ]
  ...
  tail call void @llvm.dbg.value(metadata double %420, metadata !148, metadata !DIExpression()), !dbg !356
  tail call void @llvm.dbg.value(metadata double %421, metadata !144, metadata !DIExpression()), !dbg !356
  %422 = trunc i64 %418 to i32, !dbg !358
  %423 = shl nsw i32 %422, 1, !dbg !358
  %424 = sext i32 %423 to i64, !dbg !358
  %425 = getelementptr inbounds double, ptr %7, i64 %424, !dbg !358
  %426 = load double, ptr %425, align 8, !dbg !358, !tbaa !159
  tail call void @llvm.dbg.value(metadata double %426, metadata !150, metadata !DIExpression()), !dbg !359
  %427 = or disjoint i32 %423, 1, !dbg !360
  %428 = sext i32 %427 to i64, !dbg !360
  %429 = getelementptr inbounds double, ptr %7, i64 %428, !dbg !360
  %430 = load double, ptr %429, align 8, !dbg !360, !tbaa !159
  tail call void @llvm.dbg.value(metadata double %430, metadata !154, metadata !DIExpression()), !dbg !359
  %431 = add i64 %419, %416, !dbg !361
  %432 = trunc i64 %431 to i32, !dbg !361
  %433 = shl nsw i32 %432, 1, !dbg !361
  %434 = sext i32 %433 to i64, !dbg !361
  %435 = getelementptr inbounds double, ptr %5, i64 %434, !dbg !361
  %436 = load double, ptr %435, align 8, !dbg !361, !tbaa !159
  tail call void @llvm.dbg.value(metadata double %436, metadata !155, metadata !DIExpression()), !dbg !359
  %437 = or disjoint i32 %433, 1, !dbg !362
  %438 = sext i32 %437 to i64, !dbg !362
  %439 = getelementptr inbounds double, ptr %5, i64 %438, !dbg !362
  %440 = load double, ptr %439, align 8, !dbg !362, !tbaa !159
  tail call void @llvm.dbg.value(metadata double %440, metadata !156, metadata !DIExpression()), !dbg !359
  %441 = fmul double %426, %436, !dbg !363
  %442 = fmul double %430, %440, !dbg !364
  %443 = fadd double %441, %442, !dbg !364
  %444 = fadd double %421, %443, !dbg !365
  tail call void @llvm.dbg.value(metadata double %444, metadata !144, metadata !DIExpression()), !dbg !356
  %445 = fmul double %430, %436, !dbg !366
  %446 = fmul double %426, %440, !dbg !367
  %447 = fsub double %445, %446, !dbg !367
  %448 = fadd double %420, %447, !dbg !368
  tail call void @llvm.dbg.value(metadata double %448, metadata !148, metadata !DIExpression()), !dbg !356
...
452:                                              ; preds = %417, %412
  %453 = phi double [ 0.000000e+00, %412 ], [ %444, %417 ], !dbg !356
  %454 = phi double [ 0.000000e+00, %412 ], [ %448, %417 ], !dbg !356
  %455 = fmul double %13, %453, !dbg !374
  %456 = fmul double %15, %454, !dbg !375
  %457 = fsub double %455, %456, !dbg !376
  %458 = trunc i64 %413 to i32, !dbg !377
  %459 = shl nsw i32 %458, 1, !dbg !377
  %460 = sext i32 %459 to i64, !dbg !377
  %461 = getelementptr inbounds double, ptr %10, i64 %460, !dbg !377
  %462 = load double, ptr %461, align 8, !dbg !378, !tbaa !159
  %463 = fadd double %457, %462, !dbg !378
  store double %463, ptr %461, align 8, !dbg !378, !tbaa !159
  %464 = fmul double %13, %454, !dbg !379
  %465 = fmul double %15, %453, !dbg !380
  %466 = fadd double %465, %464, !dbg !381
  %467 = or disjoint i32 %459, 1, !dbg !382
  %468 = sext i32 %467 to i64, !dbg !382
  %469 = getelementptr inbounds double, ptr %10, i64 %468, !dbg !382
  %470 = load double, ptr %469, align 8, !dbg !383, !tbaa !159
  %471 = fadd double %466, %470, !dbg !383
  store double %471, ptr %469, align 8, !dbg !383, !tbaa !159
