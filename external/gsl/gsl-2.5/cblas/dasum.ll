...
13:                                               ; preds = %13, %11
  ...
  %20 = fadd double %15, %19, !dbg !43
  tail call void @llvm.dbg.value(metadata double %20, metadata !22, metadata !DIExpression()), !dbg !29
  ...
  tail call void @llvm.dbg.value(metadata i32 poison, metadata !26, metadata !DIExpression(DW_OP_plus_uconst, 1, DW_OP_stack_value)), !dbg !29
  tail call void @llvm.dbg.value(metadata double %20, metadata !22, metadata !DIExpression()), !dbg !29
  %22 = getelementptr inbounds double, ptr %1, i64 %21, !dbg !35
  %23 = load double, ptr %22, align 8, !dbg !35, !tbaa !38
  %24 = tail call double @llvm.fabs.f64(double %23), !dbg !42
  %25 = fadd double %20, %24, !dbg !43
  tail call void @llvm.dbg.value(metadata double %25, metadata !22, metadata !DIExpression()), !dbg !29
  ...
  tail call void @llvm.dbg.value(metadata i32 poison, metadata !26, metadata !DIExpression(DW_OP_plus_uconst, 2, DW_OP_stack_value)), !dbg !29
  tail call void @llvm.dbg.value(metadata double %25, metadata !22, metadata !DIExpression()), !dbg !29
  %27 = getelementptr inbounds double, ptr %1, i64 %26, !dbg !35
  %28 = load double, ptr %27, align 8, !dbg !35, !tbaa !38
  %29 = tail call double @llvm.fabs.f64(double %28), !dbg !42
  %30 = fadd double %25, %29, !dbg !43
  tail call void @llvm.dbg.value(metadata double %30, metadata !22, metadata !DIExpression()), !dbg !29
  ...
  tail call void @llvm.dbg.value(metadata i32 poison, metadata !26, metadata !DIExpression(DW_OP_plus_uconst, 3, DW_OP_stack_value)), !dbg !29
  tail call void @llvm.dbg.value(metadata double %30, metadata !22, metadata !DIExpression()), !dbg !29
  %32 = getelementptr inbounds double, ptr %1, i64 %31, !dbg !35
  %33 = load double, ptr %32, align 8, !dbg !35, !tbaa !38
  %34 = tail call double @llvm.fabs.f64(double %33), !dbg !42
  %35 = fadd double %30, %34, !dbg !43
  tail call void @llvm.dbg.value(metadata double %35, metadata !22, metadata !DIExpression()), !dbg !29
...
39:                                               ; preds = %13, %7
  %40 = phi double [ undef, %7 ], [ %35, %13 ]
  %41 = phi i64 [ 0, %7 ], [ %36, %13 ]
  %42 = phi double [ 0.000000e+00, %7 ], [ %35, %13 ]
...
44:                                               ; preds = %39, %44
  ...
  tail call void @llvm.dbg.value(metadata i32 poison, metadata !26, metadata !DIExpression()), !dbg !29
  tail call void @llvm.dbg.value(metadata double %46, metadata !22, metadata !DIExpression()), !dbg !29
  %48 = getelementptr inbounds double, ptr %1, i64 %45, !dbg !35
  %49 = load double, ptr %48, align 8, !dbg !35, !tbaa !38
  %50 = tail call double @llvm.fabs.f64(double %49), !dbg !42
  %51 = fadd double %46, %50, !dbg !43
  tail call void @llvm.dbg.value(metadata double %51, metadata !22, metadata !DIExpression()), !dbg !29
...
55:                                               ; preds = %39, %44, %3
  %56 = phi double [ 0.000000e+00, %3 ], [ %40, %39 ], [ %51, %44 ], !dbg !29
  ret double %56, !dbg !50
}
