...
define dso_local double @cblas_dnrm2(i32 noundef %0, ptr nocapture noundef readonly %1, i32 noundef %2) local_unnamed_addr #0 !dbg !10 {
  ...
  %5 = icmp slt i32 %2, 1
  %6 = or i1 %4, %5, !dbg !40
  br i1 %6, label %43, label %7, !dbg !40
...
14:                                               ; preds = %9, %34
  ...
  %16 = phi double [ 0.000000e+00, %9 ], [ %36, %34 ]
  %17 = phi i32 [ 0, %9 ], [ %38, %34 ]
  %18 = phi double [ 1.000000e+00, %9 ], [ %35, %34 ]
...
25:                                               ; preds = %22
  ...
  %29 = fadd double %28, 1.000000e+00, !dbg !66
  tail call void @llvm.dbg.value(metadata double %29, metadata !26, metadata !DIExpression()), !dbg !37
  tail call void @llvm.dbg.value(metadata double %23, metadata !22, metadata !DIExpression()), !dbg !37
  br label %34, !dbg !67

30:                                               ; preds = %22
  %31 = fdiv double %23, %16, !dbg !68
  %32 = fmul double %31, %31, !dbg !70
  %33 = fadd double %18, %32, !dbg !71
  tail call void @llvm.dbg.value(metadata double %33, metadata !26, metadata !DIExpression()), !dbg !37
  br label %34

34:                                               ; preds = %25, %30, %14
  %35 = phi double [ %18, %14 ], [ %29, %25 ], [ %33, %30 ], !dbg !37
  %36 = phi double [ %16, %14 ], [ %23, %25 ], [ %16, %30 ], !dbg !37
  tail call void @llvm.dbg.value(metadata double %36, metadata !22, metadata !DIExpression()), !dbg !37
  tail call void @llvm.dbg.value(metadata double %35, metadata !26, metadata !DIExpression()), !dbg !37
...
40:                                               ; preds = %34
  %41 = tail call double @sqrt(double noundef %35) #4, !dbg !78
  %42 = fmul double %36, %41, !dbg !79
  br label %43, !dbg !80

43:                                               ; preds = %3, %40, %11
  %44 = phi double [ %13, %11 ], [ %42, %40 ], [ 0.000000e+00, %3 ], !dbg !37
  ret double %44, !dbg !81
}
...
declare !dbg !83 double @sqrt(double noundef) local_unnamed_addr #2
...
!66 = !DILocation(line: 39, column: 19, scope: !63)
