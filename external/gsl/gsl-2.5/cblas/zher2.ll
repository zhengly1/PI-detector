...
66:                                               ; preds = %46, %63
  ...
  %87 = fsub double %85, %86, !dbg !169
  tail call void @llvm.dbg.value(metadata double %87, metadata !84, metadata !DIExpression()), !dbg !165
  %88 = fmul double %33, %80, !dbg !170
  %89 = fmul double %31, %84, !dbg !171
  %90 = fadd double %88, %89, !dbg !172
  tail call void @llvm.dbg.value(metadata double %90, metadata !85, metadata !DIExpression()), !dbg !165
  %91 = trunc i64 %67 to i32, !dbg !173
  %92 = shl nsw i32 %91, 1, !dbg !173
  %93 = sext i32 %92 to i64, !dbg !173
  %94 = getelementptr inbounds double, ptr %6, i64 %93, !dbg !173
  %95 = load double, ptr %94, align 8, !dbg !173, !tbaa !144
  tail call void @llvm.dbg.value(metadata double %95, metadata !86, metadata !DIExpression()), !dbg !165
  %96 = or disjoint i32 %92, 1, !dbg !174
  %97 = sext i32 %96 to i64, !dbg !174
  %98 = getelementptr inbounds double, ptr %6, i64 %97, !dbg !174
  %99 = load double, ptr %98, align 8, !dbg !174, !tbaa !144
  tail call void @llvm.dbg.value(metadata double %99, metadata !87, metadata !DIExpression()), !dbg !165
  %100 = fmul double %31, %95, !dbg !175
  %101 = fmul double %33, %99, !dbg !176
  %102 = fadd double %100, %101, !dbg !177
  tail call void @llvm.dbg.value(metadata double %102, metadata !88, metadata !DIExpression()), !dbg !165
  %103 = fmul double %31, %99, !dbg !178
  %104 = fmul double %33, %95, !dbg !179
  %105 = fsub double %103, %104, !dbg !179
  tail call void @llvm.dbg.value(metadata double %105, metadata !89, metadata !DIExpression()), !dbg !165
  ...
  %108 = fmul double %95, %87, !dbg !182
  %109 = fmul double %90, %99, !dbg !183
  %110 = fadd double %108, %109, !dbg !184
  %111 = fmul double %110, 2.000000e+00, !dbg !185
  %112 = mul i64 %69, %57, !dbg !186
  %113 = mul i32 %62, %75, !dbg !186
  %114 = shl nsw i32 %113, 1, !dbg !186
  %115 = sext i32 %114 to i64, !dbg !186
  %116 = getelementptr inbounds double, ptr %8, i64 %115, !dbg !186
  %117 = load double, ptr %116, align 8, !dbg !187, !tbaa !144
  %118 = fadd double %117, %111, !dbg !187
  store double %118, ptr %116, align 8, !dbg !187, !tbaa !144
  %119 = or disjoint i32 %114, 1, !dbg !188
  %120 = sext i32 %119 to i64, !dbg !188
  %121 = getelementptr inbounds double, ptr %8, i64 %120, !dbg !188
  store double 0.000000e+00, ptr %121, align 8, !dbg !189, !tbaa !144
...
127:                                              ; preds = %124, %127
  ...
  %134 = getelementptr inbounds double, ptr %4, i64 %133, !dbg !193
  %135 = load double, ptr %134, align 8, !dbg !193, !tbaa !144
  tail call void @llvm.dbg.value(metadata double %135, metadata !92, metadata !DIExpression()), !dbg !194
  %136 = or disjoint i32 %132, 1, !dbg !195
  %137 = sext i32 %136 to i64, !dbg !195
  %138 = getelementptr inbounds double, ptr %4, i64 %137, !dbg !195
  %139 = load double, ptr %138, align 8, !dbg !195, !tbaa !144
  tail call void @llvm.dbg.value(metadata double %139, metadata !96, metadata !DIExpression()), !dbg !194
  %140 = trunc i64 %128 to i32, !dbg !196
  %141 = shl nsw i32 %140, 1, !dbg !196
  %142 = sext i32 %141 to i64, !dbg !196
  %143 = getelementptr inbounds double, ptr %6, i64 %142, !dbg !196
  %144 = load double, ptr %143, align 8, !dbg !196, !tbaa !144
  tail call void @llvm.dbg.value(metadata double %144, metadata !97, metadata !DIExpression()), !dbg !194
  %145 = or disjoint i32 %141, 1, !dbg !197
  %146 = sext i32 %145 to i64, !dbg !197
  %147 = getelementptr inbounds double, ptr %6, i64 %146, !dbg !197
  %148 = load double, ptr %147, align 8, !dbg !197, !tbaa !144
  tail call void @llvm.dbg.value(metadata double %148, metadata !98, metadata !DIExpression()), !dbg !194
  %149 = fmul double %87, %144, !dbg !198
  %150 = fmul double %90, %148, !dbg !199
  %151 = fadd double %149, %150, !dbg !200
  %152 = fmul double %102, %135, !dbg !201
  %153 = fmul double %105, %139, !dbg !202
  %154 = fadd double %152, %153, !dbg !203
  %155 = fadd double %154, %151, !dbg !204
  %156 = add i64 %130, %112, !dbg !205
  %157 = trunc i64 %156 to i32, !dbg !205
  %158 = shl nsw i32 %157, 1, !dbg !205
  %159 = sext i32 %158 to i64, !dbg !205
  %160 = getelementptr inbounds double, ptr %8, i64 %159, !dbg !205
  %161 = load double, ptr %160, align 8, !dbg !206, !tbaa !144
  %162 = fadd double %161, %155, !dbg !206
  store double %162, ptr %160, align 8, !dbg !206, !tbaa !144
  %163 = fmul double %90, %144, !dbg !207
  %164 = fmul double %87, %148, !dbg !208
  %165 = fsub double %163, %164, !dbg !209
  %166 = fmul double %105, %135, !dbg !210
  %167 = fmul double %102, %139, !dbg !211
  %168 = fsub double %166, %167, !dbg !212
  %169 = fadd double %168, %165, !dbg !213
  %170 = fmul double %169, %54, !dbg !214
  %171 = or disjoint i32 %158, 1, !dbg !215
  %172 = sext i32 %171 to i64, !dbg !215
  %173 = getelementptr inbounds double, ptr %8, i64 %172, !dbg !215
  %174 = load double, ptr %173, align 8, !dbg !216, !tbaa !144
  %175 = fadd double %174, %170, !dbg !216
  store double %175, ptr %173, align 8, !dbg !216, !tbaa !144
...
203:                                              ; preds = %186, %293
  ...
  %210 = getelementptr inbounds double, ptr %4, i64 %209, !dbg !228
  %211 = load double, ptr %210, align 8, !dbg !228, !tbaa !144
  tail call void @llvm.dbg.value(metadata double %211, metadata !103, metadata !DIExpression()), !dbg !229
  %212 = or disjoint i32 %208, 1, !dbg !230
  %213 = sext i32 %212 to i64, !dbg !230
  %214 = getelementptr inbounds double, ptr %4, i64 %213, !dbg !230
  %215 = load double, ptr %214, align 8, !dbg !230, !tbaa !144
  tail call void @llvm.dbg.value(metadata double %215, metadata !107, metadata !DIExpression()), !dbg !229
  %216 = fmul double %31, %211, !dbg !231
  %217 = fmul double %33, %215, !dbg !232
  %218 = fsub double %216, %217, !dbg !233
  tail call void @llvm.dbg.value(metadata double %218, metadata !108, metadata !DIExpression()), !dbg !229
  %219 = fmul double %33, %211, !dbg !234
  %220 = fmul double %31, %215, !dbg !235
  %221 = fadd double %219, %220, !dbg !236
  tail call void @llvm.dbg.value(metadata double %221, metadata !109, metadata !DIExpression()), !dbg !229
  %222 = trunc i64 %204 to i32, !dbg !237
  %223 = shl nsw i32 %222, 1, !dbg !237
  %224 = sext i32 %223 to i64, !dbg !237
  %225 = getelementptr inbounds double, ptr %6, i64 %224, !dbg !237
  %226 = load double, ptr %225, align 8, !dbg !237, !tbaa !144
  tail call void @llvm.dbg.value(metadata double %226, metadata !110, metadata !DIExpression()), !dbg !229
  %227 = or disjoint i32 %223, 1, !dbg !238
  %228 = sext i32 %227 to i64, !dbg !238
  %229 = getelementptr inbounds double, ptr %6, i64 %228, !dbg !238
  %230 = load double, ptr %229, align 8, !dbg !238, !tbaa !144
  tail call void @llvm.dbg.value(metadata double %230, metadata !111, metadata !DIExpression()), !dbg !229
  %231 = fmul double %31, %226, !dbg !239
  %232 = fmul double %33, %230, !dbg !240
  %233 = fadd double %231, %232, !dbg !241
  tail call void @llvm.dbg.value(metadata double %233, metadata !112, metadata !DIExpression()), !dbg !229
  %234 = fmul double %31, %230, !dbg !242
  %235 = fmul double %33, %226, !dbg !243
  %236 = fsub double %234, %235, !dbg !243
  tail call void @llvm.dbg.value(metadata double %236, metadata !113, metadata !DIExpression()), !dbg !229
...
240:                                              ; preds = %238, %240
  ...
  %247 = getelementptr inbounds double, ptr %4, i64 %246, !dbg !246
  %248 = load double, ptr %247, align 8, !dbg !246, !tbaa !144
  tail call void @llvm.dbg.value(metadata double %248, metadata !116, metadata !DIExpression()), !dbg !247
  %249 = or disjoint i32 %245, 1, !dbg !248
  %250 = sext i32 %249 to i64, !dbg !248
  %251 = getelementptr inbounds double, ptr %4, i64 %250, !dbg !248
  %252 = load double, ptr %251, align 8, !dbg !248, !tbaa !144
  tail call void @llvm.dbg.value(metadata double %252, metadata !120, metadata !DIExpression()), !dbg !247
  %253 = trunc i64 %242 to i32, !dbg !249
  %254 = shl nsw i32 %253, 1, !dbg !249
  %255 = sext i32 %254 to i64, !dbg !249
  %256 = getelementptr inbounds double, ptr %6, i64 %255, !dbg !249
  %257 = load double, ptr %256, align 8, !dbg !249, !tbaa !144
  tail call void @llvm.dbg.value(metadata double %257, metadata !121, metadata !DIExpression()), !dbg !247
  %258 = or disjoint i32 %254, 1, !dbg !250
  %259 = sext i32 %258 to i64, !dbg !250
  %260 = getelementptr inbounds double, ptr %6, i64 %259, !dbg !250
  %261 = load double, ptr %260, align 8, !dbg !250, !tbaa !144
  tail call void @llvm.dbg.value(metadata double %261, metadata !122, metadata !DIExpression()), !dbg !247
  %262 = fmul double %218, %257, !dbg !251
  %263 = fmul double %221, %261, !dbg !252
  %264 = fadd double %262, %263, !dbg !253
  %265 = fmul double %233, %248, !dbg !254
  %266 = fmul double %236, %252, !dbg !255
  %267 = fadd double %265, %266, !dbg !256
  %268 = fadd double %267, %264, !dbg !257
  %269 = add i64 %243, %239, !dbg !258
  %270 = trunc i64 %269 to i32, !dbg !258
  %271 = shl nsw i32 %270, 1, !dbg !258
  %272 = sext i32 %271 to i64, !dbg !258
  %273 = getelementptr inbounds double, ptr %8, i64 %272, !dbg !258
  %274 = load double, ptr %273, align 8, !dbg !259, !tbaa !144
  %275 = fadd double %274, %268, !dbg !259
  store double %275, ptr %273, align 8, !dbg !259, !tbaa !144
  %276 = fmul double %221, %257, !dbg !260
  %277 = fmul double %218, %261, !dbg !261
  %278 = fsub double %276, %277, !dbg !262
  %279 = fmul double %236, %248, !dbg !263
  %280 = fmul double %233, %252, !dbg !264
  %281 = fsub double %279, %280, !dbg !265
  %282 = fadd double %281, %278, !dbg !266
  %283 = fmul double %282, %194, !dbg !267
  %284 = or disjoint i32 %271, 1, !dbg !268
  %285 = sext i32 %284 to i64, !dbg !268
  %286 = getelementptr inbounds double, ptr %8, i64 %285, !dbg !268
  %287 = load double, ptr %286, align 8, !dbg !269, !tbaa !144
  %288 = fadd double %287, %283, !dbg !269
  store double %288, ptr %286, align 8, !dbg !269, !tbaa !144
...
293:                                              ; preds = %240, %203
  %294 = fmul double %226, %218, !dbg !275
  %295 = fmul double %221, %230, !dbg !276
  %296 = fadd double %294, %295, !dbg !277
  %297 = fmul double %296, 2.000000e+00, !dbg !278
  %298 = trunc i64 %206 to i32, !dbg !279
  %299 = mul i32 %196, %298, !dbg !279
  %300 = sext i32 %299 to i64, !dbg !279
  %301 = getelementptr inbounds double, ptr %8, i64 %300, !dbg !279
  %302 = load double, ptr %301, align 8, !dbg !280, !tbaa !144
  %303 = fadd double %297, %302, !dbg !280
  store double %303, ptr %301, align 8, !dbg !280, !tbaa !144
  %304 = or disjoint i32 %299, 1, !dbg !281
  %305 = sext i32 %304 to i64, !dbg !281
  %306 = getelementptr inbounds double, ptr %8, i64 %305, !dbg !281
  store double 0.000000e+00, ptr %306, align 8, !dbg !282, !tbaa !144
