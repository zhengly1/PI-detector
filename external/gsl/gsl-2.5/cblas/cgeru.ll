...
define dso_local void @cblas_cgeru(i32 noundef %0, i32 noundef %1, i32 noundef %2, ptr nocapture noundef readonly %3, ptr nocapture noundef readonly %4, i32 noundef %5, ptr nocapture noundef readonly %6, i32 noundef %7, ptr nocapture noundef %8, i32 noundef %9) local_unnamed_addr #0 !dbg !40 {
...
58:                                               ; preds = %41, %111
  ...
  %72 = fsub float %70, %71, !dbg !142
  tail call void @llvm.dbg.value(metadata float %72, metadata !77, metadata !DIExpression()), !dbg !138
  %73 = fmul float %38, %65, !dbg !143
  %74 = fmul float %36, %69, !dbg !144
  %75 = fadd float %73, %74, !dbg !145
  tail call void @llvm.dbg.value(metadata float %75, metadata !78, metadata !DIExpression()), !dbg !138
...
78:                                               ; preds = %76, %78
  ...
  %84 = getelementptr inbounds float, ptr %6, i64 %83, !dbg !147
  %85 = load float, ptr %84, align 4, !dbg !147, !tbaa !125
  tail call void @llvm.dbg.value(metadata float %85, metadata !80, metadata !DIExpression()), !dbg !148
  %86 = or disjoint i32 %82, 1, !dbg !149
  %87 = sext i32 %86 to i64, !dbg !149
  %88 = getelementptr inbounds float, ptr %6, i64 %87, !dbg !149
  %89 = load float, ptr %88, align 4, !dbg !149, !tbaa !125
  tail call void @llvm.dbg.value(metadata float %89, metadata !84, metadata !DIExpression()), !dbg !148
  %90 = fmul float %72, %85, !dbg !150
  %91 = fmul float %75, %89, !dbg !151
  %92 = fsub float %90, %91, !dbg !152
  %93 = add i64 %80, %77, !dbg !153
  %94 = trunc i64 %93 to i32, !dbg !153
  %95 = shl nsw i32 %94, 1, !dbg !153
  %96 = sext i32 %95 to i64, !dbg !153
  %97 = getelementptr inbounds float, ptr %8, i64 %96, !dbg !153
  %98 = load float, ptr %97, align 4, !dbg !154, !tbaa !125
  %99 = fadd float %98, %92, !dbg !154
  store float %99, ptr %97, align 4, !dbg !154, !tbaa !125
  %100 = fmul float %72, %89, !dbg !155
  %101 = fmul float %75, %85, !dbg !156
  %102 = fadd float %101, %100, !dbg !157
  %103 = or disjoint i32 %95, 1, !dbg !158
  %104 = sext i32 %103 to i64, !dbg !158
  %105 = getelementptr inbounds float, ptr %8, i64 %104, !dbg !158
  %106 = load float, ptr %105, align 4, !dbg !159, !tbaa !125
  %107 = fadd float %102, %106, !dbg !159
  store float %107, ptr %105, align 4, !dbg !159, !tbaa !125
  %108 = add i64 %79, %52, !dbg !160
  tail call void @llvm.dbg.value(metadata i64 %108, metadata !79, metadata !DIExpression()), !dbg !138
  %109 = add nuw nsw i64 %80, 1, !dbg !161
  tail call void @llvm.dbg.value(metadata i64 %109, metadata !63, metadata !DIExpression()), !dbg !133
  %110 = icmp eq i64 %109, %57, !dbg !162
  br i1 %110, label %111, label %78, !dbg !146, !llvm.loop !163

111:                                              ; preds = %78, %58
  %112 = add i64 %59, %55, !dbg !166
  tail call void @llvm.dbg.value(metadata i64 %112, metadata !69, metadata !DIExpression()), !dbg !132
  %113 = add nuw nsw i64 %60, 1, !dbg !167
  tail call void @llvm.dbg.value(metadata i64 %113, metadata !60, metadata !DIExpression()), !dbg !133
  %114 = icmp eq i64 %113, %56, !dbg !134
  br i1 %114, label %194, label %58, !dbg !135, !llvm.loop !168

115:                                              ; preds = %35
  %116 = icmp eq i32 %0, 102, !dbg !170
  br i1 %116, label %117, label %193, !dbg !171

117:                                              ; preds = %115
  tail call void @llvm.dbg.value(metadata i32 poison, metadata !85, metadata !DIExpression()), !dbg !172
  tail call void @llvm.dbg.value(metadata i32 0, metadata !63, metadata !DIExpression()), !dbg !133
  %118 = icmp sgt i32 %2, 0, !dbg !173
  br i1 %118, label %119, label %194, !dbg !174

119:                                              ; preds = %117
  %120 = icmp sgt i32 %7, 0, !dbg !175
  %121 = sub nsw i32 1, %2, !dbg !175
  %122 = mul i32 %121, %7, !dbg !175
  %123 = select i1 %120, i32 0, i32 %122, !dbg !175
  tail call void @llvm.dbg.value(metadata i32 %123, metadata !85, metadata !DIExpression()), !dbg !172
  %124 = icmp sgt i32 %5, 0
  %125 = sub i32 1, %1
  %126 = mul i32 %125, %5
  %127 = select i1 %124, i32 0, i32 %126
  %128 = icmp sgt i32 %1, 0
  %129 = zext i32 %127 to i64, !dbg !174
  %130 = zext i32 %5 to i64, !dbg !174
  %131 = zext i32 %9 to i64, !dbg !174
  %132 = zext i32 %123 to i64, !dbg !174
  %133 = zext i32 %7 to i64, !dbg !174
  %134 = zext nneg i32 %2 to i64, !dbg !173
  %135 = zext nneg i32 %1 to i64
  br label %136, !dbg !174
...
136:                                              ; preds = %119, %189
  ...
  tail call void @llvm.dbg.value(metadata i64 %137, metadata !85, metadata !DIExpression()), !dbg !172
  %139 = trunc i64 %137 to i32, !dbg !176
  %140 = shl nsw i32 %139, 1, !dbg !176
  %141 = sext i32 %140 to i64, !dbg !176
  %142 = getelementptr inbounds float, ptr %6, i64 %141, !dbg !176
  %143 = load float, ptr %142, align 4, !dbg !176, !tbaa !125
  tail call void @llvm.dbg.value(metadata float %143, metadata !88, metadata !DIExpression()), !dbg !177
  %144 = or disjoint i32 %140, 1, !dbg !178
  %145 = sext i32 %144 to i64, !dbg !178
  %146 = getelementptr inbounds float, ptr %6, i64 %145, !dbg !178
  %147 = load float, ptr %146, align 4, !dbg !178, !tbaa !125
  tail call void @llvm.dbg.value(metadata float %147, metadata !92, metadata !DIExpression()), !dbg !177
  %148 = fmul float %36, %143, !dbg !179
  %149 = fmul float %38, %147, !dbg !180
  %150 = fsub float %148, %149, !dbg !181
  tail call void @llvm.dbg.value(metadata float %150, metadata !93, metadata !DIExpression()), !dbg !177
  %151 = fmul float %38, %143, !dbg !182
  %152 = fmul float %36, %147, !dbg !183
  %153 = fadd float %151, %152, !dbg !184
  tail call void @llvm.dbg.value(metadata float %153, metadata !94, metadata !DIExpression()), !dbg !177
  tail call void @llvm.dbg.value(metadata i32 %127, metadata !95, metadata !DIExpression()), !dbg !177
  tail call void @llvm.dbg.value(metadata i32 0, metadata !60, metadata !DIExpression()), !dbg !133
  br i1 %128, label %154, label %189, !dbg !185

154:                                              ; preds = %136
  %155 = mul i64 %138, %131
  br label %156, !dbg !185
...
156:                                              ; preds = %154, %156
  ...
  tail call void @llvm.dbg.value(metadata i64 %157, metadata !95, metadata !DIExpression()), !dbg !177
  %159 = trunc i64 %157 to i32, !dbg !186
  %160 = shl nsw i32 %159, 1, !dbg !186
  %161 = sext i32 %160 to i64, !dbg !186
  %162 = getelementptr inbounds float, ptr %4, i64 %161, !dbg !186
  %163 = load float, ptr %162, align 4, !dbg !186, !tbaa !125
  tail call void @llvm.dbg.value(metadata float %163, metadata !96, metadata !DIExpression()), !dbg !187
  %164 = or disjoint i32 %160, 1, !dbg !188
  %165 = sext i32 %164 to i64, !dbg !188
  %166 = getelementptr inbounds float, ptr %4, i64 %165, !dbg !188
  %167 = load float, ptr %166, align 4, !dbg !188, !tbaa !125
  tail call void @llvm.dbg.value(metadata float %167, metadata !100, metadata !DIExpression()), !dbg !187
  %168 = fmul float %150, %163, !dbg !189
  %169 = fmul float %153, %167, !dbg !190
  %170 = fsub float %168, %169, !dbg !191
  %171 = add i64 %158, %155, !dbg !192
  %172 = trunc i64 %171 to i32, !dbg !192
  %173 = shl nsw i32 %172, 1, !dbg !192
  %174 = sext i32 %173 to i64, !dbg !192
  %175 = getelementptr inbounds float, ptr %8, i64 %174, !dbg !192
  %176 = load float, ptr %175, align 4, !dbg !193, !tbaa !125
  %177 = fadd float %176, %170, !dbg !193
  store float %177, ptr %175, align 4, !dbg !193, !tbaa !125
  %178 = fmul float %150, %167, !dbg !194
  %179 = fmul float %153, %163, !dbg !195
  %180 = fadd float %179, %178, !dbg !196
  %181 = or disjoint i32 %173, 1, !dbg !197
  %182 = sext i32 %181 to i64, !dbg !197
  %183 = getelementptr inbounds float, ptr %8, i64 %182, !dbg !197
  %184 = load float, ptr %183, align 4, !dbg !198, !tbaa !125
  %185 = fadd float %180, %184, !dbg !198
  store float %185, ptr %183, align 4, !dbg !198, !tbaa !125
  %186 = add i64 %157, %130, !dbg !199
  tail call void @llvm.dbg.value(metadata i64 %186, metadata !95, metadata !DIExpression()), !dbg !177
  %187 = add nuw nsw i64 %158, 1, !dbg !200
  tail call void @llvm.dbg.value(metadata i64 %187, metadata !60, metadata !DIExpression()), !dbg !133
  %188 = icmp eq i64 %187, %135, !dbg !201
  br i1 %188, label %189, label %156, !dbg !185, !llvm.loop !202

189:                                              ; preds = %156, %136
  %190 = add i64 %137, %133, !dbg !204
  tail call void @llvm.dbg.value(metadata i64 %190, metadata !85, metadata !DIExpression()), !dbg !172
  %191 = add nuw nsw i64 %138, 1, !dbg !205
  tail call void @llvm.dbg.value(metadata i64 %191, metadata !63, metadata !DIExpression()), !dbg !133
  %192 = icmp eq i64 %191, %134, !dbg !173
  br i1 %192, label %194, label %136, !dbg !174, !llvm.loop !206

193:                                              ; preds = %115
  tail call void (i32, ptr, ptr, ...) @cblas_xerbla(i32 noundef 0, ptr noundef nonnull @.str, ptr noundef nonnull @.str.2) #3, !dbg !208
  br label %194
...
declare !dbg !212 void @cblas_xerbla(i32 noundef, ptr noundef, ptr noundef, ...) local_unnamed_addr #1
...
!18 = !DIFile(filename: "cgeru.c", directory: "/PI-detector/external/gsl/gsl-2.5/cblas", checksumkind: CSK_MD5, checksum: "5cd2e5027bed0ca53c4c4b8ce0cf43ad")
!19 = !{!20}
...
!40 = distinct !DISubprogram(name: "cblas_cgeru", scope: !18, file: !18, line: 7, type: !41, scopeLine: 10, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !17, retainedNodes: !49)
...
!149 = !DILocation(line: 39, column: 31, scope: !81)
!150 = !DILocation(line: 40, column: 42, scope: !81)
!151 = !DILocation(line: 40, column: 62, scope: !81)
!152 = !DILocation(line: 40, column: 53, scope: !81)
!153 = !DILocation(line: 40, column: 11, scope: !81)
!154 = !DILocation(line: 40, column: 32, scope: !81)
!155 = !DILocation(line: 41, column: 42, scope: !81)
