...
78:                                               ; preds = %76, %78
  ...
  tail call void @llvm.dbg.value(metadata float poison, metadata !84, metadata !DIExpression()), !dbg !148
  %90 = fmul float %72, %85, !dbg !150
  %91 = fmul float %75, %89, !dbg !151
  %92 = fadd float %90, %91, !dbg !151
  %93 = add i64 %80, %77, !dbg !152
  %94 = trunc i64 %93 to i32, !dbg !152
  %95 = shl nsw i32 %94, 1, !dbg !152
  %96 = sext i32 %95 to i64, !dbg !152
  %97 = getelementptr inbounds float, ptr %8, i64 %96, !dbg !152
  %98 = load float, ptr %97, align 4, !dbg !153, !tbaa !125
  %99 = fadd float %98, %92, !dbg !153
  store float %99, ptr %97, align 4, !dbg !153, !tbaa !125
  %100 = fmul float %75, %85, !dbg !154
  %101 = fmul float %72, %89, !dbg !155
  %102 = fsub float %100, %101, !dbg !155
  %103 = or disjoint i32 %95, 1, !dbg !156
  %104 = sext i32 %103 to i64, !dbg !156
  %105 = getelementptr inbounds float, ptr %8, i64 %104, !dbg !156
  %106 = load float, ptr %105, align 4, !dbg !157, !tbaa !125
  %107 = fadd float %102, %106, !dbg !157
  store float %107, ptr %105, align 4, !dbg !157, !tbaa !125
...
136:                                              ; preds = %119, %189
  ...
  %142 = getelementptr inbounds float, ptr %6, i64 %141, !dbg !174
  %143 = load float, ptr %142, align 4, !dbg !174, !tbaa !125
  tail call void @llvm.dbg.value(metadata float %143, metadata !88, metadata !DIExpression()), !dbg !175
  %144 = or disjoint i32 %140, 1, !dbg !176
  %145 = sext i32 %144 to i64, !dbg !176
  %146 = getelementptr inbounds float, ptr %6, i64 %145, !dbg !176
  %147 = load float, ptr %146, align 4, !dbg !176, !tbaa !125
  tail call void @llvm.dbg.value(metadata float poison, metadata !92, metadata !DIExpression()), !dbg !175
  %148 = fmul float %36, %143, !dbg !177
  %149 = fmul float %38, %147, !dbg !178
  %150 = fadd float %148, %149, !dbg !178
  tail call void @llvm.dbg.value(metadata float %150, metadata !93, metadata !DIExpression()), !dbg !175
  %151 = fmul float %38, %143, !dbg !179
  %152 = fmul float %36, %147, !dbg !180
  %153 = fsub float %151, %152, !dbg !180
  tail call void @llvm.dbg.value(metadata float %153, metadata !94, metadata !DIExpression()), !dbg !175
...
156:                                              ; preds = %154, %156
  ...
  %162 = getelementptr inbounds float, ptr %4, i64 %161, !dbg !182
  %163 = load float, ptr %162, align 4, !dbg !182, !tbaa !125
  tail call void @llvm.dbg.value(metadata float %163, metadata !96, metadata !DIExpression()), !dbg !183
  %164 = or disjoint i32 %160, 1, !dbg !184
  %165 = sext i32 %164 to i64, !dbg !184
  %166 = getelementptr inbounds float, ptr %4, i64 %165, !dbg !184
  %167 = load float, ptr %166, align 4, !dbg !184, !tbaa !125
  tail call void @llvm.dbg.value(metadata float %167, metadata !100, metadata !DIExpression()), !dbg !183
  %168 = fmul float %150, %163, !dbg !185
  %169 = fmul float %153, %167, !dbg !186
  %170 = fsub float %168, %169, !dbg !187
  %171 = add i64 %158, %155, !dbg !188
  %172 = trunc i64 %171 to i32, !dbg !188
  %173 = shl nsw i32 %172, 1, !dbg !188
  %174 = sext i32 %173 to i64, !dbg !188
  %175 = getelementptr inbounds float, ptr %8, i64 %174, !dbg !188
  %176 = load float, ptr %175, align 4, !dbg !189, !tbaa !125
  %177 = fadd float %176, %170, !dbg !189
  store float %177, ptr %175, align 4, !dbg !189, !tbaa !125
  %178 = fmul float %150, %167, !dbg !190
  %179 = fmul float %153, %163, !dbg !191
  %180 = fadd float %179, %178, !dbg !192
  %181 = or disjoint i32 %173, 1, !dbg !193
  %182 = sext i32 %181 to i64, !dbg !193
  %183 = getelementptr inbounds float, ptr %8, i64 %182, !dbg !193
  %184 = load float, ptr %183, align 4, !dbg !194, !tbaa !125
  %185 = fadd float %180, %184, !dbg !194
  store float %185, ptr %183, align 4, !dbg !194, !tbaa !125
