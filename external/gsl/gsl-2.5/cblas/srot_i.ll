...
define dso_local void @cblas_srot(i32 noundef %0, ptr nocapture noundef %1, i32 noundef %2, ptr nocapture noundef %3, i32 noundef %4, float noundef %5, float noundef %6) local_unnamed_addr #0 !dbg !10 {
  ...
  br i1 %8, label %9, label %45, !dbg !40
...
21:                                               ; preds = %21, %9
  %22 = phi i64 [ %19, %9 ], [ %42, %21 ]
  %23 = phi i64 [ %17, %9 ], [ %41, %21 ]
  %24 = phi i32 [ 0, %9 ], [ %43, %21 ]
  ...
  %31 = fpext float %29 to double, !dbg !52
  %32 = fpext float %30 to double, !dbg !52
  %33 = fptrunc double %31 to float, !dbg !52
  %34 = fptrunc double %32 to float, !dbg !52
  %handler_result = call float @fAddHandlerFloat(float %33, float %34), !dbg !52
  store float %handler_result, ptr %25, align 4, !dbg !52, !tbaa !44
  %35 = fmul float %28, %5, !dbg !53
  %36 = fmul float %26, %6, !dbg !54
  %37 = fpext float %35 to double, !dbg !55
  %38 = fpext float %36 to double, !dbg !55
  %39 = fptrunc double %37 to float, !dbg !55
  %40 = fptrunc double %38 to float, !dbg !55
  %handler_result1 = call float @fSubHandlerFloat(float %39, float %40), !dbg !55
  store float %handler_result1, ptr %27, align 4, !dbg !55, !tbaa !44
  %41 = add i64 %23, %18, !dbg !56
  tail call void @llvm.dbg.value(metadata i64 %41, metadata !30, metadata !DIExpression()), !dbg !38
  %42 = add i64 %22, %20, !dbg !57
  tail call void @llvm.dbg.value(metadata i64 %42, metadata !31, metadata !DIExpression()), !dbg !38
  %43 = add nuw nsw i32 %24, 1, !dbg !58
  tail call void @llvm.dbg.value(metadata i32 %43, metadata !26, metadata !DIExpression()), !dbg !38
  %44 = icmp eq i32 %43, %0, !dbg !39
  br i1 %44, label %45, label %21, !dbg !40, !llvm.loop !59
