...
54:                                               ; preds = %38, %51
  ...
  %82 = getelementptr inbounds float, ptr %6, i64 %81, !dbg !149
  %83 = load float, ptr %82, align 4, !dbg !150, !tbaa !136
  %84 = fadd float %83, %75, !dbg !150
  store float %84, ptr %82, align 4, !dbg !150, !tbaa !136
  %85 = or disjoint i32 %80, 1, !dbg !151
  %86 = sext i32 %85 to i64, !dbg !151
  %87 = getelementptr inbounds float, ptr %6, i64 %86, !dbg !151
  store float 0.000000e+00, ptr %87, align 4, !dbg !152, !tbaa !136
...
93:                                               ; preds = %91, %93
  ...
  %99 = getelementptr inbounds float, ptr %4, i64 %98, !dbg !157
  %100 = load float, ptr %99, align 4, !dbg !157, !tbaa !136
  tail call void @llvm.dbg.value(metadata float %100, metadata !82, metadata !DIExpression()), !dbg !158
  %101 = or disjoint i32 %97, 1, !dbg !159
  %102 = sext i32 %101 to i64, !dbg !159
  %103 = getelementptr inbounds float, ptr %4, i64 %102, !dbg !159
  %104 = load float, ptr %103, align 4, !dbg !159, !tbaa !136
  %105 = fmul float %104, %45, !dbg !160
  tail call void @llvm.dbg.value(metadata float %105, metadata !86, metadata !DIExpression()), !dbg !158
  %106 = fmul float %66, %100, !dbg !161
  %107 = fmul float %71, %105, !dbg !162
  %108 = fsub float %106, %107, !dbg !163
  %109 = add i64 %95, %76, !dbg !164
  %110 = trunc i64 %109 to i32, !dbg !164
  %111 = shl nsw i32 %110, 1, !dbg !164
  %112 = sext i32 %111 to i64, !dbg !164
  %113 = getelementptr inbounds float, ptr %6, i64 %112, !dbg !164
  %114 = load float, ptr %113, align 4, !dbg !165, !tbaa !136
  %115 = fadd float %114, %108, !dbg !165
  store float %115, ptr %113, align 4, !dbg !165, !tbaa !136
  %116 = fmul float %66, %105, !dbg !166
  %117 = fmul float %71, %100, !dbg !167
  %118 = fadd float %117, %116, !dbg !168
  %119 = or disjoint i32 %111, 1, !dbg !169
  %120 = sext i32 %119 to i64, !dbg !169
  %121 = getelementptr inbounds float, ptr %6, i64 %120, !dbg !169
  %122 = load float, ptr %121, align 4, !dbg !170, !tbaa !136
  %123 = fadd float %122, %118, !dbg !170
  store float %123, ptr %121, align 4, !dbg !170, !tbaa !136
...
137:                                              ; preds = %131
  %138 = sitofp i32 %11 to float
  %139 = fmul float %138, %3
  %140 = sitofp i32 %10 to float
  %141 = shl i32 %7, 1
  %142 = add i32 %141, 2
...
147:                                              ; preds = %137, %200
  ...
  %153 = getelementptr inbounds float, ptr %4, i64 %152, !dbg !180
  %154 = load float, ptr %153, align 4, !dbg !180, !tbaa !136
  %155 = fmul float %154, %3, !dbg !181
  tail call void @llvm.dbg.value(metadata float %155, metadata !90, metadata !DIExpression()), !dbg !182
  %156 = or disjoint i32 %151, 1, !dbg !183
  %157 = sext i32 %156 to i64, !dbg !183
  %158 = getelementptr inbounds float, ptr %4, i64 %157, !dbg !183
  %159 = load float, ptr %158, align 4, !dbg !183, !tbaa !136
  %160 = fmul float %139, %159, !dbg !184
  tail call void @llvm.dbg.value(metadata float %160, metadata !94, metadata !DIExpression()), !dbg !182
...
164:                                              ; preds = %162, %164
  ...
  %170 = getelementptr inbounds float, ptr %4, i64 %169, !dbg !187
  %171 = load float, ptr %170, align 4, !dbg !187, !tbaa !136
  tail call void @llvm.dbg.value(metadata float %171, metadata !96, metadata !DIExpression()), !dbg !188
  %172 = or disjoint i32 %168, 1, !dbg !189
  %173 = sext i32 %172 to i64, !dbg !189
  %174 = getelementptr inbounds float, ptr %4, i64 %173, !dbg !189
  %175 = load float, ptr %174, align 4, !dbg !189, !tbaa !136
  %176 = fmul float %175, %140, !dbg !190
  tail call void @llvm.dbg.value(metadata float %176, metadata !100, metadata !DIExpression()), !dbg !188
  %177 = fmul float %155, %171, !dbg !191
  %178 = fmul float %160, %176, !dbg !192
  %179 = fsub float %177, %178, !dbg !193
  %180 = add i64 %166, %163, !dbg !194
  %181 = trunc i64 %180 to i32, !dbg !194
  %182 = shl nsw i32 %181, 1, !dbg !194
  %183 = sext i32 %182 to i64, !dbg !194
  %184 = getelementptr inbounds float, ptr %6, i64 %183, !dbg !194
  %185 = load float, ptr %184, align 4, !dbg !195, !tbaa !136
  %186 = fadd float %185, %179, !dbg !195
  store float %186, ptr %184, align 4, !dbg !195, !tbaa !136
  %187 = fmul float %155, %176, !dbg !196
  %188 = fmul float %160, %171, !dbg !197
  %189 = fadd float %188, %187, !dbg !198
  %190 = or disjoint i32 %182, 1, !dbg !199
  %191 = sext i32 %190 to i64, !dbg !199
  %192 = getelementptr inbounds float, ptr %6, i64 %191, !dbg !199
  %193 = load float, ptr %192, align 4, !dbg !200, !tbaa !136
  %194 = fadd float %193, %189, !dbg !200
  store float %194, ptr %192, align 4, !dbg !200, !tbaa !136
...
200:                                              ; preds = %198, %147
  ...
  %204 = getelementptr inbounds float, ptr %4, i64 %203, !dbg !205
  %205 = load float, ptr %204, align 4, !dbg !205, !tbaa !136
  tail call void @llvm.dbg.value(metadata float %205, metadata !101, metadata !DIExpression()), !dbg !206
  %206 = or disjoint i32 %202, 1, !dbg !207
  %207 = sext i32 %206 to i64, !dbg !207
  %208 = getelementptr inbounds float, ptr %4, i64 %207, !dbg !207
  %209 = load float, ptr %208, align 4, !dbg !207, !tbaa !136
  %210 = fmul float %209, %140, !dbg !208
  tail call void @llvm.dbg.value(metadata float %210, metadata !103, metadata !DIExpression()), !dbg !206
  %211 = fmul float %155, %205, !dbg !209
  %212 = fmul float %160, %210, !dbg !210
  %213 = fsub float %211, %212, !dbg !211
  %214 = trunc i64 %149 to i32, !dbg !212
  %215 = mul i32 %142, %214, !dbg !212
  %216 = sext i32 %215 to i64, !dbg !212
  %217 = getelementptr inbounds float, ptr %6, i64 %216, !dbg !212
  %218 = load float, ptr %217, align 4, !dbg !213, !tbaa !136
  %219 = fadd float %218, %213, !dbg !213
  store float %219, ptr %217, align 4, !dbg !213, !tbaa !136
  %220 = or disjoint i32 %215, 1, !dbg !214
  %221 = sext i32 %220 to i64, !dbg !214
  %222 = getelementptr inbounds float, ptr %6, i64 %221, !dbg !214
  store float 0.000000e+00, ptr %222, align 4, !dbg !215, !tbaa !136
