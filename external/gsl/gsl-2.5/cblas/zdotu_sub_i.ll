; ModuleID = 'zdotu_sub.ll'
source_filename = "zdotu_sub.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

; Function Attrs: nofree norecurse nosync nounwind memory(argmem: readwrite) uwtable
define dso_local void @cblas_zdotu_sub(i32 noundef %0, ptr nocapture noundef readonly %1, i32 noundef %2, ptr nocapture noundef readonly %3, i32 noundef %4, ptr nocapture noundef writeonly %5) local_unnamed_addr #0 !dbg !15 {
  ...
  br i1 %7, label %8, label %52, !dbg !48
...
20:                                               ; preds = %20, %8
  %21 = phi i64 [ %18, %8 ], [ %49, %20 ]
  %22 = phi i64 [ %16, %8 ], [ %48, %20 ]
  %23 = phi double [ 0.000000e+00, %8 ], [ %handler_result1, %20 ]
  %24 = phi double [ 0.000000e+00, %8 ], [ %handler_result3, %20 ]
  %25 = phi i32 [ 0, %8 ], [ %50, %20 ]
  ...
  %handler_result = call double @fSubHandlerDouble(double %44, double %45), !dbg !62
  %handler_result1 = call double @fAddHandlerDouble(double %23, double %handler_result), !dbg !63
  tail call void @llvm.dbg.value(metadata double %handler_result1, metadata !30, metadata !DIExpression()), !dbg !46
  %46 = fmul double %30, %43, !dbg !63
  %47 = fmul double %34, %39, !dbg !64
  %handler_result2 = call double @fAddHandlerDouble(double %47, double %46), !dbg !65
  %handler_result3 = call double @fAddHandlerDouble(double %24, double %handler_result2), !dbg !66
  tail call void @llvm.dbg.value(metadata double %handler_result3, metadata !34, metadata !DIExpression()), !dbg !46
  %48 = add i64 %22, %17, !dbg !66
  tail call void @llvm.dbg.value(metadata i64 %48, metadata !36, metadata !DIExpression()), !dbg !46
  %49 = add i64 %21, %19, !dbg !67
  tail call void @llvm.dbg.value(metadata i64 %49, metadata !37, metadata !DIExpression()), !dbg !46
  %50 = add nuw nsw i32 %25, 1, !dbg !68
  tail call void @llvm.dbg.value(metadata i32 %50, metadata !35, metadata !DIExpression()), !dbg !46
  %51 = icmp eq i32 %50, %0, !dbg !47
  br i1 %51, label %52, label %20, !dbg !48, !llvm.loop !69

52:                                               ; preds = %20, %6
  %53 = phi double [ 0.000000e+00, %6 ], [ %handler_result3, %20 ], !dbg !46
  %54 = phi double [ 0.000000e+00, %6 ], [ %handler_result1, %20 ], !dbg !46
  store double %54, ptr %5, align 8, !dbg !72, !tbaa !52
  %55 = getelementptr inbounds double, ptr %5, i64 1, !dbg !73
  store double %53, ptr %55, align 8, !dbg !74, !tbaa !52
  ret void, !dbg !75
}
...
!1 = !DIFile(filename: "zdotu_sub.c", directory: "/PI-detector/external/gsl/gsl-2.5/cblas", checksumkind: CSK_MD5, checksum: "74b93d1f017b454dbb9bf5d8c302ebe3")
!2 = !{!3, !6}
...
!15 = distinct !DISubprogram(name: "cblas_zdotu_sub", scope: !1, file: !1, line: 6, type: !16, scopeLine: 8, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !23)
...
!61 = !DILocation(line: 31, column: 52, scope: !39)
!62 = !DILocation(line: 31, column: 12, scope: !39)
!63 = !DILocation(line: 32, column: 22, scope: !39)
!64 = !DILocation(line: 32, column: 52, scope: !39)
