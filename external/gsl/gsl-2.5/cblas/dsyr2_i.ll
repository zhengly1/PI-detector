...
define dso_local void @cblas_dsyr2(i32 noundef %0, i32 noundef %1, i32 noundef %2, double noundef %3, ptr nocapture noundef readonly %4, i32 noundef %5, ptr nocapture noundef readonly %6, i32 noundef %7, ptr nocapture noundef %8, i32 noundef %9) local_unnamed_addr #0 !dbg !39 {
  ...
  tail call void @llvm.dbg.value(metadata double %3, metadata !54, metadata !DIExpression()), !dbg !89
...
28:                                               ; preds = %27, %10
  ...
  br i1 %31, label %176, label %32, !dbg !108
...
36:                                               ; preds = %32
  ...
  br i1 %39, label %40, label %89, !dbg !112
...
40:                                               ; preds = %36, %32
  ...
  br i1 %41, label %42, label %176, !dbg !116
...
56:                                               ; preds = %84, %42
  %57 = phi i64 [ %52, %42 ], [ %85, %84 ]
  %58 = phi i64 [ %50, %42 ], [ %86, %84 ]
  %59 = phi i64 [ 0, %42 ], [ %87, %84 ]
  ...
  %60 = getelementptr inbounds double, ptr %4, i64 %57, !dbg !119
  %61 = load double, ptr %60, align 8, !dbg !119, !tbaa !120
  %62 = fmul double %61, %3, !dbg !124
  tail call void @llvm.dbg.value(metadata double %62, metadata !71, metadata !DIExpression()), !dbg !125
  %63 = getelementptr inbounds double, ptr %6, i64 %58, !dbg !126
  %64 = load double, ptr %63, align 8, !dbg !126, !tbaa !120
  %65 = fmul double %64, %3, !dbg !127
  tail call void @llvm.dbg.value(metadata double %65, metadata !75, metadata !DIExpression()), !dbg !125
  ...
  %67 = getelementptr double, ptr %8, i64 %66, !dbg !128
  br label %68, !dbg !128

68:                                               ; preds = %68, %56
  %69 = phi i64 [ %57, %56 ], [ %80, %68 ]
  %70 = phi i64 [ %58, %56 ], [ %81, %68 ]
  %71 = phi i64 [ %59, %56 ], [ %82, %68 ]
  ...
  %72 = getelementptr inbounds double, ptr %6, i64 %70, !dbg !130
  %73 = load double, ptr %72, align 8, !dbg !130, !tbaa !120
  %74 = fmul double %62, %73, !dbg !133
  %75 = getelementptr inbounds double, ptr %4, i64 %69, !dbg !134
  %76 = load double, ptr %75, align 8, !dbg !134, !tbaa !120
  %77 = fmul double %65, %76, !dbg !135
  %handler_result = call double @fAddHandlerDouble(double %74, double %77), !dbg !136
  %78 = getelementptr double, ptr %67, i64 %71, !dbg !136
  %79 = load double, ptr %78, align 8, !dbg !137, !tbaa !120
  %handler_result1 = call double @fAddHandlerDouble(double %79, double %handler_result), !dbg !137
  store double %handler_result1, ptr %78, align 8, !dbg !137, !tbaa !120
  %80 = add i64 %69, %53, !dbg !138
  tail call void @llvm.dbg.value(metadata i64 %80, metadata !76, metadata !DIExpression()), !dbg !125
  %81 = add i64 %70, %51, !dbg !139
  tail call void @llvm.dbg.value(metadata i64 %81, metadata !77, metadata !DIExpression()), !dbg !125
  %82 = add nuw nsw i64 %71, 1, !dbg !140
  tail call void @llvm.dbg.value(metadata i64 %82, metadata !64, metadata !DIExpression()), !dbg !114
  %83 = icmp eq i64 %82, %55, !dbg !141
  br i1 %83, label %84, label %68, !dbg !128, !llvm.loop !142

84:                                               ; preds = %68
  %85 = add i64 %57, %53, !dbg !145
  tail call void @llvm.dbg.value(metadata i64 %85, metadata !67, metadata !DIExpression()), !dbg !113
  %86 = add i64 %58, %51, !dbg !146
  tail call void @llvm.dbg.value(metadata i64 %86, metadata !70, metadata !DIExpression()), !dbg !113
  %87 = add nuw nsw i64 %59, 1, !dbg !147
  tail call void @llvm.dbg.value(metadata i64 %87, metadata !61, metadata !DIExpression()), !dbg !114
  %88 = icmp eq i64 %87, %55, !dbg !115
  br i1 %88, label %176, label %56, !dbg !116, !llvm.loop !148

89:                                               ; preds = %36
  %90 = and i1 %33, %38, !dbg !150
  %91 = and i1 %37, %34
  %92 = or i1 %90, %91, !dbg !150
  br i1 %92, label %93, label %175, !dbg !150
...
93:                                               ; preds = %89
  ...
  tail call void @llvm.dbg.value(metadata i32 0, metadata !61, metadata !DIExpression()), !dbg !114
  tail call void @llvm.dbg.value(metadata i32 poison, metadata !78, metadata !DIExpression()), !dbg !151
  %94 = icmp sgt i32 %2, 0, !dbg !152
  br i1 %94, label %95, label %176, !dbg !153

95:                                               ; preds = %93
  %96 = icmp sgt i32 %7, 0, !dbg !154
  %97 = sub nsw i32 1, %2, !dbg !155
  %98 = mul i32 %97, %7, !dbg !154
  %99 = select i1 %96, i32 0, i32 %98, !dbg !154
  tail call void @llvm.dbg.value(metadata i32 %99, metadata !81, metadata !DIExpression()), !dbg !151
  %100 = icmp sgt i32 %5, 0, !dbg !155
  %101 = mul i32 %97, %5, !dbg !155
  %102 = select i1 %100, i32 0, i32 %101, !dbg !155
  tail call void @llvm.dbg.value(metadata i32 %102, metadata !78, metadata !DIExpression()), !dbg !151
  %103 = sext i32 %99 to i64, !dbg !153
  %104 = sext i32 %7 to i64, !dbg !153
  %105 = sext i32 %102 to i64, !dbg !153
  %106 = sext i32 %5 to i64, !dbg !153
  %107 = sext i32 %9 to i64, !dbg !153
  %108 = zext nneg i32 %2 to i64, !dbg !152
  br label %109, !dbg !153

109:                                              ; preds = %169, %95
  %110 = phi i64 [ %105, %95 ], [ %170, %169 ]
  %111 = phi i64 [ %103, %95 ], [ %171, %169 ]
  %112 = phi i64 [ 0, %95 ], [ %172, %169 ]
  %113 = phi i64 [ 1, %95 ], [ %173, %169 ]
  tail call void @llvm.dbg.value(metadata i64 %112, metadata !61, metadata !DIExpression()), !dbg !114
  tail call void @llvm.dbg.value(metadata i64 %111, metadata !81, metadata !DIExpression()), !dbg !151
  tail call void @llvm.dbg.value(metadata i64 %110, metadata !78, metadata !DIExpression()), !dbg !151
  %114 = getelementptr inbounds double, ptr %4, i64 %110, !dbg !156
  %115 = load double, ptr %114, align 8, !dbg !156, !tbaa !120
  %116 = fmul double %115, %3, !dbg !157
  tail call void @llvm.dbg.value(metadata double %116, metadata !82, metadata !DIExpression()), !dbg !158
  %117 = getelementptr inbounds double, ptr %6, i64 %111, !dbg !159
  %118 = load double, ptr %117, align 8, !dbg !159, !tbaa !120
  %119 = fmul double %118, %3, !dbg !160
  tail call void @llvm.dbg.value(metadata double %119, metadata !86, metadata !DIExpression()), !dbg !158
  ...
  %120 = mul nsw i64 %112, %107
  tail call void @llvm.dbg.value(metadata i32 poison, metadata !88, metadata !DIExpression()), !dbg !158
  tail call void @llvm.dbg.value(metadata i32 poison, metadata !87, metadata !DIExpression()), !dbg !158
  tail call void @llvm.dbg.value(metadata i32 0, metadata !64, metadata !DIExpression()), !dbg !114
  %121 = getelementptr double, ptr %8, i64 %120, !dbg !161
  %122 = and i64 %113, 1, !dbg !161
  %123 = icmp eq i64 %112, 0, !dbg !161
  br i1 %123, label %155, label %124, !dbg !161

124:                                              ; preds = %109
  %125 = and i64 %113, 9223372036854775806, !dbg !161
  br label %126, !dbg !161

126:                                              ; preds = %126, %124
  %127 = phi i64 [ 0, %124 ], [ %152, %126 ]
  %128 = phi i64 [ %105, %124 ], [ %150, %126 ]
  %129 = phi i64 [ %103, %124 ], [ %151, %126 ]
  %130 = phi i64 [ 0, %124 ], [ %153, %126 ]
  tail call void @llvm.dbg.value(metadata i64 %129, metadata !88, metadata !DIExpression()), !dbg !158
  tail call void @llvm.dbg.value(metadata i64 %128, metadata !87, metadata !DIExpression()), !dbg !158
  tail call void @llvm.dbg.value(metadata i64 %127, metadata !64, metadata !DIExpression()), !dbg !114
  %131 = getelementptr inbounds double, ptr %6, i64 %129, !dbg !163
  %132 = load double, ptr %131, align 8, !dbg !163, !tbaa !120
  %133 = fmul double %116, %132, !dbg !166
  %134 = getelementptr inbounds double, ptr %4, i64 %128, !dbg !167
  %135 = load double, ptr %134, align 8, !dbg !167, !tbaa !120
  %136 = fmul double %119, %135, !dbg !168
  %handler_result2 = call double @fAddHandlerDouble(double %133, double %136), !dbg !169
  %137 = getelementptr double, ptr %121, i64 %127, !dbg !169
  %138 = load double, ptr %137, align 8, !dbg !170, !tbaa !120
  %handler_result3 = call double @fAddHandlerDouble(double %138, double %handler_result2), !dbg !170
  store double %handler_result3, ptr %137, align 8, !dbg !170, !tbaa !120
  %139 = add i64 %128, %106, !dbg !171
  tail call void @llvm.dbg.value(metadata i64 %139, metadata !87, metadata !DIExpression()), !dbg !158
  %140 = add i64 %129, %104, !dbg !172
  tail call void @llvm.dbg.value(metadata i64 %140, metadata !88, metadata !DIExpression()), !dbg !158
  %141 = or disjoint i64 %127, 1, !dbg !173
  tail call void @llvm.dbg.value(metadata i64 %141, metadata !64, metadata !DIExpression()), !dbg !114
  tail call void @llvm.dbg.value(metadata i64 %140, metadata !88, metadata !DIExpression()), !dbg !158
  tail call void @llvm.dbg.value(metadata i64 %139, metadata !87, metadata !DIExpression()), !dbg !158
  tail call void @llvm.dbg.value(metadata i64 %141, metadata !64, metadata !DIExpression()), !dbg !114
  %142 = getelementptr inbounds double, ptr %6, i64 %140, !dbg !163
  %143 = load double, ptr %142, align 8, !dbg !163, !tbaa !120
  %144 = fmul double %116, %143, !dbg !166
  %145 = getelementptr inbounds double, ptr %4, i64 %139, !dbg !167
  %146 = load double, ptr %145, align 8, !dbg !167, !tbaa !120
  %147 = fmul double %119, %146, !dbg !168
  %handler_result4 = call double @fAddHandlerDouble(double %144, double %147), !dbg !169
  %148 = getelementptr double, ptr %121, i64 %141, !dbg !169
  %149 = load double, ptr %148, align 8, !dbg !170, !tbaa !120
  %handler_result5 = call double @fAddHandlerDouble(double %149, double %handler_result4), !dbg !170
  store double %handler_result5, ptr %148, align 8, !dbg !170, !tbaa !120
  %150 = add i64 %139, %106, !dbg !171
  tail call void @llvm.dbg.value(metadata i64 %150, metadata !87, metadata !DIExpression()), !dbg !158
  %151 = add i64 %140, %104, !dbg !172
  tail call void @llvm.dbg.value(metadata i64 %151, metadata !88, metadata !DIExpression()), !dbg !158
  %152 = add nuw nsw i64 %127, 2, !dbg !173
  tail call void @llvm.dbg.value(metadata i64 %152, metadata !64, metadata !DIExpression()), !dbg !114
  %153 = add i64 %130, 2, !dbg !161
  %154 = icmp eq i64 %153, %125, !dbg !161
  br i1 %154, label %155, label %126, !dbg !161, !llvm.loop !174

155:                                              ; preds = %126, %109
  %156 = phi i64 [ 0, %109 ], [ %152, %126 ]
  %157 = phi i64 [ %105, %109 ], [ %150, %126 ]
  %158 = phi i64 [ %103, %109 ], [ %151, %126 ]
  %159 = icmp eq i64 %122, 0, !dbg !161
  br i1 %159, label %169, label %160, !dbg !161

160:                                              ; preds = %155
  tail call void @llvm.dbg.value(metadata i64 %158, metadata !88, metadata !DIExpression()), !dbg !158
  tail call void @llvm.dbg.value(metadata i64 %157, metadata !87, metadata !DIExpression()), !dbg !158
  tail call void @llvm.dbg.value(metadata i64 %156, metadata !64, metadata !DIExpression()), !dbg !114
  %161 = getelementptr inbounds double, ptr %6, i64 %158, !dbg !163
  %162 = load double, ptr %161, align 8, !dbg !163, !tbaa !120
  %163 = fmul double %116, %162, !dbg !166
  %164 = getelementptr inbounds double, ptr %4, i64 %157, !dbg !167
  %165 = load double, ptr %164, align 8, !dbg !167, !tbaa !120
  %166 = fmul double %119, %165, !dbg !168
  %handler_result6 = call double @fAddHandlerDouble(double %163, double %166), !dbg !169
  %167 = getelementptr double, ptr %121, i64 %156, !dbg !169
  %168 = load double, ptr %167, align 8, !dbg !170, !tbaa !120
  %handler_result7 = call double @fAddHandlerDouble(double %168, double %handler_result6), !dbg !170
  store double %handler_result7, ptr %167, align 8, !dbg !170, !tbaa !120
  tail call void @llvm.dbg.value(metadata !DIArgList(i64 %157, i64 %106), metadata !87, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_plus, DW_OP_stack_value)), !dbg !158
  tail call void @llvm.dbg.value(metadata !DIArgList(i64 %158, i64 %104), metadata !88, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_plus, DW_OP_stack_value)), !dbg !158
  tail call void @llvm.dbg.value(metadata i64 %156, metadata !64, metadata !DIExpression(DW_OP_plus_uconst, 1, DW_OP_stack_value)), !dbg !114
  br label %169, !dbg !176

169:                                              ; preds = %160, %155
  %170 = add i64 %110, %106, !dbg !176
  tail call void @llvm.dbg.value(metadata i64 %170, metadata !78, metadata !DIExpression()), !dbg !151
  %171 = add i64 %111, %104, !dbg !177
  tail call void @llvm.dbg.value(metadata i64 %171, metadata !81, metadata !DIExpression()), !dbg !151
  %172 = add nuw nsw i64 %112, 1, !dbg !178
  tail call void @llvm.dbg.value(metadata i64 %172, metadata !61, metadata !DIExpression()), !dbg !114
  %173 = add nuw nsw i64 %113, 1, !dbg !153
  %174 = icmp eq i64 %172, %108, !dbg !152
  br i1 %174, label %176, label %109, !dbg !153, !llvm.loop !179

175:                                              ; preds = %89
  tail call void (i32, ptr, ptr, ...) @cblas_xerbla(i32 noundef 0, ptr noundef nonnull @.str, ptr noundef nonnull @.str.2) #3, !dbg !181
  br label %176

176:                                              ; preds = %175, %169, %93, %84, %40, %28
  ret void, !dbg !183
}
...
!18 = !DIFile(filename: "dsyr2.c", directory: "/PI-detector/external/gsl/gsl-2.5/cblas", checksumkind: CSK_MD5, checksum: "f4783091d63e1c09c26e05eaea1715e8")
!19 = !{!20, !26}
...
!39 = distinct !DISubprogram(name: "cblas_dsyr2", scope: !18, file: !18, line: 7, type: !40, scopeLine: 10, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !17, retainedNodes: !50)
