...
76:                                               ; preds = %76, %74
  ...
  tail call void @llvm.dbg.value(metadata double poison, metadata !84, metadata !DIExpression()), !dbg !146
  %88 = fmul double %handler_result, %83, !dbg !148
  %89 = fmul double %handler_result1, %87, !dbg !149
  %handler_result2 = call double @fAddHandlerDouble(double %88, double %89), !dbg !150
  ...
  %96 = fmul double %handler_result1, %83, !dbg !152
  %97 = fmul double %handler_result, %87, !dbg !153
  %handler_result4 = call double @fSubHandlerDouble(double %96, double %97), !dbg !154
...
130:                                              ; preds = %177, %113
  ...
  tail call void @llvm.dbg.value(metadata double poison, metadata !92, metadata !DIExpression()), !dbg !173
  %142 = fmul double %36, %137, !dbg !175
  %143 = fmul double %38, %141, !dbg !176
  %handler_result6 = call double @fAddHandlerDouble(double %142, double %143), !dbg !177
  ...
  %handler_result7 = call double @fSubHandlerDouble(double %144, double %145), !dbg !179
