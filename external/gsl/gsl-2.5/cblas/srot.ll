; ModuleID = 'srot.c'
source_filename = "srot.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

; Function Attrs: nofree norecurse nosync nounwind memory(argmem: readwrite) uwtable
define dso_local void @cblas_srot(i32 noundef %0, ptr nocapture noundef %1, i32 noundef %2, ptr nocapture noundef %3, i32 noundef %4, float noundef %5, float noundef %6) local_unnamed_addr #0 !dbg !10 {
  ...
  tail call void @llvm.dbg.value(metadata float %5, metadata !24, metadata !DIExpression()), !dbg !37
  tail call void @llvm.dbg.value(metadata float %6, metadata !25, metadata !DIExpression()), !dbg !37
  ...
  br i1 %8, label %9, label %39, !dbg !40
...
21:                                               ; preds = %9, %21
  %22 = phi i64 [ %19, %9 ], [ %36, %21 ]
  %23 = phi i64 [ %17, %9 ], [ %35, %21 ]
  %24 = phi i32 [ 0, %9 ], [ %37, %21 ]
  ...
  %25 = getelementptr inbounds float, ptr %1, i64 %23, !dbg !43
  %26 = load float, ptr %25, align 4, !dbg !43, !tbaa !44
  tail call void @llvm.dbg.value(metadata float %26, metadata !32, metadata !DIExpression()), !dbg !48
  %27 = getelementptr inbounds float, ptr %3, i64 %22, !dbg !49
  %28 = load float, ptr %27, align 4, !dbg !49, !tbaa !44
  tail call void @llvm.dbg.value(metadata float %28, metadata !36, metadata !DIExpression()), !dbg !48
  %29 = fmul float %26, %5, !dbg !50
  %30 = fmul float %28, %6, !dbg !51
  %31 = fadd float %29, %30, !dbg !52
  store float %31, ptr %25, align 4, !dbg !53, !tbaa !44
  %32 = fmul float %28, %5, !dbg !54
  %33 = fmul float %26, %6, !dbg !55
  %34 = fsub float %32, %33, !dbg !55
  store float %34, ptr %27, align 4, !dbg !56, !tbaa !44
  %35 = add i64 %23, %18, !dbg !57
  tail call void @llvm.dbg.value(metadata i64 %35, metadata !30, metadata !DIExpression()), !dbg !38
  %36 = add i64 %22, %20, !dbg !58
  tail call void @llvm.dbg.value(metadata i64 %36, metadata !31, metadata !DIExpression()), !dbg !38
  %37 = add nuw nsw i32 %24, 1, !dbg !59
  tail call void @llvm.dbg.value(metadata i32 %37, metadata !26, metadata !DIExpression()), !dbg !38
  %38 = icmp eq i32 %37, %0, !dbg !39
  br i1 %38, label %39, label %21, !dbg !40, !llvm.loop !60
...
!1 = !DIFile(filename: "srot.c", directory: "/PI-detector/external/gsl/gsl-2.5/cblas", checksumkind: CSK_MD5, checksum: "88e23a22ed18deb63844ef9fa2eb405f")
...
!10 = distinct !DISubprogram(name: "cblas_srot", scope: !1, file: !1, line: 6, type: !11, scopeLine: 8, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !18)
...
!52 = !DILocation(line: 27, column: 19, scope: !33)
!53 = !DILocation(line: 27, column: 11, scope: !33)
!54 = !DILocation(line: 28, column: 24, scope: !33)
!55 = !DILocation(line: 28, column: 20, scope: !33)
!56 = !DILocation(line: 28, column: 11, scope: !33)
!57 = !DILocation(line: 29, column: 8, scope: !33)
!58 = !DILocation(line: 30, column: 8, scope: !33)
!59 = !DILocation(line: 24, column: 23, scope: !34)
!60 = distinct !{!60, !40, !61, !62}
!61 = !DILocation(line: 31, column: 3, scope: !35)
!62 = !{!"llvm.loop.mustprogress"}
!63 = !DILocation(line: 12, column: 1, scope: !64)
!64 = !DILexicalBlockFile(scope: !10, file: !1, discriminator: 0)
