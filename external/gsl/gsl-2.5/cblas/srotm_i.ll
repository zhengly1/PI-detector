...
define dso_local void @cblas_srotm(i32 noundef %0, ptr nocapture noundef %1, i32 noundef %2, ptr nocapture noundef %3, i32 noundef %4, ptr nocapture noundef readonly %5) local_unnamed_addr #0 !dbg !23 {
  ...
  %14 = load float, ptr %5, align 4, !dbg !57, !tbaa !59
  %15 = fcmp oeq float %14, -1.000000e+00, !dbg !63
  br i1 %15, label %16, label %25, !dbg !64

16:                                               ; preds = %6
  %17 = getelementptr inbounds float, ptr %5, i64 1, !dbg !65
  %18 = load float, ptr %17, align 4, !dbg !65, !tbaa !59
  tail call void @llvm.dbg.value(metadata float %18, metadata !44, metadata !DIExpression()), !dbg !55
  %19 = getelementptr inbounds float, ptr %5, i64 2, !dbg !67
  %20 = load float, ptr %19, align 4, !dbg !67, !tbaa !59
  tail call void @llvm.dbg.value(metadata float %20, metadata !45, metadata !DIExpression()), !dbg !55
  %21 = getelementptr inbounds float, ptr %5, i64 3, !dbg !68
  %22 = load float, ptr %21, align 4, !dbg !68, !tbaa !59
  tail call void @llvm.dbg.value(metadata float %22, metadata !46, metadata !DIExpression()), !dbg !55
  %23 = getelementptr inbounds float, ptr %5, i64 4, !dbg !69
  %24 = load float, ptr %23, align 4, !dbg !69, !tbaa !59
  tail call void @llvm.dbg.value(metadata float %24, metadata !47, metadata !DIExpression()), !dbg !55
  br label %42, !dbg !70

25:                                               ; preds = %6
  %26 = fcmp oeq float %14, 0.000000e+00, !dbg !71
  br i1 %26, label %27, label %32, !dbg !73

27:                                               ; preds = %25
  tail call void @llvm.dbg.value(metadata float 1.000000e+00, metadata !44, metadata !DIExpression()), !dbg !55
  %28 = getelementptr inbounds float, ptr %5, i64 2, !dbg !74
  %29 = load float, ptr %28, align 4, !dbg !74, !tbaa !59
  tail call void @llvm.dbg.value(metadata float %29, metadata !45, metadata !DIExpression()), !dbg !55
  %30 = getelementptr inbounds float, ptr %5, i64 3, !dbg !76
  %31 = load float, ptr %30, align 4, !dbg !76, !tbaa !59
  tail call void @llvm.dbg.value(metadata float %31, metadata !46, metadata !DIExpression()), !dbg !55
  tail call void @llvm.dbg.value(metadata float 1.000000e+00, metadata !47, metadata !DIExpression()), !dbg !55
  br label %42, !dbg !77

32:                                               ; preds = %25
  %33 = fcmp oeq float %14, 1.000000e+00, !dbg !78
  br i1 %33, label %34, label %39, !dbg !80

34:                                               ; preds = %32
  %35 = getelementptr inbounds float, ptr %5, i64 1, !dbg !81
  %36 = load float, ptr %35, align 4, !dbg !81, !tbaa !59
  tail call void @llvm.dbg.value(metadata float %36, metadata !44, metadata !DIExpression()), !dbg !55
  tail call void @llvm.dbg.value(metadata float -1.000000e+00, metadata !45, metadata !DIExpression()), !dbg !55
  tail call void @llvm.dbg.value(metadata float 1.000000e+00, metadata !46, metadata !DIExpression()), !dbg !55
  %37 = getelementptr inbounds float, ptr %5, i64 4, !dbg !83
  %38 = load float, ptr %37, align 4, !dbg !83, !tbaa !59
  tail call void @llvm.dbg.value(metadata float %38, metadata !47, metadata !DIExpression()), !dbg !55
  br label %42

39:                                               ; preds = %32
  %40 = fcmp oeq float %14, -2.000000e+00, !dbg !84
  br i1 %40, label %77, label %41, !dbg !86
...
42:                                               ; preds = %34, %27, %16
  %43 = phi float [ %18, %16 ], [ 1.000000e+00, %27 ], [ %36, %34 ], !dbg !90
  %44 = phi float [ %20, %16 ], [ %29, %27 ], [ -1.000000e+00, %34 ], !dbg !90
  %45 = phi float [ %22, %16 ], [ %31, %27 ], [ 1.000000e+00, %34 ], !dbg !90
  %46 = phi float [ %24, %16 ], [ 1.000000e+00, %27 ], [ %38, %34 ], !dbg !90
  tail call void @llvm.dbg.value(metadata float %46, metadata !47, metadata !DIExpression()), !dbg !55
  tail call void @llvm.dbg.value(metadata float %45, metadata !46, metadata !DIExpression()), !dbg !55
  tail call void @llvm.dbg.value(metadata float %44, metadata !45, metadata !DIExpression()), !dbg !55
  tail call void @llvm.dbg.value(metadata float %43, metadata !44, metadata !DIExpression()), !dbg !55
  tail call void @llvm.dbg.value(metadata i32 0, metadata !39, metadata !DIExpression()), !dbg !55
  tail call void @llvm.dbg.value(metadata i32 %10, metadata !42, metadata !DIExpression()), !dbg !55
  tail call void @llvm.dbg.value(metadata i32 %13, metadata !43, metadata !DIExpression()), !dbg !55
  %47 = icmp sgt i32 %0, 0, !dbg !91
  br i1 %47, label %48, label %77, !dbg !92
...
53:                                               ; preds = %53, %48
  %54 = phi i64 [ %51, %48 ], [ %74, %53 ]
  %55 = phi i64 [ %49, %48 ], [ %73, %53 ]
  %56 = phi i32 [ 0, %48 ], [ %75, %53 ]
  ...
  %57 = getelementptr inbounds float, ptr %1, i64 %55, !dbg !93
  %58 = load float, ptr %57, align 4, !dbg !93, !tbaa !59
  tail call void @llvm.dbg.value(metadata float %58, metadata !48, metadata !DIExpression()), !dbg !94
  %59 = getelementptr inbounds float, ptr %3, i64 %54, !dbg !95
  %60 = load float, ptr %59, align 4, !dbg !95, !tbaa !59
  tail call void @llvm.dbg.value(metadata float %60, metadata !52, metadata !DIExpression()), !dbg !94
  %61 = fmul float %43, %58, !dbg !96
  %62 = fmul float %45, %60, !dbg !97
  %63 = fpext float %61 to double, !dbg !98
  %64 = fpext float %62 to double, !dbg !98
  %65 = fptrunc double %63 to float, !dbg !98
  %66 = fptrunc double %64 to float, !dbg !98
  %handler_result = call float @fAddHandlerFloat(float %65, float %66), !dbg !98
  store float %handler_result, ptr %57, align 4, !dbg !98, !tbaa !59
  %67 = fmul float %44, %58, !dbg !99
  %68 = fmul float %46, %60, !dbg !100
  %69 = fpext float %67 to double, !dbg !101
  %70 = fpext float %68 to double, !dbg !101
  %71 = fptrunc double %69 to float, !dbg !101
  %72 = fptrunc double %70 to float, !dbg !101
  %handler_result1 = call float @fAddHandlerFloat(float %71, float %72), !dbg !101
  store float %handler_result1, ptr %59, align 4, !dbg !101, !tbaa !59
  %73 = add i64 %55, %50, !dbg !102
  tail call void @llvm.dbg.value(metadata i64 %73, metadata !42, metadata !DIExpression()), !dbg !55
  %74 = add i64 %54, %52, !dbg !103
  tail call void @llvm.dbg.value(metadata i64 %74, metadata !43, metadata !DIExpression()), !dbg !55
  %75 = add nuw nsw i32 %56, 1, !dbg !104
  tail call void @llvm.dbg.value(metadata i32 %75, metadata !39, metadata !DIExpression()), !dbg !55
  %76 = icmp eq i32 %75, %0, !dbg !91
  br i1 %76, label %77, label %53, !dbg !92, !llvm.loop !105

77:                                               ; preds = %53, %42, %41, %39
  ret void, !dbg !108
}

declare !dbg !110 void @cblas_xerbla(i32 noundef, ptr noundef, ptr noundef, ...) local_unnamed_addr #1
...
!13 = !DIFile(filename: "srotm.c", directory: "/PI-detector/external/gsl/gsl-2.5/cblas", checksumkind: CSK_MD5, checksum: "0390cac9556f3ac0a27653b62d0def80")
!14 = !{!0, !7}
...
!23 = distinct !DISubprogram(name: "cblas_srotm", scope: !13, file: !13, line: 6, type: !24, scopeLine: 8, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !12, retainedNodes: !32)
...
!37 = !DILocalVariable(name: "incY", arg: 5, scope: !23, file: !13, line: 6, type: !26)
...
!98 = !DILocation(line: 52, column: 10, scope: !49)
!99 = !DILocation(line: 53, column: 16, scope: !49)
!100 = !DILocation(line: 53, column: 26, scope: !49)
!101 = !DILocation(line: 53, column: 10, scope: !49)
!102 = !DILocation(line: 54, column: 7, scope: !49)
!103 = !DILocation(line: 55, column: 7, scope: !49)
!104 = !DILocation(line: 49, column: 23, scope: !50)
!105 = distinct !{!105, !92, !106, !107}
!106 = !DILocation(line: 56, column: 3, scope: !51)
!107 = !{!"llvm.loop.mustprogress"}
!108 = !DILocation(line: 12, column: 1, scope: !109)
!109 = !DILexicalBlockFile(scope: !23, file: !13, discriminator: 0)
!110 = !DISubprogram(name: "cblas_xerbla", scope: !111, file: !111, line: 602, type: !112, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized)
!111 = !DIFile(filename: "../gsl/gsl_cblas.h", directory: "/PI-detector/external/gsl/gsl-2.5/cblas", checksumkind: CSK_MD5, checksum: "03ac5115536daff0db5f3e2b63839634")
!112 = !DISubroutineType(types: !113)
!113 = !{null, !27, !114, !114, null}
