...
190:                                              ; preds = %173
  ...
  %198 = fadd double %197, 0.000000e+00, !dbg !196
  tail call void @llvm.dbg.value(metadata double %198, metadata !86, metadata !DIExpression()), !dbg !183
...
201:                                              ; preds = %190, %173
  ...
  %204 = phi double [ 0.000000e+00, %173 ], [ %198, %190 ]
  %205 = phi double [ undef, %173 ], [ %198, %190 ]
...
208:                                              ; preds = %201, %208
  ...
  %211 = phi double [ %231, %208 ], [ %204, %201 ]
  ...
  tail call void @llvm.dbg.value(metadata double %211, metadata !86, metadata !DIExpression()), !dbg !183
  %212 = getelementptr inbounds double, ptr %9, i64 %209, !dbg !191
  %213 = load double, ptr %212, align 8, !dbg !191, !tbaa !150
  %214 = trunc i64 %210 to i32, !dbg !193
  %215 = add i32 %185, %214, !dbg !193
  %216 = sext i32 %215 to i64, !dbg !194
  %217 = getelementptr inbounds double, ptr %7, i64 %216, !dbg !194
  %218 = load double, ptr %217, align 8, !dbg !194, !tbaa !150
  %219 = fmul double %213, %218, !dbg !195
  %220 = fadd double %211, %219, !dbg !196
  tail call void @llvm.dbg.value(metadata double %220, metadata !86, metadata !DIExpression()), !dbg !183
  ...
  tail call void @llvm.dbg.value(metadata i64 %221, metadata !92, metadata !DIExpression()), !dbg !183
  tail call void @llvm.dbg.value(metadata double %220, metadata !86, metadata !DIExpression()), !dbg !183
  %222 = getelementptr inbounds double, ptr %9, i64 %221, !dbg !191
  %223 = load double, ptr %222, align 8, !dbg !191, !tbaa !150
  %224 = trunc i64 %210 to i32, !dbg !193
  %225 = add i32 %224, 1, !dbg !193
  %226 = add i32 %185, %225, !dbg !193
  %227 = sext i32 %226 to i64, !dbg !194
  %228 = getelementptr inbounds double, ptr %7, i64 %227, !dbg !194
  %229 = load double, ptr %228, align 8, !dbg !194, !tbaa !150
  %230 = fmul double %223, %229, !dbg !195
  %231 = fadd double %220, %230, !dbg !196
  tail call void @llvm.dbg.value(metadata double %231, metadata !86, metadata !DIExpression()), !dbg !183
...
235:                                              ; preds = %201, %208, %162
  %236 = phi double [ 0.000000e+00, %162 ], [ %205, %201 ], [ %231, %208 ], !dbg !183
  %237 = fmul double %236, %6, !dbg !201
  %238 = getelementptr inbounds double, ptr %12, i64 %163, !dbg !202
  %239 = load double, ptr %238, align 8, !dbg !203, !tbaa !150
  %240 = fadd double %237, %239, !dbg !203
  store double %240, ptr %238, align 8, !dbg !203, !tbaa !150
...
262:                                              ; preds = %250, %337
  ...
  %274 = getelementptr inbounds double, ptr %9, i64 %263, !dbg !213
  %275 = load double, ptr %274, align 8, !dbg !213, !tbaa !150
  %276 = fmul double %275, %6, !dbg !214
  tail call void @llvm.dbg.value(metadata double %276, metadata !96, metadata !DIExpression()), !dbg !215
  %277 = fcmp une double %276, 0.000000e+00, !dbg !216
...
295:                                              ; preds = %287
  ...
  %298 = getelementptr inbounds double, ptr %7, i64 %297, !dbg !228
  %299 = load double, ptr %298, align 8, !dbg !228, !tbaa !150
  %300 = fmul double %276, %299, !dbg !229
  %301 = getelementptr inbounds double, ptr %12, i64 %272, !dbg !230
  %302 = load double, ptr %301, align 8, !dbg !231, !tbaa !150
  %303 = fadd double %302, %300, !dbg !231
  store double %303, ptr %301, align 8, !dbg !231, !tbaa !150
...
311:                                              ; preds = %306, %311
  ...
  %317 = getelementptr inbounds double, ptr %7, i64 %316, !dbg !228
  %318 = load double, ptr %317, align 8, !dbg !228, !tbaa !150
  %319 = fmul double %276, %318, !dbg !229
  %320 = getelementptr inbounds double, ptr %12, i64 %313, !dbg !230
  %321 = load double, ptr %320, align 8, !dbg !231, !tbaa !150
  %322 = fadd double %321, %319, !dbg !231
  store double %322, ptr %320, align 8, !dbg !231, !tbaa !150
  ...
  %328 = getelementptr inbounds double, ptr %7, i64 %327, !dbg !228
  %329 = load double, ptr %328, align 8, !dbg !228, !tbaa !150
  %330 = fmul double %276, %329, !dbg !229
  %331 = getelementptr inbounds double, ptr %12, i64 %323, !dbg !230
  %332 = load double, ptr %331, align 8, !dbg !231, !tbaa !150
  %333 = fadd double %332, %330, !dbg !231
  store double %333, ptr %331, align 8, !dbg !231, !tbaa !150
...
!242 = !DILocation(line: 16, column: 1, scope: !243)
