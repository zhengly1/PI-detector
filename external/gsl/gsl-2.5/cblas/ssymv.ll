...
145:                                              ; preds = %130, %196
  ...
  %167 = fadd float %166, %164, !dbg !175
  store float %167, ptr %165, align 4, !dbg !175, !tbaa !132
...
169:                                              ; preds = %145
  ...
  %173 = getelementptr float, ptr %4, i64 %170, !dbg !179
...
174:                                              ; preds = %169, %174
  ...
  %178 = phi float [ 0.000000e+00, %169 ], [ %189, %174 ]
  ...
  tail call void @llvm.dbg.value(metadata float %178, metadata !82, metadata !DIExpression()), !dbg !168
  %179 = getelementptr float, ptr %173, i64 %177, !dbg !180
  %180 = load float, ptr %179, align 4, !dbg !180, !tbaa !132
  %181 = fmul float %157, %180, !dbg !182
  %182 = getelementptr inbounds float, ptr %9, i64 %176, !dbg !183
  %183 = load float, ptr %182, align 4, !dbg !184, !tbaa !132
  %184 = fadd float %183, %181, !dbg !184
  store float %184, ptr %182, align 4, !dbg !184, !tbaa !132
  %185 = getelementptr inbounds float, ptr %6, i64 %175, !dbg !185
  %186 = load float, ptr %185, align 4, !dbg !185, !tbaa !132
  %187 = load float, ptr %179, align 4, !dbg !186, !tbaa !132
  %188 = fmul float %186, %187, !dbg !187
  %189 = fadd float %178, %188, !dbg !188
  tail call void @llvm.dbg.value(metadata float %189, metadata !82, metadata !DIExpression()), !dbg !168
...
194:                                              ; preds = %174
  %195 = load float, ptr %165, align 4, !dbg !194, !tbaa !132
  br label %196, !dbg !195

196:                                              ; preds = %194, %145
  %197 = phi float [ %167, %145 ], [ %195, %194 ], !dbg !194
  %198 = phi float [ 0.000000e+00, %145 ], [ %189, %194 ], !dbg !168
  %199 = fmul float %198, %3, !dbg !195
  %200 = fadd float %199, %197, !dbg !194
  store float %200, ptr %165, align 4, !dbg !194, !tbaa !132
...
234:                                              ; preds = %211, %322
  ...
  %243 = getelementptr inbounds float, ptr %6, i64 %242, !dbg !211
  %244 = load float, ptr %243, align 4, !dbg !211, !tbaa !132
  %245 = fmul float %244, %3, !dbg !212
  tail call void @llvm.dbg.value(metadata float %245, metadata !91, metadata !DIExpression()), !dbg !213
  tail call void @llvm.dbg.value(metadata float 0.000000e+00, metadata !95, metadata !DIExpression()), !dbg !213
  ...
  %248 = getelementptr float, ptr %4, i64 %240, !dbg !216
  %249 = getelementptr float, ptr %248, i64 %247, !dbg !216
  %250 = load float, ptr %249, align 4, !dbg !216, !tbaa !132
  %251 = fmul float %245, %250, !dbg !217
  %252 = sext i32 %238 to i64, !dbg !218
  %253 = getelementptr inbounds float, ptr %9, i64 %252, !dbg !218
  %254 = load float, ptr %253, align 4, !dbg !219, !tbaa !132
  %255 = fadd float %254, %251, !dbg !219
  store float %255, ptr %253, align 4, !dbg !219, !tbaa !132
...
257:                                              ; preds = %234
  %258 = fmul float %3, 0.000000e+00, !dbg !224
  %259 = fadd float %258, %255, !dbg !225
  store float %259, ptr %253, align 4, !dbg !225, !tbaa !132
...
260:                                              ; preds = %234
  ...
  %262 = getelementptr float, ptr %4, i64 %261, !dbg !223
...
267:                                              ; preds = %267, %265
  ...
  %271 = phi float [ 0.000000e+00, %265 ], [ %297, %267 ]
  ...
  tail call void @llvm.dbg.value(metadata float %271, metadata !95, metadata !DIExpression()), !dbg !213
  %273 = getelementptr float, ptr %262, i64 %268, !dbg !226
  %274 = load float, ptr %273, align 4, !dbg !226, !tbaa !132
  %275 = fmul float %245, %274, !dbg !228
  %276 = getelementptr inbounds float, ptr %9, i64 %270, !dbg !229
  %277 = load float, ptr %276, align 4, !dbg !230, !tbaa !132
  %278 = fadd float %277, %275, !dbg !230
  store float %278, ptr %276, align 4, !dbg !230, !tbaa !132
  %279 = getelementptr inbounds float, ptr %6, i64 %269, !dbg !231
  %280 = load float, ptr %279, align 4, !dbg !231, !tbaa !132
  %281 = load float, ptr %273, align 4, !dbg !232, !tbaa !132
  %282 = fmul float %280, %281, !dbg !233
  %283 = fadd float %271, %282, !dbg !234
  tail call void @llvm.dbg.value(metadata float %283, metadata !95, metadata !DIExpression()), !dbg !213
  ...
  tail call void @llvm.dbg.value(metadata i64 %286, metadata !65, metadata !DIExpression()), !dbg !123
  tail call void @llvm.dbg.value(metadata float %283, metadata !95, metadata !DIExpression()), !dbg !213
  %287 = getelementptr float, ptr %262, i64 %286, !dbg !226
  %288 = load float, ptr %287, align 4, !dbg !226, !tbaa !132
  %289 = fmul float %245, %288, !dbg !228
  %290 = getelementptr inbounds float, ptr %9, i64 %285, !dbg !229
  %291 = load float, ptr %290, align 4, !dbg !230, !tbaa !132
  %292 = fadd float %291, %289, !dbg !230
  store float %292, ptr %290, align 4, !dbg !230, !tbaa !132
  %293 = getelementptr inbounds float, ptr %6, i64 %284, !dbg !231
  %294 = load float, ptr %293, align 4, !dbg !231, !tbaa !132
  %295 = load float, ptr %287, align 4, !dbg !232, !tbaa !132
  %296 = fmul float %294, %295, !dbg !233
  %297 = fadd float %283, %296, !dbg !234
  tail call void @llvm.dbg.value(metadata float %297, metadata !95, metadata !DIExpression()), !dbg !213
...
310:                                              ; preds = %303
  ...
  tail call void @llvm.dbg.value(metadata float %308, metadata !95, metadata !DIExpression()), !dbg !213
  %311 = getelementptr float, ptr %262, i64 %305, !dbg !226
  %312 = load float, ptr %311, align 4, !dbg !226, !tbaa !132
  %313 = fmul float %245, %312, !dbg !228
  %314 = getelementptr inbounds float, ptr %9, i64 %307, !dbg !229
  %315 = load float, ptr %314, align 4, !dbg !230, !tbaa !132
  %316 = fadd float %315, %313, !dbg !230
  store float %316, ptr %314, align 4, !dbg !230, !tbaa !132
  %317 = getelementptr inbounds float, ptr %6, i64 %306, !dbg !231
  %318 = load float, ptr %317, align 4, !dbg !231, !tbaa !132
  %319 = load float, ptr %311, align 4, !dbg !232, !tbaa !132
  %320 = fmul float %318, %319, !dbg !233
  %321 = fadd float %308, %320, !dbg !234
  tail call void @llvm.dbg.value(metadata float %321, metadata !95, metadata !DIExpression()), !dbg !213
...
322:                                              ; preds = %303, %310
  %323 = phi float [ %304, %303 ], [ %321, %310 ], !dbg !234
  %324 = load float, ptr %253, align 4, !dbg !225, !tbaa !132
  %325 = fmul float %323, %3, !dbg !224
  %326 = fadd float %325, %324, !dbg !225
  store float %326, ptr %253, align 4, !dbg !225, !tbaa !132
