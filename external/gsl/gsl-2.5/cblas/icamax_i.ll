; ModuleID = 'icamax.ll'
source_filename = "icamax.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

; Function Attrs: nofree norecurse nosync nounwind memory(argmem: read) uwtable
define dso_local i64 @cblas_icamax(i32 noundef %0, ptr nocapture noundef readonly %1, i32 noundef %2) local_unnamed_addr #0 !dbg !14 {
  ...
  tail call void @llvm.dbg.value(metadata float 0.000000e+00, metadata !28, metadata !DIExpression()), !dbg !40
  ...
  %5 = icmp sgt i32 %0, 0
  %6 = and i1 %4, %5, !dbg !43
  br i1 %6, label %7, label %36, !dbg !43
...
10:                                               ; preds = %10, %7
  %11 = phi i64 [ 0, %7 ], [ %33, %10 ]
  %12 = phi i64 [ 0, %7 ], [ %34, %10 ]
  %13 = phi i64 [ 0, %7 ], [ %32, %10 ]
  %14 = phi float [ 0.000000e+00, %7 ], [ %31, %10 ]
  ...
  tail call void @llvm.dbg.value(metadata float %14, metadata !28, metadata !DIExpression()), !dbg !40
  %15 = trunc i64 %11 to i32, !dbg !46
  %16 = shl nuw nsw i32 %15, 1, !dbg !46
  %17 = zext nneg i32 %16 to i64, !dbg !46
  %18 = getelementptr inbounds float, ptr %1, i64 %17, !dbg !46
  %19 = load float, ptr %18, align 4, !dbg !46, !tbaa !47
  %20 = tail call float @llvm.fabs.f32(float %19), !dbg !51
  %21 = or disjoint i32 %16, 1, !dbg !52
  %22 = zext nneg i32 %21 to i64, !dbg !52
  %23 = getelementptr inbounds float, ptr %1, i64 %22, !dbg !52
  %24 = load float, ptr %23, align 4, !dbg !52, !tbaa !47
  %25 = tail call float @llvm.fabs.f32(float %24), !dbg !53
  %26 = fpext float %20 to double, !dbg !54
  %27 = fpext float %25 to double, !dbg !54
  %28 = fptrunc double %26 to float, !dbg !54
  %29 = fptrunc double %27 to float, !dbg !54
  %handler_result = call float @fAddHandlerFloat(float %28, float %29), !dbg !54
  tail call void @llvm.dbg.value(metadata float %handler_result, metadata !35, metadata !DIExpression()), !dbg !56
  %30 = fcmp ogt float %handler_result, %14, !dbg !54
  %31 = select i1 %30, float %handler_result, float %14, !dbg !57
  %32 = select i1 %30, i64 %12, i64 %13, !dbg !57
  tail call void @llvm.dbg.value(metadata i64 %32, metadata !34, metadata !DIExpression()), !dbg !40
  tail call void @llvm.dbg.value(metadata float %31, metadata !28, metadata !DIExpression()), !dbg !40
  %33 = add nuw nsw i64 %11, %8, !dbg !58
  tail call void @llvm.dbg.value(metadata i64 %33, metadata !32, metadata !DIExpression()), !dbg !40
  %34 = add nuw nsw i64 %12, 1, !dbg !59
  tail call void @llvm.dbg.value(metadata i64 %34, metadata !33, metadata !DIExpression()), !dbg !40
  %35 = icmp eq i64 %34, %9, !dbg !45
  br i1 %35, label %36, label %10, !dbg !44, !llvm.loop !60

36:                                               ; preds = %10, %3
  %37 = phi i64 [ 0, %3 ], [ %32, %10 ], !dbg !40
  ret i64 %37, !dbg !63
}
...
!1 = !DIFile(filename: "icamax.c", directory: "/PI-detector/external/gsl/gsl-2.5/cblas", checksumkind: CSK_MD5, checksum: "c28e3dfaed717d27dd702951c99e102c")
!2 = !{!3}
...
!14 = distinct !DISubprogram(name: "cblas_icamax", scope: !1, file: !1, line: 6, type: !15, scopeLine: 7, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !24)
