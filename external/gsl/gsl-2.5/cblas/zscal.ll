; ModuleID = 'zscal.c'
source_filename = "zscal.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

; Function Attrs: nofree norecurse nosync nounwind memory(argmem: readwrite) uwtable
define dso_local void @cblas_zscal(i32 noundef %0, ptr nocapture noundef readonly %1, ptr nocapture noundef %2, i32 noundef %3) local_unnamed_addr #0 !dbg !15 {
  ...
  %5 = load double, ptr %1, align 8, !dbg !42, !tbaa !43
  tail call void @llvm.dbg.value(metadata double %5, metadata !33, metadata !DIExpression()), !dbg !41
  %6 = getelementptr inbounds double, ptr %1, i64 1, !dbg !47
  %7 = load double, ptr %6, align 8, !dbg !47, !tbaa !43
  tail call void @llvm.dbg.value(metadata double %7, metadata !34, metadata !DIExpression()), !dbg !41
  ...
  br i1 %10, label %11, label %34, !dbg !50
...
13:                                               ; preds = %11, %13
  ...
  %19 = getelementptr inbounds double, ptr %2, i64 %18, !dbg !52
  %20 = load double, ptr %19, align 8, !dbg !52, !tbaa !43
  tail call void @llvm.dbg.value(metadata double %20, metadata !35, metadata !DIExpression()), !dbg !53
  %21 = or disjoint i32 %17, 1, !dbg !54
  %22 = zext nneg i32 %21 to i64, !dbg !54
  %23 = getelementptr inbounds double, ptr %2, i64 %22, !dbg !54
  %24 = load double, ptr %23, align 8, !dbg !54, !tbaa !43
  tail call void @llvm.dbg.value(metadata double %24, metadata !39, metadata !DIExpression()), !dbg !53
  %25 = fmul double %5, %20, !dbg !55
  %26 = fmul double %7, %24, !dbg !56
  %27 = fsub double %25, %26, !dbg !57
  store double %27, ptr %19, align 8, !dbg !58, !tbaa !43
  %28 = fmul double %7, %20, !dbg !59
  %29 = fmul double %5, %24, !dbg !60
  %30 = fadd double %28, %29, !dbg !61
  store double %30, ptr %23, align 8, !dbg !62, !tbaa !43
  %31 = add nuw nsw i64 %14, %12, !dbg !63
  tail call void @llvm.dbg.value(metadata i64 %31, metadata !32, metadata !DIExpression()), !dbg !41
  %32 = add nuw nsw i32 %15, 1, !dbg !64
  tail call void @llvm.dbg.value(metadata i32 %32, metadata !28, metadata !DIExpression()), !dbg !41
  %33 = icmp eq i32 %32, %0, !dbg !65
  br i1 %33, label %34, label %13, !dbg !51, !llvm.loop !66
...
!1 = !DIFile(filename: "zscal.c", directory: "/PI-detector/external/gsl/gsl-2.5/cblas", checksumkind: CSK_MD5, checksum: "ba0ad3da3cf28d9bef77ddf98442acb4")
!2 = !{!3, !6}
...
!15 = distinct !DISubprogram(name: "cblas_zscal", scope: !1, file: !1, line: 6, type: !16, scopeLine: 7, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !23)
...
!57 = !DILocation(line: 33, column: 39, scope: !36)
!58 = !DILocation(line: 33, column: 17, scope: !36)
!59 = !DILocation(line: 34, column: 26, scope: !36)
!60 = !DILocation(line: 34, column: 48, scope: !36)
!61 = !DILocation(line: 34, column: 39, scope: !36)
!62 = !DILocation(line: 34, column: 17, scope: !36)
!63 = !DILocation(line: 35, column: 8, scope: !36)
!64 = !DILocation(line: 30, column: 23, scope: !37)
!65 = !DILocation(line: 30, column: 17, scope: !37)
!66 = distinct !{!66, !51, !67, !68}
!67 = !DILocation(line: 36, column: 3, scope: !38)
!68 = !{!"llvm.loop.mustprogress"}
!69 = !DILocation(line: 11, column: 1, scope: !70)
!70 = !DILexicalBlockFile(scope: !15, file: !1, discriminator: 0)
