...
68:                                               ; preds = %65, %68
  ...
  %77 = fadd float %76, %74, !dbg !121
  store float %77, ptr %75, align 4, !dbg !121, !tbaa !108
  ...
  tail call void @llvm.dbg.value(metadata i64 %78, metadata !69, metadata !DIExpression()), !dbg !113
  tail call void @llvm.dbg.value(metadata i64 %79, metadata !59, metadata !DIExpression()), !dbg !103
  %80 = getelementptr inbounds float, ptr %6, i64 %78, !dbg !116
  %81 = load float, ptr %80, align 4, !dbg !116, !tbaa !108
  %82 = fmul float %64, %81, !dbg !119
  %83 = getelementptr float, ptr %67, i64 %79, !dbg !120
  %84 = load float, ptr %83, align 4, !dbg !121, !tbaa !108
  %85 = fadd float %84, %82, !dbg !121
  store float %85, ptr %83, align 4, !dbg !121, !tbaa !108
...
93:                                               ; preds = %90
  ...
  %94 = getelementptr inbounds float, ptr %6, i64 %92, !dbg !116
  %95 = load float, ptr %94, align 4, !dbg !116, !tbaa !108
  %96 = fmul float %64, %95, !dbg !119
  %97 = getelementptr float, ptr %67, i64 %91, !dbg !120
  %98 = load float, ptr %97, align 4, !dbg !121, !tbaa !108
  %99 = fadd float %98, %96, !dbg !121
  store float %99, ptr %97, align 4, !dbg !121, !tbaa !108
...
129:                                              ; preds = %108, %170
  ...
  %132 = getelementptr inbounds float, ptr %6, i64 %131, !dbg !137
  %133 = load float, ptr %132, align 4, !dbg !137, !tbaa !108
  %134 = fmul float %133, %3, !dbg !138
  tail call void @llvm.dbg.value(metadata float %134, metadata !73, metadata !DIExpression()), !dbg !139
...
135:                                              ; preds = %129
  ...
  %137 = getelementptr float, ptr %8, i64 %136, !dbg !140
...
138:                                              ; preds = %135, %138
  ...
  %142 = getelementptr inbounds float, ptr %4, i64 %140, !dbg !142
  %143 = load float, ptr %142, align 4, !dbg !142, !tbaa !108
  %144 = fmul float %134, %143, !dbg !145
  %145 = getelementptr float, ptr %137, i64 %139, !dbg !146
  %146 = load float, ptr %145, align 4, !dbg !147, !tbaa !108
  %147 = fadd float %146, %144, !dbg !147
  store float %147, ptr %145, align 4, !dbg !147, !tbaa !108
  ...
  tail call void @llvm.dbg.value(metadata i64 %148, metadata !77, metadata !DIExpression()), !dbg !139
  tail call void @llvm.dbg.value(metadata i64 %149, metadata !56, metadata !DIExpression()), !dbg !103
  %150 = getelementptr inbounds float, ptr %4, i64 %148, !dbg !142
  %151 = load float, ptr %150, align 4, !dbg !142, !tbaa !108
  %152 = fmul float %134, %151, !dbg !145
  %153 = getelementptr float, ptr %137, i64 %149, !dbg !146
  %154 = load float, ptr %153, align 4, !dbg !147, !tbaa !108
  %155 = fadd float %154, %152, !dbg !147
  store float %155, ptr %153, align 4, !dbg !147, !tbaa !108
...
163:                                              ; preds = %160
  ...
  %164 = getelementptr inbounds float, ptr %4, i64 %162, !dbg !142
  %165 = load float, ptr %164, align 4, !dbg !142, !tbaa !108
  %166 = fmul float %134, %165, !dbg !145
  %167 = getelementptr float, ptr %137, i64 %161, !dbg !146
  %168 = load float, ptr %167, align 4, !dbg !147, !tbaa !108
  %169 = fadd float %168, %166, !dbg !147
  store float %169, ptr %167, align 4, !dbg !147, !tbaa !108
