...
define dso_local double @cblas_dznrm2(i32 noundef %0, ptr nocapture noundef readonly %1, i32 noundef %2) local_unnamed_addr #0 !dbg !14 {
  ...
  %5 = icmp slt i32 %2, 1
  %6 = or i1 %4, %5, !dbg !47
  br i1 %6, label %65, label %7, !dbg !47
...
7:                                                ; preds = %3
  ...
  br i1 %8, label %9, label %60, !dbg !49
...
11:                                               ; preds = %9, %54
  ...
  %13 = phi double [ 0.000000e+00, %9 ], [ %56, %54 ]
  %14 = phi double [ 1.000000e+00, %9 ], [ %55, %54 ]
...
29:                                               ; preds = %26
  ...
  %33 = fadd double %32, 1.000000e+00, !dbg !68
  tail call void @llvm.dbg.value(metadata double %33, metadata !29, metadata !DIExpression()), !dbg !44
  tail call void @llvm.dbg.value(metadata double %27, metadata !25, metadata !DIExpression()), !dbg !44
  br label %38, !dbg !69

34:                                               ; preds = %26
  %35 = fdiv double %27, %13, !dbg !70
  %36 = fmul double %35, %35, !dbg !72
  %37 = fadd double %14, %36, !dbg !73
  tail call void @llvm.dbg.value(metadata double %37, metadata !29, metadata !DIExpression()), !dbg !44
  br label %38

38:                                               ; preds = %29, %34, %11
  %39 = phi double [ %14, %11 ], [ %33, %29 ], [ %37, %34 ], !dbg !44
  %40 = phi double [ %13, %11 ], [ %27, %29 ], [ %13, %34 ], !dbg !44
  tail call void @llvm.dbg.value(metadata double %40, metadata !25, metadata !DIExpression()), !dbg !44
  tail call void @llvm.dbg.value(metadata double %39, metadata !29, metadata !DIExpression()), !dbg !44
  %41 = fcmp une double %24, 0.000000e+00, !dbg !74
  br i1 %41, label %42, label %54, !dbg !75

42:                                               ; preds = %38
  %43 = tail call double @llvm.fabs.f64(double %24), !dbg !76
  tail call void @llvm.dbg.value(metadata double %43, metadata !40, metadata !DIExpression()), !dbg !77
  %44 = fcmp olt double %40, %43, !dbg !78
  br i1 %44, label %45, label %50, !dbg !80

45:                                               ; preds = %42
  %46 = fdiv double %40, %43, !dbg !81
  %47 = fmul double %39, %46, !dbg !83
  %48 = fmul double %46, %47, !dbg !84
  %49 = fadd double %48, 1.000000e+00, !dbg !85
  tail call void @llvm.dbg.value(metadata double %49, metadata !29, metadata !DIExpression()), !dbg !44
  tail call void @llvm.dbg.value(metadata double %43, metadata !25, metadata !DIExpression()), !dbg !44
  br label %54, !dbg !86

50:                                               ; preds = %42
  %51 = fdiv double %43, %40, !dbg !87
  %52 = fmul double %51, %51, !dbg !89
  %53 = fadd double %39, %52, !dbg !90
  tail call void @llvm.dbg.value(metadata double %53, metadata !29, metadata !DIExpression()), !dbg !44
  br label %54

54:                                               ; preds = %45, %50, %38
  %55 = phi double [ %39, %38 ], [ %49, %45 ], [ %53, %50 ], !dbg !55
  %56 = phi double [ %40, %38 ], [ %43, %45 ], [ %40, %50 ], !dbg !55
  tail call void @llvm.dbg.value(metadata double %56, metadata !25, metadata !DIExpression()), !dbg !44
  tail call void @llvm.dbg.value(metadata double %55, metadata !29, metadata !DIExpression()), !dbg !44
...
60:                                               ; preds = %54, %7
  %61 = phi double [ 1.000000e+00, %7 ], [ %55, %54 ], !dbg !44
  %62 = phi double [ 0.000000e+00, %7 ], [ %56, %54 ], !dbg !44
  %63 = tail call double @sqrt(double noundef %61) #4, !dbg !96
  %64 = fmul double %62, %63, !dbg !97
  br label %65, !dbg !98

65:                                               ; preds = %3, %60
  %66 = phi double [ %64, %60 ], [ 0.000000e+00, %3 ], !dbg !44
  ret double %66, !dbg !99
}
...
declare !dbg !101 double @sqrt(double noundef) local_unnamed_addr #2
...
!68 = !DILocation(line: 38, column: 19, scope: !65)
...
!85 = !DILocation(line: 49, column: 19, scope: !82)
...
!96 = !DILocation(line: 59, column: 18, scope: !26)
!97 = !DILocation(line: 59, column: 16, scope: !26)
!98 = !DILocation(line: 59, column: 3, scope: !26)
!99 = !DILocation(line: 11, column: 1, scope: !100)
!100 = !DILexicalBlockFile(scope: !14, file: !1, discriminator: 0)
!101 = !DISubprogram(name: "sqrt", scope: !102, file: !102, line: 143, type: !103, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized)
!102 = !DIFile(filename: "/usr/include/x86_64-linux-gnu/bits/mathcalls.h", directory: "", checksumkind: CSK_MD5, checksum: "12f0a7cb98f2ec572091728ebaf4a161")
