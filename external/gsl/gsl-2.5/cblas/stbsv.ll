...
86:                                               ; preds = %80, %86
  ...
  %98 = fsub float %89, %97, !dbg !190
  tail call void @llvm.dbg.value(metadata float %98, metadata !83, metadata !DIExpression()), !dbg !181
...
102:                                              ; preds = %86, %67
  %103 = phi float [ %74, %67 ], [ %98, %86 ], !dbg !181
  br i1 %11, label %104, label %109, !dbg !196

104:                                              ; preds = %102
  %105 = mul nsw i64 %71, %66, !dbg !197
  %106 = getelementptr inbounds float, ptr %6, i64 %105, !dbg !200
  %107 = load float, ptr %106, align 4, !dbg !200, !tbaa !177
  %108 = fdiv float %103, %107, !dbg !201
  br label %109, !dbg !202

109:                                              ; preds = %102, %104
  %110 = phi float [ %108, %104 ], [ %103, %102 ], !dbg !203
  store float %110, ptr %73, align 4, !dbg !203, !tbaa !177
...
124:                                              ; preds = %118
  ...
  %130 = getelementptr float, ptr %6, i64 %127, !dbg !212
...
131:                                              ; preds = %124, %177
  ...
  %134 = getelementptr inbounds float, ptr %8, i64 %132, !dbg !213
  %135 = load float, ptr %134, align 4, !dbg !213, !tbaa !177
  tail call void @llvm.dbg.value(metadata float %135, metadata !97, metadata !DIExpression()), !dbg !214
...
154:                                              ; preds = %142, %154
  ...
  tail call void @llvm.dbg.value(metadata float %157, metadata !97, metadata !DIExpression()), !dbg !214
  %158 = trunc i64 %156 to i32, !dbg !219
  %159 = add i32 %153, %158, !dbg !219
  %160 = sext i32 %159 to i64, !dbg !220
  %161 = getelementptr inbounds float, ptr %6, i64 %160, !dbg !220
  %162 = load float, ptr %161, align 4, !dbg !220, !tbaa !177
  tail call void @llvm.dbg.value(metadata float %162, metadata !104, metadata !DIExpression()), !dbg !221
  %163 = getelementptr inbounds float, ptr %8, i64 %155, !dbg !222
  %164 = load float, ptr %163, align 4, !dbg !222, !tbaa !177
  %165 = fmul float %162, %164, !dbg !223
  %166 = fsub float %157, %165, !dbg !224
  tail call void @llvm.dbg.value(metadata float %166, metadata !97, metadata !DIExpression()), !dbg !214
...
170:                                              ; preds = %154, %131
  %171 = phi float [ %135, %131 ], [ %166, %154 ], !dbg !214
  br i1 %11, label %172, label %177, !dbg !229

172:                                              ; preds = %170
  %173 = mul nsw i64 %133, %126, !dbg !230
  %174 = getelementptr float, ptr %130, i64 %173, !dbg !233
  %175 = load float, ptr %174, align 4, !dbg !233, !tbaa !177
  %176 = fdiv float %171, %175, !dbg !234
  br label %177, !dbg !235

177:                                              ; preds = %170, %172
  %178 = phi float [ %176, %172 ], [ %171, %170 ], !dbg !236
  store float %178, ptr %134, align 4, !dbg !236, !tbaa !177
...
200:                                              ; preds = %194, %244
  ...
  %203 = getelementptr inbounds float, ptr %8, i64 %201, !dbg !247
  %204 = load float, ptr %203, align 4, !dbg !247, !tbaa !177
  tail call void @llvm.dbg.value(metadata float %204, metadata !111, metadata !DIExpression()), !dbg !248
...
219:                                              ; preds = %211, %219
  ...
  tail call void @llvm.dbg.value(metadata float %222, metadata !111, metadata !DIExpression()), !dbg !248
  %223 = sub i64 %202, %221, !dbg !253
  %224 = mul nsw i64 %221, %195, !dbg !254
  %225 = shl i64 %223, 32, !dbg !255
  %226 = ashr exact i64 %225, 32, !dbg !255
  %227 = getelementptr float, ptr %6, i64 %226, !dbg !256
  %228 = getelementptr float, ptr %227, i64 %224, !dbg !256
  %229 = load float, ptr %228, align 4, !dbg !256, !tbaa !177
  tail call void @llvm.dbg.value(metadata float %229, metadata !118, metadata !DIExpression()), !dbg !257
  %230 = getelementptr inbounds float, ptr %8, i64 %220, !dbg !258
  %231 = load float, ptr %230, align 4, !dbg !258, !tbaa !177
  %232 = fmul float %229, %231, !dbg !259
  %233 = fsub float %222, %232, !dbg !260
  tail call void @llvm.dbg.value(metadata float %233, metadata !111, metadata !DIExpression()), !dbg !248
...
237:                                              ; preds = %219, %200
  %238 = phi float [ %204, %200 ], [ %233, %219 ], !dbg !248
  br i1 %11, label %239, label %244, !dbg !265

239:                                              ; preds = %237
  %240 = mul nsw i64 %202, %195, !dbg !266
  %241 = getelementptr inbounds float, ptr %6, i64 %240, !dbg !269
  %242 = load float, ptr %241, align 4, !dbg !269, !tbaa !177
  %243 = fdiv float %238, %242, !dbg !270
  br label %244, !dbg !271

244:                                              ; preds = %237, %239
  %245 = phi float [ %243, %239 ], [ %238, %237 ], !dbg !272
  store float %245, ptr %203, align 4, !dbg !272, !tbaa !177
...
255:                                              ; preds = %253
  ...
  %270 = getelementptr float, ptr %6, i64 %269, !dbg !280
...
271:                                              ; preds = %255, %313
  ...
  %277 = getelementptr inbounds float, ptr %8, i64 %276, !dbg !286
  %278 = load float, ptr %277, align 4, !dbg !286, !tbaa !177
  tail call void @llvm.dbg.value(metadata float %278, metadata !125, metadata !DIExpression()), !dbg !287
...
288:                                              ; preds = %284, %288
  ...
  tail call void @llvm.dbg.value(metadata float %291, metadata !125, metadata !DIExpression()), !dbg !287
  ...
  %296 = getelementptr float, ptr %6, i64 %294, !dbg !294
  %297 = getelementptr float, ptr %296, i64 %295, !dbg !294
  %298 = load float, ptr %297, align 4, !dbg !294, !tbaa !177
  tail call void @llvm.dbg.value(metadata float %298, metadata !132, metadata !DIExpression()), !dbg !295
  %299 = getelementptr inbounds float, ptr %8, i64 %290, !dbg !296
  %300 = load float, ptr %299, align 4, !dbg !296, !tbaa !177
  %301 = fmul float %298, %300, !dbg !297
  %302 = fsub float %291, %301, !dbg !298
  tail call void @llvm.dbg.value(metadata float %302, metadata !125, metadata !DIExpression()), !dbg !287
...
306:                                              ; preds = %288, %271
  %307 = phi float [ %278, %271 ], [ %302, %288 ], !dbg !287
  br i1 %11, label %308, label %313, !dbg !303

308:                                              ; preds = %306
  %309 = mul nsw i64 %275, %268, !dbg !304
  %310 = getelementptr float, ptr %270, i64 %309, !dbg !307
  %311 = load float, ptr %310, align 4, !dbg !307, !tbaa !177
  %312 = fdiv float %307, %311, !dbg !308
  br label %313, !dbg !309

313:                                              ; preds = %306, %308
  %314 = phi float [ %312, %308 ], [ %307, %306 ], !dbg !310
  store float %314, ptr %277, align 4, !dbg !310, !tbaa !177
