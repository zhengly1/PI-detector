...
89:                                               ; preds = %82, %89
  ...
  %103 = fsub double %101, %102, !dbg !192
  tail call void @llvm.dbg.value(metadata double %103, metadata !88, metadata !DIExpression()), !dbg !188
  %104 = fmul double %33, %96, !dbg !193
  %105 = fmul double %31, %100, !dbg !194
  %106 = fadd double %104, %105, !dbg !195
  tail call void @llvm.dbg.value(metadata double %106, metadata !89, metadata !DIExpression()), !dbg !188
  store double %103, ptr %95, align 8, !dbg !196, !tbaa !155
  store double %106, ptr %99, align 8, !dbg !197, !tbaa !155
...
115:                                              ; preds = %112
  ...
  %118 = getelementptr inbounds double, ptr %8, i64 %117, !dbg !174
  store double 0.000000e+00, ptr %118, align 8, !dbg !176, !tbaa !155
  %119 = or disjoint i32 %116, 1, !dbg !177
  %120 = sext i32 %119 to i64, !dbg !177
  %121 = getelementptr inbounds double, ptr %8, i64 %120, !dbg !177
  store double 0.000000e+00, ptr %121, align 8, !dbg !178, !tbaa !155
...
148:                                              ; preds = %132, %257
  ...
  %161 = getelementptr inbounds double, ptr %5, i64 %160, !dbg !213
  %162 = load double, ptr %161, align 8, !dbg !213, !tbaa !155
  tail call void @llvm.dbg.value(metadata double %162, metadata !94, metadata !DIExpression()), !dbg !214
  %163 = or disjoint i32 %159, 1, !dbg !215
  %164 = sext i32 %163 to i64, !dbg !215
  %165 = getelementptr inbounds double, ptr %5, i64 %164, !dbg !215
  %166 = load double, ptr %165, align 8, !dbg !215, !tbaa !155
  tail call void @llvm.dbg.value(metadata double %166, metadata !98, metadata !DIExpression()), !dbg !214
  %167 = fmul double %28, %162, !dbg !216
  %168 = fmul double %30, %166, !dbg !217
  %169 = fsub double %167, %168, !dbg !218
  tail call void @llvm.dbg.value(metadata double %169, metadata !99, metadata !DIExpression()), !dbg !214
  %170 = fmul double %28, %166, !dbg !219
  %171 = fmul double %30, %162, !dbg !220
  %172 = fadd double %171, %170, !dbg !221
  tail call void @llvm.dbg.value(metadata double %172, metadata !100, metadata !DIExpression()), !dbg !214
  tail call void @llvm.dbg.value(metadata double 0.000000e+00, metadata !101, metadata !DIExpression()), !dbg !214
  tail call void @llvm.dbg.value(metadata double 0.000000e+00, metadata !102, metadata !DIExpression()), !dbg !214
  ...
  %179 = getelementptr inbounds double, ptr %4, i64 %178, !dbg !223
  %180 = load double, ptr %179, align 8, !dbg !223, !tbaa !155
  tail call void @llvm.dbg.value(metadata double %180, metadata !107, metadata !DIExpression()), !dbg !214
  %181 = fmul double %180, %169, !dbg !224
  %182 = trunc i64 %149 to i32, !dbg !225
  %183 = shl nsw i32 %182, 1, !dbg !225
  %184 = sext i32 %183 to i64, !dbg !225
  %185 = getelementptr inbounds double, ptr %8, i64 %184, !dbg !225
  %186 = load double, ptr %185, align 8, !dbg !226, !tbaa !155
  %187 = fadd double %186, %181, !dbg !226
  store double %187, ptr %185, align 8, !dbg !226, !tbaa !155
  %188 = fmul double %180, %172, !dbg !227
  %189 = or disjoint i32 %183, 1, !dbg !228
  %190 = sext i32 %189 to i64, !dbg !228
  %191 = getelementptr inbounds double, ptr %8, i64 %190, !dbg !228
  %192 = load double, ptr %191, align 8, !dbg !229, !tbaa !155
  %193 = fadd double %188, %192, !dbg !229
  store double %193, ptr %191, align 8, !dbg !229, !tbaa !155
...
199:                                              ; preds = %195, %199
  ...
  %203 = phi double [ 0.000000e+00, %195 ], [ %245, %199 ]
  %204 = phi double [ 0.000000e+00, %195 ], [ %249, %199 ]
  ...
  tail call void @llvm.dbg.value(metadata double %203, metadata !101, metadata !DIExpression()), !dbg !214
  tail call void @llvm.dbg.value(metadata double %204, metadata !102, metadata !DIExpression()), !dbg !214
  %205 = trunc i64 %202 to i32, !dbg !232
  %206 = add i32 %198, %205, !dbg !232
  %207 = shl nsw i32 %206, 1, !dbg !232
  %208 = sext i32 %207 to i64, !dbg !232
  %209 = getelementptr inbounds double, ptr %4, i64 %208, !dbg !232
  %210 = load double, ptr %209, align 8, !dbg !232, !tbaa !155
  tail call void @llvm.dbg.value(metadata double %210, metadata !108, metadata !DIExpression()), !dbg !233
  %211 = or disjoint i32 %207, 1, !dbg !234
  %212 = sext i32 %211 to i64, !dbg !234
  %213 = getelementptr inbounds double, ptr %4, i64 %212, !dbg !234
  %214 = load double, ptr %213, align 8, !dbg !234, !tbaa !155
  %215 = fmul double %214, %142, !dbg !235
  tail call void @llvm.dbg.value(metadata double %215, metadata !112, metadata !DIExpression()), !dbg !233
  %216 = fmul double %169, %210, !dbg !236
  %217 = fmul double %172, %215, !dbg !237
  %218 = fadd double %216, %217, !dbg !237
  %219 = trunc i64 %201 to i32, !dbg !238
  %220 = shl nsw i32 %219, 1, !dbg !238
  %221 = sext i32 %220 to i64, !dbg !238
  %222 = getelementptr inbounds double, ptr %8, i64 %221, !dbg !238
  %223 = load double, ptr %222, align 8, !dbg !239, !tbaa !155
  %224 = fadd double %223, %218, !dbg !239
  store double %224, ptr %222, align 8, !dbg !239, !tbaa !155
  %225 = fmul double %172, %210, !dbg !240
  %226 = fmul double %169, %215, !dbg !241
  %227 = fsub double %225, %226, !dbg !241
  %228 = or disjoint i32 %220, 1, !dbg !242
  %229 = sext i32 %228 to i64, !dbg !242
  %230 = getelementptr inbounds double, ptr %8, i64 %229, !dbg !242
  %231 = load double, ptr %230, align 8, !dbg !243, !tbaa !155
  %232 = fadd double %231, %227, !dbg !243
  store double %232, ptr %230, align 8, !dbg !243, !tbaa !155
  %233 = trunc i64 %200 to i32, !dbg !244
  %234 = shl nsw i32 %233, 1, !dbg !244
  %235 = sext i32 %234 to i64, !dbg !244
  %236 = getelementptr inbounds double, ptr %5, i64 %235, !dbg !244
  %237 = load double, ptr %236, align 8, !dbg !244, !tbaa !155
  tail call void @llvm.dbg.value(metadata double %237, metadata !94, metadata !DIExpression()), !dbg !214
  %238 = or disjoint i32 %234, 1, !dbg !245
  %239 = sext i32 %238 to i64, !dbg !245
  %240 = getelementptr inbounds double, ptr %5, i64 %239, !dbg !245
  %241 = load double, ptr %240, align 8, !dbg !245, !tbaa !155
  tail call void @llvm.dbg.value(metadata double %241, metadata !98, metadata !DIExpression()), !dbg !214
  %242 = fmul double %210, %237, !dbg !246
  %243 = fmul double %215, %241, !dbg !247
  %244 = fsub double %242, %243, !dbg !248
  %245 = fadd double %203, %244, !dbg !249
  tail call void @llvm.dbg.value(metadata double %245, metadata !101, metadata !DIExpression()), !dbg !214
  %246 = fmul double %215, %237, !dbg !250
  %247 = fmul double %210, %241, !dbg !251
  %248 = fadd double %246, %247, !dbg !252
  %249 = fadd double %204, %248, !dbg !253
  tail call void @llvm.dbg.value(metadata double %249, metadata !102, metadata !DIExpression()), !dbg !214
...
254:                                              ; preds = %199
  %255 = load double, ptr %185, align 8, !dbg !259, !tbaa !155
  %256 = load double, ptr %191, align 8, !dbg !260, !tbaa !155
  br label %257, !dbg !261

257:                                              ; preds = %254, %148
  %258 = phi double [ %193, %148 ], [ %256, %254 ], !dbg !260
  %259 = phi double [ %187, %148 ], [ %255, %254 ], !dbg !259
  %260 = phi double [ 0.000000e+00, %148 ], [ %249, %254 ], !dbg !214
  %261 = phi double [ 0.000000e+00, %148 ], [ %245, %254 ], !dbg !214
  %262 = fmul double %28, %261, !dbg !261
  %263 = fmul double %30, %260, !dbg !262
  %264 = fsub double %262, %263, !dbg !263
  %265 = fadd double %264, %259, !dbg !259
  store double %265, ptr %185, align 8, !dbg !259, !tbaa !155
  %266 = fmul double %28, %260, !dbg !264
  %267 = fmul double %30, %261, !dbg !265
  %268 = fadd double %266, %267, !dbg !266
  %269 = fadd double %268, %258, !dbg !260
  store double %269, ptr %191, align 8, !dbg !260, !tbaa !155
...
295:                                              ; preds = %281, %396
  ...
  %302 = getelementptr inbounds double, ptr %5, i64 %301, !dbg !277
  %303 = load double, ptr %302, align 8, !dbg !277, !tbaa !155
  tail call void @llvm.dbg.value(metadata double %303, metadata !117, metadata !DIExpression()), !dbg !278
  %304 = or disjoint i32 %300, 1, !dbg !279
  %305 = sext i32 %304 to i64, !dbg !279
  %306 = getelementptr inbounds double, ptr %5, i64 %305, !dbg !279
  %307 = load double, ptr %306, align 8, !dbg !279, !tbaa !155
  tail call void @llvm.dbg.value(metadata double %307, metadata !121, metadata !DIExpression()), !dbg !278
  %308 = fmul double %28, %303, !dbg !280
  %309 = fmul double %30, %307, !dbg !281
  %310 = fsub double %308, %309, !dbg !282
  tail call void @llvm.dbg.value(metadata double %310, metadata !122, metadata !DIExpression()), !dbg !278
  %311 = fmul double %28, %307, !dbg !283
  %312 = fmul double %30, %303, !dbg !284
  %313 = fadd double %312, %311, !dbg !285
  tail call void @llvm.dbg.value(metadata double %313, metadata !123, metadata !DIExpression()), !dbg !278
  tail call void @llvm.dbg.value(metadata double 0.000000e+00, metadata !124, metadata !DIExpression()), !dbg !278
  ...
  %322 = getelementptr inbounds double, ptr %4, i64 %321, !dbg !286
  %323 = load double, ptr %322, align 8, !dbg !286, !tbaa !155
  tail call void @llvm.dbg.value(metadata double %323, metadata !130, metadata !DIExpression()), !dbg !278
  %324 = fmul double %323, %310, !dbg !287
  %325 = trunc i64 %297 to i32, !dbg !288
  %326 = shl nsw i32 %325, 1, !dbg !288
  %327 = sext i32 %326 to i64, !dbg !288
  %328 = getelementptr inbounds double, ptr %8, i64 %327, !dbg !288
  %329 = load double, ptr %328, align 8, !dbg !289, !tbaa !155
  %330 = fadd double %329, %324, !dbg !289
  store double %330, ptr %328, align 8, !dbg !289, !tbaa !155
  %331 = fmul double %323, %313, !dbg !290
  %332 = or disjoint i32 %326, 1, !dbg !291
  %333 = sext i32 %332 to i64, !dbg !291
  %334 = getelementptr inbounds double, ptr %8, i64 %333, !dbg !291
  %335 = load double, ptr %334, align 8, !dbg !292, !tbaa !155
  %336 = fadd double %331, %335, !dbg !292
  store double %336, ptr %334, align 8, !dbg !292, !tbaa !155
...
338:                                              ; preds = %295, %338
  ...
  %342 = phi double [ %388, %338 ], [ 0.000000e+00, %295 ]
  %343 = phi double [ %384, %338 ], [ 0.000000e+00, %295 ]
  ...
  tail call void @llvm.dbg.value(metadata double %342, metadata !125, metadata !DIExpression()), !dbg !278
  tail call void @llvm.dbg.value(metadata double %343, metadata !124, metadata !DIExpression()), !dbg !278
  ...
  %348 = getelementptr inbounds double, ptr %4, i64 %347, !dbg !295
  %349 = load double, ptr %348, align 8, !dbg !295, !tbaa !155
  tail call void @llvm.dbg.value(metadata double %349, metadata !131, metadata !DIExpression()), !dbg !296
  %350 = or disjoint i32 %346, 1, !dbg !297
  %351 = zext nneg i32 %350 to i64, !dbg !297
  %352 = getelementptr inbounds double, ptr %4, i64 %351, !dbg !297
  %353 = load double, ptr %352, align 8, !dbg !297, !tbaa !155
  %354 = fmul double %353, %289, !dbg !298
  tail call void @llvm.dbg.value(metadata double %354, metadata !135, metadata !DIExpression()), !dbg !296
  %355 = fmul double %310, %349, !dbg !299
  %356 = fmul double %313, %354, !dbg !300
  %357 = fadd double %355, %356, !dbg !300
  %358 = trunc i64 %340 to i32, !dbg !301
  %359 = shl nsw i32 %358, 1, !dbg !301
  %360 = sext i32 %359 to i64, !dbg !301
  %361 = getelementptr inbounds double, ptr %8, i64 %360, !dbg !301
  %362 = load double, ptr %361, align 8, !dbg !302, !tbaa !155
  %363 = fadd double %362, %357, !dbg !302
  store double %363, ptr %361, align 8, !dbg !302, !tbaa !155
  %364 = fmul double %313, %349, !dbg !303
  %365 = fmul double %310, %354, !dbg !304
  %366 = fsub double %364, %365, !dbg !304
  %367 = or disjoint i32 %359, 1, !dbg !305
  %368 = sext i32 %367 to i64, !dbg !305
  %369 = getelementptr inbounds double, ptr %8, i64 %368, !dbg !305
  %370 = load double, ptr %369, align 8, !dbg !306, !tbaa !155
  %371 = fadd double %370, %366, !dbg !306
  store double %371, ptr %369, align 8, !dbg !306, !tbaa !155
  %372 = trunc i64 %339 to i32, !dbg !307
  %373 = shl nsw i32 %372, 1, !dbg !307
  %374 = sext i32 %373 to i64, !dbg !307
  %375 = getelementptr inbounds double, ptr %5, i64 %374, !dbg !307
  %376 = load double, ptr %375, align 8, !dbg !307, !tbaa !155
  tail call void @llvm.dbg.value(metadata double %376, metadata !117, metadata !DIExpression()), !dbg !278
  %377 = or disjoint i32 %373, 1, !dbg !308
  %378 = sext i32 %377 to i64, !dbg !308
  %379 = getelementptr inbounds double, ptr %5, i64 %378, !dbg !308
  %380 = load double, ptr %379, align 8, !dbg !308, !tbaa !155
  tail call void @llvm.dbg.value(metadata double %380, metadata !121, metadata !DIExpression()), !dbg !278
  %381 = fmul double %349, %376, !dbg !309
  %382 = fmul double %354, %380, !dbg !310
  %383 = fsub double %381, %382, !dbg !311
  %384 = fadd double %343, %383, !dbg !312
  tail call void @llvm.dbg.value(metadata double %384, metadata !124, metadata !DIExpression()), !dbg !278
  %385 = fmul double %354, %376, !dbg !313
  %386 = fmul double %349, %380, !dbg !314
  %387 = fadd double %385, %386, !dbg !315
  %388 = fadd double %342, %387, !dbg !316
  tail call void @llvm.dbg.value(metadata double %388, metadata !125, metadata !DIExpression()), !dbg !278
...
393:                                              ; preds = %338
  %394 = load double, ptr %328, align 8, !dbg !322, !tbaa !155
  %395 = load double, ptr %334, align 8, !dbg !323, !tbaa !155
  br label %396, !dbg !324

396:                                              ; preds = %393, %295
  %397 = phi double [ %336, %295 ], [ %395, %393 ], !dbg !323
  %398 = phi double [ %330, %295 ], [ %394, %393 ], !dbg !322
  %399 = phi double [ 0.000000e+00, %295 ], [ %384, %393 ], !dbg !278
  %400 = phi double [ 0.000000e+00, %295 ], [ %388, %393 ], !dbg !278
  %401 = fmul double %28, %399, !dbg !324
  %402 = fmul double %30, %400, !dbg !325
  %403 = fsub double %401, %402, !dbg !326
  %404 = fadd double %403, %398, !dbg !322
  store double %404, ptr %328, align 8, !dbg !322, !tbaa !155
  %405 = fmul double %28, %400, !dbg !327
  %406 = fmul double %30, %399, !dbg !328
  %407 = fadd double %406, %405, !dbg !329
  %408 = fadd double %407, %397, !dbg !323
  store double %408, ptr %334, align 8, !dbg !323, !tbaa !155
