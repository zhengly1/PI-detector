...
51:                                               ; preds = %34, %47
  ...
  %78 = getelementptr inbounds float, ptr %6, i64 %77, !dbg !146
  %79 = load float, ptr %78, align 4, !dbg !147, !tbaa !133
  %80 = fadd float %79, %72, !dbg !147
  store float %80, ptr %78, align 4, !dbg !147, !tbaa !133
  %81 = or disjoint i32 %76, 1, !dbg !148
  %82 = sext i32 %81 to i64, !dbg !148
  %83 = getelementptr inbounds float, ptr %6, i64 %82, !dbg !148
  store float 0.000000e+00, ptr %83, align 4, !dbg !149, !tbaa !133
...
90:                                               ; preds = %87, %90
  ...
  %96 = getelementptr inbounds float, ptr %4, i64 %95, !dbg !154
  %97 = load float, ptr %96, align 4, !dbg !154, !tbaa !133
  tail call void @llvm.dbg.value(metadata float %97, metadata !81, metadata !DIExpression()), !dbg !155
  %98 = or disjoint i32 %94, 1, !dbg !156
  %99 = sext i32 %98 to i64, !dbg !156
  %100 = getelementptr inbounds float, ptr %4, i64 %99, !dbg !156
  %101 = load float, ptr %100, align 4, !dbg !156, !tbaa !133
  %102 = fmul float %101, %41, !dbg !157
  tail call void @llvm.dbg.value(metadata float %102, metadata !85, metadata !DIExpression()), !dbg !155
  %103 = fmul float %63, %97, !dbg !158
  %104 = fmul float %68, %102, !dbg !159
  %105 = fsub float %103, %104, !dbg !160
  %106 = trunc i64 %92 to i32, !dbg !161
  %107 = add i32 %89, %106, !dbg !161
  %108 = shl nsw i32 %107, 1, !dbg !161
  %109 = sext i32 %108 to i64, !dbg !161
  %110 = getelementptr inbounds float, ptr %6, i64 %109, !dbg !161
  %111 = load float, ptr %110, align 4, !dbg !162, !tbaa !133
  %112 = fadd float %111, %105, !dbg !162
  store float %112, ptr %110, align 4, !dbg !162, !tbaa !133
  %113 = fmul float %63, %102, !dbg !163
  %114 = fmul float %68, %97, !dbg !164
  %115 = fadd float %114, %113, !dbg !165
  %116 = or disjoint i32 %108, 1, !dbg !166
  %117 = sext i32 %116 to i64, !dbg !166
  %118 = getelementptr inbounds float, ptr %6, i64 %117, !dbg !166
  %119 = load float, ptr %118, align 4, !dbg !167, !tbaa !133
  %120 = fadd float %119, %115, !dbg !167
  store float %120, ptr %118, align 4, !dbg !167, !tbaa !133
...
134:                                              ; preds = %128
  ...
  %136 = fmul float %135, %3
  %137 = sitofp i32 %9 to float
...
140:                                              ; preds = %134, %194
  ...
  %146 = getelementptr inbounds float, ptr %4, i64 %145, !dbg !177
  %147 = load float, ptr %146, align 4, !dbg !177, !tbaa !133
  %148 = fmul float %147, %3, !dbg !178
  tail call void @llvm.dbg.value(metadata float %148, metadata !89, metadata !DIExpression()), !dbg !179
  %149 = or disjoint i32 %144, 1, !dbg !180
  %150 = sext i32 %149 to i64, !dbg !180
  %151 = getelementptr inbounds float, ptr %4, i64 %150, !dbg !180
  %152 = load float, ptr %151, align 4, !dbg !180, !tbaa !133
  %153 = fmul float %136, %152, !dbg !181
  tail call void @llvm.dbg.value(metadata float %153, metadata !93, metadata !DIExpression()), !dbg !179
...
158:                                              ; preds = %155, %158
  ...
  %164 = getelementptr inbounds float, ptr %4, i64 %163, !dbg !184
  %165 = load float, ptr %164, align 4, !dbg !184, !tbaa !133
  tail call void @llvm.dbg.value(metadata float %165, metadata !95, metadata !DIExpression()), !dbg !185
  %166 = or disjoint i32 %162, 1, !dbg !186
  %167 = sext i32 %166 to i64, !dbg !186
  %168 = getelementptr inbounds float, ptr %4, i64 %167, !dbg !186
  %169 = load float, ptr %168, align 4, !dbg !186, !tbaa !133
  %170 = fmul float %169, %137, !dbg !187
  tail call void @llvm.dbg.value(metadata float %170, metadata !99, metadata !DIExpression()), !dbg !185
  %171 = fmul float %148, %165, !dbg !188
  %172 = fmul float %153, %170, !dbg !189
  %173 = fsub float %171, %172, !dbg !190
  %174 = shl nuw i32 %160, 1, !dbg !191
  %175 = add i32 %174, %157, !dbg !191
  %176 = and i32 %175, -2, !dbg !191
  %177 = sext i32 %176 to i64, !dbg !191
  %178 = getelementptr inbounds float, ptr %6, i64 %177, !dbg !191
  %179 = load float, ptr %178, align 4, !dbg !192, !tbaa !133
  %180 = fadd float %179, %173, !dbg !192
  store float %180, ptr %178, align 4, !dbg !192, !tbaa !133
  %181 = fmul float %148, %170, !dbg !193
  %182 = fmul float %153, %165, !dbg !194
  %183 = fadd float %182, %181, !dbg !195
  %184 = or i32 %175, 1, !dbg !196
  %185 = sext i32 %184 to i64, !dbg !196
  %186 = getelementptr inbounds float, ptr %6, i64 %185, !dbg !196
  %187 = load float, ptr %186, align 4, !dbg !197, !tbaa !133
  %188 = fadd float %187, %183, !dbg !197
  store float %188, ptr %186, align 4, !dbg !197, !tbaa !133
...
194:                                              ; preds = %140, %192
  ...
  %199 = getelementptr inbounds float, ptr %4, i64 %198, !dbg !202
  %200 = load float, ptr %199, align 4, !dbg !202, !tbaa !133
  tail call void @llvm.dbg.value(metadata float %200, metadata !100, metadata !DIExpression()), !dbg !204
  %201 = or disjoint i32 %197, 1, !dbg !205
  %202 = sext i32 %201 to i64, !dbg !205
  %203 = getelementptr inbounds float, ptr %4, i64 %202, !dbg !205
  %204 = load float, ptr %203, align 4, !dbg !205, !tbaa !133
  %205 = fmul float %204, %137, !dbg !206
  tail call void @llvm.dbg.value(metadata float %205, metadata !102, metadata !DIExpression()), !dbg !204
  %206 = fmul float %148, %200, !dbg !207
  %207 = fmul float %153, %205, !dbg !208
  %208 = fsub float %206, %207, !dbg !209
  %209 = add nuw i32 %142, 3, !dbg !203
  %210 = mul i32 %209, %142, !dbg !203
  %211 = and i32 %210, -2, !dbg !203
  %212 = sext i32 %211 to i64, !dbg !203
  %213 = getelementptr inbounds float, ptr %6, i64 %212, !dbg !203
  %214 = load float, ptr %213, align 4, !dbg !210, !tbaa !133
  %215 = fadd float %214, %208, !dbg !210
  store float %215, ptr %213, align 4, !dbg !210, !tbaa !133
  %216 = or i32 %210, 1, !dbg !211
  %217 = sext i32 %216 to i64, !dbg !211
  %218 = getelementptr inbounds float, ptr %6, i64 %217, !dbg !211
  store float 0.000000e+00, ptr %218, align 4, !dbg !212, !tbaa !133
