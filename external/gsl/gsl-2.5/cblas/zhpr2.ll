...
62:                                               ; preds = %42, %58
  ...
  %83 = fsub double %81, %82, !dbg !166
  tail call void @llvm.dbg.value(metadata double %83, metadata !83, metadata !DIExpression()), !dbg !162
  %84 = fmul double %29, %76, !dbg !167
  %85 = fmul double %27, %80, !dbg !168
  %86 = fadd double %84, %85, !dbg !169
  tail call void @llvm.dbg.value(metadata double %86, metadata !84, metadata !DIExpression()), !dbg !162
  %87 = trunc i64 %63 to i32, !dbg !170
  %88 = shl nsw i32 %87, 1, !dbg !170
  %89 = sext i32 %88 to i64, !dbg !170
  %90 = getelementptr inbounds double, ptr %6, i64 %89, !dbg !170
  %91 = load double, ptr %90, align 8, !dbg !170, !tbaa !141
  tail call void @llvm.dbg.value(metadata double %91, metadata !85, metadata !DIExpression()), !dbg !162
  %92 = or disjoint i32 %88, 1, !dbg !171
  %93 = sext i32 %92 to i64, !dbg !171
  %94 = getelementptr inbounds double, ptr %6, i64 %93, !dbg !171
  %95 = load double, ptr %94, align 8, !dbg !171, !tbaa !141
  tail call void @llvm.dbg.value(metadata double %95, metadata !86, metadata !DIExpression()), !dbg !162
  %96 = fmul double %27, %91, !dbg !172
  %97 = fmul double %29, %95, !dbg !173
  %98 = fadd double %96, %97, !dbg !174
  tail call void @llvm.dbg.value(metadata double %98, metadata !87, metadata !DIExpression()), !dbg !162
  %99 = fmul double %27, %95, !dbg !175
  %100 = fmul double %29, %91, !dbg !176
  %101 = fsub double %99, %100, !dbg !176
  tail call void @llvm.dbg.value(metadata double %101, metadata !88, metadata !DIExpression()), !dbg !162
  ...
  %104 = fmul double %91, %83, !dbg !179
  %105 = fmul double %86, %95, !dbg !180
  %106 = fadd double %104, %105, !dbg !181
  %107 = fmul double %106, 2.000000e+00, !dbg !182
  ...
  %113 = getelementptr inbounds double, ptr %8, i64 %112, !dbg !183
  %114 = load double, ptr %113, align 8, !dbg !184, !tbaa !141
  %115 = fadd double %114, %107, !dbg !184
  store double %115, ptr %113, align 8, !dbg !184, !tbaa !141
  %116 = or disjoint i32 %111, 1, !dbg !185
  %117 = sext i32 %116 to i64, !dbg !185
  %118 = getelementptr inbounds double, ptr %8, i64 %117, !dbg !185
  store double 0.000000e+00, ptr %118, align 8, !dbg !186, !tbaa !141
...
125:                                              ; preds = %121, %125
  ...
  %132 = getelementptr inbounds double, ptr %4, i64 %131, !dbg !190
  %133 = load double, ptr %132, align 8, !dbg !190, !tbaa !141
  tail call void @llvm.dbg.value(metadata double %133, metadata !91, metadata !DIExpression()), !dbg !191
  %134 = or disjoint i32 %130, 1, !dbg !192
  %135 = sext i32 %134 to i64, !dbg !192
  %136 = getelementptr inbounds double, ptr %4, i64 %135, !dbg !192
  %137 = load double, ptr %136, align 8, !dbg !192, !tbaa !141
  tail call void @llvm.dbg.value(metadata double %137, metadata !95, metadata !DIExpression()), !dbg !191
  ...
  %142 = load double, ptr %141, align 8, !dbg !193, !tbaa !141
  tail call void @llvm.dbg.value(metadata double %142, metadata !96, metadata !DIExpression()), !dbg !191
  %143 = or disjoint i32 %139, 1, !dbg !194
  %144 = sext i32 %143 to i64, !dbg !194
  %145 = getelementptr inbounds double, ptr %6, i64 %144, !dbg !194
  %146 = load double, ptr %145, align 8, !dbg !194, !tbaa !141
  tail call void @llvm.dbg.value(metadata double %146, metadata !97, metadata !DIExpression()), !dbg !191
  %147 = fmul double %83, %142, !dbg !195
  %148 = fmul double %86, %146, !dbg !196
  %149 = fadd double %147, %148, !dbg !197
  %150 = fmul double %98, %133, !dbg !198
  %151 = fmul double %101, %137, !dbg !199
  %152 = fadd double %150, %151, !dbg !200
  %153 = fadd double %152, %149, !dbg !201
  %154 = trunc i64 %128 to i32, !dbg !202
  %155 = add i32 %124, %154, !dbg !202
  %156 = shl nsw i32 %155, 1, !dbg !202
  %157 = sext i32 %156 to i64, !dbg !202
  %158 = getelementptr inbounds double, ptr %8, i64 %157, !dbg !202
  %159 = load double, ptr %158, align 8, !dbg !203, !tbaa !141
  %160 = fadd double %159, %153, !dbg !203
  store double %160, ptr %158, align 8, !dbg !203, !tbaa !141
  %161 = fmul double %86, %142, !dbg !204
  %162 = fmul double %83, %146, !dbg !205
  %163 = fsub double %161, %162, !dbg !206
  %164 = fmul double %101, %133, !dbg !207
  %165 = fmul double %98, %137, !dbg !208
  %166 = fsub double %164, %165, !dbg !209
  %167 = fadd double %166, %163, !dbg !210
  %168 = fmul double %167, %52, !dbg !211
  %169 = or disjoint i32 %156, 1, !dbg !212
  %170 = sext i32 %169 to i64, !dbg !212
  %171 = getelementptr inbounds double, ptr %8, i64 %170, !dbg !212
  %172 = load double, ptr %171, align 8, !dbg !213, !tbaa !141
  %173 = fadd double %172, %168, !dbg !213
  store double %173, ptr %171, align 8, !dbg !213, !tbaa !141
...
197:                                              ; preds = %184, %288
  ...
  %204 = getelementptr inbounds double, ptr %4, i64 %203, !dbg !225
  %205 = load double, ptr %204, align 8, !dbg !225, !tbaa !141
  tail call void @llvm.dbg.value(metadata double %205, metadata !102, metadata !DIExpression()), !dbg !226
  %206 = or disjoint i32 %202, 1, !dbg !227
  %207 = sext i32 %206 to i64, !dbg !227
  %208 = getelementptr inbounds double, ptr %4, i64 %207, !dbg !227
  %209 = load double, ptr %208, align 8, !dbg !227, !tbaa !141
  tail call void @llvm.dbg.value(metadata double %209, metadata !106, metadata !DIExpression()), !dbg !226
  %210 = fmul double %27, %205, !dbg !228
  %211 = fmul double %29, %209, !dbg !229
  %212 = fsub double %210, %211, !dbg !230
  tail call void @llvm.dbg.value(metadata double %212, metadata !107, metadata !DIExpression()), !dbg !226
  %213 = fmul double %29, %205, !dbg !231
  %214 = fmul double %27, %209, !dbg !232
  %215 = fadd double %213, %214, !dbg !233
  tail call void @llvm.dbg.value(metadata double %215, metadata !108, metadata !DIExpression()), !dbg !226
  %216 = trunc i64 %198 to i32, !dbg !234
  %217 = shl nsw i32 %216, 1, !dbg !234
  %218 = sext i32 %217 to i64, !dbg !234
  %219 = getelementptr inbounds double, ptr %6, i64 %218, !dbg !234
  %220 = load double, ptr %219, align 8, !dbg !234, !tbaa !141
  tail call void @llvm.dbg.value(metadata double %220, metadata !109, metadata !DIExpression()), !dbg !226
  %221 = or disjoint i32 %217, 1, !dbg !235
  %222 = sext i32 %221 to i64, !dbg !235
  %223 = getelementptr inbounds double, ptr %6, i64 %222, !dbg !235
  %224 = load double, ptr %223, align 8, !dbg !235, !tbaa !141
  tail call void @llvm.dbg.value(metadata double %224, metadata !110, metadata !DIExpression()), !dbg !226
  %225 = fmul double %27, %220, !dbg !236
  %226 = fmul double %29, %224, !dbg !237
  %227 = fadd double %225, %226, !dbg !238
  tail call void @llvm.dbg.value(metadata double %227, metadata !111, metadata !DIExpression()), !dbg !226
  %228 = fmul double %27, %224, !dbg !239
  %229 = fmul double %29, %220, !dbg !240
  %230 = fsub double %228, %229, !dbg !240
  tail call void @llvm.dbg.value(metadata double %230, metadata !112, metadata !DIExpression()), !dbg !226
...
235:                                              ; preds = %232, %235
  ...
  %242 = getelementptr inbounds double, ptr %4, i64 %241, !dbg !243
  %243 = load double, ptr %242, align 8, !dbg !243, !tbaa !141
  tail call void @llvm.dbg.value(metadata double %243, metadata !115, metadata !DIExpression()), !dbg !244
  %244 = or disjoint i32 %240, 1, !dbg !245
  %245 = sext i32 %244 to i64, !dbg !245
  %246 = getelementptr inbounds double, ptr %4, i64 %245, !dbg !245
  %247 = load double, ptr %246, align 8, !dbg !245, !tbaa !141
  tail call void @llvm.dbg.value(metadata double %247, metadata !119, metadata !DIExpression()), !dbg !244
  %248 = trunc i64 %237 to i32, !dbg !246
  %249 = shl nsw i32 %248, 1, !dbg !246
  %250 = sext i32 %249 to i64, !dbg !246
  %251 = getelementptr inbounds double, ptr %6, i64 %250, !dbg !246
  %252 = load double, ptr %251, align 8, !dbg !246, !tbaa !141
  tail call void @llvm.dbg.value(metadata double %252, metadata !120, metadata !DIExpression()), !dbg !244
  %253 = or disjoint i32 %249, 1, !dbg !247
  %254 = sext i32 %253 to i64, !dbg !247
  %255 = getelementptr inbounds double, ptr %6, i64 %254, !dbg !247
  %256 = load double, ptr %255, align 8, !dbg !247, !tbaa !141
  tail call void @llvm.dbg.value(metadata double %256, metadata !121, metadata !DIExpression()), !dbg !244
  %257 = fmul double %212, %252, !dbg !248
  %258 = fmul double %215, %256, !dbg !249
  %259 = fadd double %257, %258, !dbg !250
  %260 = fmul double %227, %243, !dbg !251
  %261 = fmul double %230, %247, !dbg !252
  %262 = fadd double %260, %261, !dbg !253
  %263 = fadd double %262, %259, !dbg !254
  %264 = shl nuw i32 %238, 1, !dbg !255
  %265 = add i32 %264, %234, !dbg !255
  %266 = and i32 %265, -2, !dbg !255
  %267 = sext i32 %266 to i64, !dbg !255
  %268 = getelementptr inbounds double, ptr %8, i64 %267, !dbg !255
  %269 = load double, ptr %268, align 8, !dbg !256, !tbaa !141
  %270 = fadd double %269, %263, !dbg !256
  store double %270, ptr %268, align 8, !dbg !256, !tbaa !141
  %271 = fmul double %215, %252, !dbg !257
  %272 = fmul double %212, %256, !dbg !258
  %273 = fsub double %271, %272, !dbg !259
  %274 = fmul double %230, %243, !dbg !260
  %275 = fmul double %227, %247, !dbg !261
  %276 = fsub double %274, %275, !dbg !262
  %277 = fadd double %276, %273, !dbg !263
  %278 = fmul double %277, %192, !dbg !264
  %279 = or i32 %265, 1, !dbg !265
  %280 = sext i32 %279 to i64, !dbg !265
  %281 = getelementptr inbounds double, ptr %8, i64 %280, !dbg !265
  %282 = load double, ptr %281, align 8, !dbg !266, !tbaa !141
  %283 = fadd double %282, %278, !dbg !266
  store double %283, ptr %281, align 8, !dbg !266, !tbaa !141
...
288:                                              ; preds = %235, %197
  ...
  %290 = fmul double %220, %212, !dbg !273
  %291 = fmul double %215, %224, !dbg !274
  %292 = fadd double %290, %291, !dbg !275
  %293 = fmul double %292, 2.000000e+00, !dbg !276
  %294 = add nuw i32 %200, 3, !dbg !272
  %295 = mul i32 %294, %200, !dbg !272
  %296 = and i32 %295, -2, !dbg !272
  %297 = sext i32 %296 to i64, !dbg !272
  %298 = getelementptr inbounds double, ptr %8, i64 %297, !dbg !272
  %299 = load double, ptr %298, align 8, !dbg !277, !tbaa !141
  %300 = fadd double %293, %299, !dbg !277
  store double %300, ptr %298, align 8, !dbg !277, !tbaa !141
  %301 = or i32 %295, 1, !dbg !278
  %302 = sext i32 %301 to i64, !dbg !278
  %303 = getelementptr inbounds double, ptr %8, i64 %302, !dbg !278
  store double 0.000000e+00, ptr %303, align 8, !dbg !279, !tbaa !141
