...
56:                                               ; preds = %44, %56
  ...
  %67 = fadd float %66, %61, !dbg !120
  store float %67, ptr %65, align 4, !dbg !120, !tbaa !106
...
89:                                               ; preds = %82, %139
  ...
  %94 = getelementptr inbounds float, ptr %4, i64 %91, !dbg !135
  %95 = load float, ptr %94, align 4, !dbg !135, !tbaa !106
  %96 = fmul float %95, %3, !dbg !136
  tail call void @llvm.dbg.value(metadata float %96, metadata !75, metadata !DIExpression()), !dbg !137
  ...
  %101 = getelementptr float, ptr %6, i64 %100, !dbg !138
...
106:                                              ; preds = %106, %104
  ...
  %110 = getelementptr inbounds float, ptr %4, i64 %108, !dbg !140
  %111 = load float, ptr %110, align 4, !dbg !140, !tbaa !106
  %112 = fmul float %96, %111, !dbg !143
  %113 = getelementptr float, ptr %101, i64 %107, !dbg !144
  %114 = load float, ptr %113, align 4, !dbg !145, !tbaa !106
  %115 = fadd float %114, %112, !dbg !145
  store float %115, ptr %113, align 4, !dbg !145, !tbaa !106
  ...
  tail call void @llvm.dbg.value(metadata i64 %116, metadata !79, metadata !DIExpression()), !dbg !137
  tail call void @llvm.dbg.value(metadata i64 %117, metadata !61, metadata !DIExpression()), !dbg !101
  %118 = getelementptr inbounds float, ptr %4, i64 %116, !dbg !140
  %119 = load float, ptr %118, align 4, !dbg !140, !tbaa !106
  %120 = fmul float %96, %119, !dbg !143
  %121 = getelementptr float, ptr %101, i64 %117, !dbg !144
  %122 = load float, ptr %121, align 4, !dbg !145, !tbaa !106
  %123 = fadd float %122, %120, !dbg !145
  store float %123, ptr %121, align 4, !dbg !145, !tbaa !106
...
132:                                              ; preds = %128
  ...
  %133 = getelementptr inbounds float, ptr %4, i64 %130, !dbg !140
  %134 = load float, ptr %133, align 4, !dbg !140, !tbaa !106
  %135 = fmul float %96, %134, !dbg !143
  %136 = getelementptr float, ptr %101, i64 %129, !dbg !144
  %137 = load float, ptr %136, align 4, !dbg !145, !tbaa !106
  %138 = fadd float %137, %135, !dbg !145
  store float %138, ptr %136, align 4, !dbg !145, !tbaa !106
