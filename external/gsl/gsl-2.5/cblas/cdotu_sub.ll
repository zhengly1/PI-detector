...
define dso_local void @cblas_cdotu_sub(i32 noundef %0, ptr nocapture noundef readonly %1, i32 noundef %2, ptr nocapture noundef readonly %3, i32 noundef %4, ptr nocapture noundef writeonly %5) local_unnamed_addr #0 !dbg !15 {
  ...
  br i1 %7, label %8, label %65, !dbg !48
...
20:                                               ; preds = %8, %20
  %21 = phi i64 [ %18, %8 ], [ %62, %20 ]
  %22 = phi i64 [ %16, %8 ], [ %61, %20 ]
  %23 = phi float [ 0.000000e+00, %8 ], [ %52, %20 ]
  %24 = phi float [ 0.000000e+00, %8 ], [ %60, %20 ]
  %25 = phi i32 [ 0, %8 ], [ %63, %20 ]
  ...
  %49 = fsub double %45, %48, !dbg !65
  %50 = fpext float %23 to double, !dbg !66
  %51 = fadd double %49, %50, !dbg !66
  %52 = fptrunc double %51 to float, !dbg !66
  tail call void @llvm.dbg.value(metadata float %52, metadata !30, metadata !DIExpression()), !dbg !46
  %53 = fmul float %30, %43, !dbg !67
  %54 = fpext float %53 to double, !dbg !68
  %55 = fpext float %39 to double, !dbg !69
  %56 = fmul double %46, %55, !dbg !70
  %57 = fadd double %56, %54, !dbg !71
  %58 = fpext float %24 to double, !dbg !72
  %59 = fadd double %57, %58, !dbg !72
  %60 = fptrunc double %59 to float, !dbg !72
  tail call void @llvm.dbg.value(metadata float %60, metadata !34, metadata !DIExpression()), !dbg !46
  %61 = add i64 %22, %17, !dbg !73
  tail call void @llvm.dbg.value(metadata i64 %61, metadata !36, metadata !DIExpression()), !dbg !46
  %62 = add i64 %21, %19, !dbg !74
  tail call void @llvm.dbg.value(metadata i64 %62, metadata !37, metadata !DIExpression()), !dbg !46
  %63 = add nuw nsw i32 %25, 1, !dbg !75
  tail call void @llvm.dbg.value(metadata i32 %63, metadata !35, metadata !DIExpression()), !dbg !46
  %64 = icmp eq i32 %63, %0, !dbg !47
  br i1 %64, label %65, label %20, !dbg !48, !llvm.loop !76

65:                                               ; preds = %20, %6
  %66 = phi float [ 0.000000e+00, %6 ], [ %60, %20 ], !dbg !46
  %67 = phi float [ 0.000000e+00, %6 ], [ %52, %20 ], !dbg !46
  store float %67, ptr %5, align 4, !dbg !79, !tbaa !52
  %68 = getelementptr inbounds float, ptr %5, i64 1, !dbg !80
  store float %66, ptr %68, align 4, !dbg !81, !tbaa !52
  ret void, !dbg !82
}
...
!65 = !DILocation(line: 31, column: 31, scope: !39)
!66 = !DILocation(line: 31, column: 12, scope: !39)
!67 = !DILocation(line: 32, column: 22, scope: !39)
!68 = !DILocation(line: 32, column: 15, scope: !39)
!69 = !DILocation(line: 32, column: 54, scope: !39)
!70 = !DILocation(line: 32, column: 52, scope: !39)
!71 = !DILocation(line: 32, column: 31, scope: !39)
!72 = !DILocation(line: 32, column: 12, scope: !39)
!73 = !DILocation(line: 33, column: 8, scope: !39)
!74 = !DILocation(line: 34, column: 8, scope: !39)
!75 = !DILocation(line: 26, column: 23, scope: !40)
!76 = distinct !{!76, !48, !77, !78}
!77 = !DILocation(line: 35, column: 3, scope: !41)
!78 = !{!"llvm.loop.mustprogress"}
!79 = !DILocation(line: 36, column: 17, scope: !31)
!80 = !DILocation(line: 37, column: 3, scope: !31)
!81 = !DILocation(line: 37, column: 17, scope: !31)
!82 = !DILocation(line: 14, column: 1, scope: !83)
!83 = !DILexicalBlockFile(scope: !15, file: !1, discriminator: 0)
