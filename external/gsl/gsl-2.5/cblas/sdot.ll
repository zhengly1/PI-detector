...
23:                                               ; preds = %23, %21
  ...
  %26 = phi float [ 0.000000e+00, %21 ], [ %41, %23 ]
  ...
  %33 = fadd float %26, %32, !dbg !47
  tail call void @llvm.dbg.value(metadata float %33, metadata !24, metadata !DIExpression()), !dbg !32
  ...
  tail call void @llvm.dbg.value(metadata i32 poison, metadata !28, metadata !DIExpression(DW_OP_plus_uconst, 1, DW_OP_stack_value)), !dbg !32
  tail call void @llvm.dbg.value(metadata float %33, metadata !24, metadata !DIExpression()), !dbg !32
  %36 = getelementptr inbounds float, ptr %1, i64 %34, !dbg !39
  %37 = load float, ptr %36, align 4, !dbg !39, !tbaa !41
  %38 = getelementptr inbounds float, ptr %3, i64 %35, !dbg !45
  %39 = load float, ptr %38, align 4, !dbg !45, !tbaa !41
  %40 = fmul float %37, %39, !dbg !46
  %41 = fadd float %33, %40, !dbg !47
  tail call void @llvm.dbg.value(metadata float %41, metadata !24, metadata !DIExpression()), !dbg !32
...
46:                                               ; preds = %23, %7
  %47 = phi float [ undef, %7 ], [ %41, %23 ]
  %48 = phi i64 [ %17, %7 ], [ %42, %23 ]
  %49 = phi i64 [ %15, %7 ], [ %43, %23 ]
  %50 = phi float [ 0.000000e+00, %7 ], [ %41, %23 ]
...
52:                                               ; preds = %46
  ...
  tail call void @llvm.dbg.value(metadata i32 poison, metadata !28, metadata !DIExpression()), !dbg !32
  tail call void @llvm.dbg.value(metadata float %50, metadata !24, metadata !DIExpression()), !dbg !32
  %53 = getelementptr inbounds float, ptr %1, i64 %48, !dbg !39
  %54 = load float, ptr %53, align 4, !dbg !39, !tbaa !41
  %55 = getelementptr inbounds float, ptr %3, i64 %49, !dbg !45
  %56 = load float, ptr %55, align 4, !dbg !45, !tbaa !41
  %57 = fmul float %54, %56, !dbg !46
  %58 = fadd float %50, %57, !dbg !47
  tail call void @llvm.dbg.value(metadata float %58, metadata !24, metadata !DIExpression()), !dbg !32
...
59:                                               ; preds = %52, %46, %5
  %60 = phi float [ 0.000000e+00, %5 ], [ %47, %46 ], [ %58, %52 ], !dbg !32
  ret float %60, !dbg !53
}
