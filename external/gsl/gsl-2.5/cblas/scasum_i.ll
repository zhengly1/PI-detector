...
define dso_local float @cblas_scasum(i32 noundef %0, ptr nocapture noundef readonly %1, i32 noundef %2) local_unnamed_addr #0 !dbg !14 {
  ...
  %5 = icmp sgt i32 %0, 0
  %6 = and i1 %4, %5, !dbg !35
  br i1 %6, label %7, label %31, !dbg !35
...
9:                                                ; preds = %9, %7
  %10 = phi i64 [ 0, %7 ], [ %28, %9 ]
  %11 = phi i32 [ 0, %7 ], [ %29, %9 ]
  %12 = phi float [ 0.000000e+00, %7 ], [ %27, %9 ]
  ...
  %handler_result = call double @fAddHandlerDouble(double %19, double %25), !dbg !48
  %26 = fpext float %12 to double, !dbg !48
  %handler_result1 = call double @fAddHandlerDouble(double %handler_result, double %26), !dbg !48
  %27 = fptrunc double %handler_result1 to float, !dbg !48
  tail call void @llvm.dbg.value(metadata float %27, metadata !25, metadata !DIExpression()), !dbg !32
  %28 = add nuw nsw i64 %10, %8, !dbg !49
  tail call void @llvm.dbg.value(metadata i64 %28, metadata !30, metadata !DIExpression()), !dbg !32
  %29 = add nuw nsw i32 %11, 1, !dbg !50
  tail call void @llvm.dbg.value(metadata i32 %29, metadata !29, metadata !DIExpression()), !dbg !32
  %30 = icmp eq i32 %29, %0, !dbg !51
  br i1 %30, label %31, label %9, !dbg !36, !llvm.loop !52

31:                                               ; preds = %9, %3
  %32 = phi float [ 0.000000e+00, %3 ], [ %27, %9 ], !dbg !32
  ret float %32, !dbg !55
}
...
!50 = !DILocation(line: 29, column: 23, scope: !40)
!51 = !DILocation(line: 29, column: 17, scope: !40)
!52 = distinct !{!52, !36, !53, !54}
!53 = !DILocation(line: 32, column: 3, scope: !37)
!54 = !{!"llvm.loop.mustprogress"}
!55 = !DILocation(line: 11, column: 1, scope: !56)
!56 = !DILexicalBlockFile(scope: !14, file: !1, discriminator: 0)
