...
152:                                              ; preds = %135, %209
  ...
  %176 = fadd double %175, %173, !dbg !189
  store double %176, ptr %174, align 8, !dbg !189, !tbaa !146
...
185:                                              ; preds = %179, %185
  ...
  %189 = phi double [ 0.000000e+00, %179 ], [ %202, %185 ]
  ...
  tail call void @llvm.dbg.value(metadata double %189, metadata !83, metadata !DIExpression()), !dbg !182
  %190 = trunc i64 %188 to i32, !dbg !192
  %191 = add i32 %183, %190, !dbg !192
  %192 = sext i32 %191 to i64, !dbg !193
  %193 = getelementptr inbounds double, ptr %5, i64 %192, !dbg !193
  %194 = load double, ptr %193, align 8, !dbg !193, !tbaa !146
  tail call void @llvm.dbg.value(metadata double %194, metadata !88, metadata !DIExpression()), !dbg !194
  %195 = fmul double %163, %194, !dbg !195
  %196 = getelementptr inbounds double, ptr %10, i64 %187, !dbg !196
  %197 = load double, ptr %196, align 8, !dbg !197, !tbaa !146
  %198 = fadd double %197, %195, !dbg !197
  store double %198, ptr %196, align 8, !dbg !197, !tbaa !146
  %199 = getelementptr inbounds double, ptr %7, i64 %186, !dbg !198
  %200 = load double, ptr %199, align 8, !dbg !198, !tbaa !146
  %201 = fmul double %194, %200, !dbg !199
  %202 = fadd double %189, %201, !dbg !200
  tail call void @llvm.dbg.value(metadata double %202, metadata !83, metadata !DIExpression()), !dbg !182
...
207:                                              ; preds = %185
  %208 = load double, ptr %174, align 8, !dbg !206, !tbaa !146
  br label %209, !dbg !207

209:                                              ; preds = %207, %152
  %210 = phi double [ %176, %152 ], [ %208, %207 ], !dbg !206
  %211 = phi double [ 0.000000e+00, %152 ], [ %202, %207 ], !dbg !182
  %212 = fmul double %211, %4, !dbg !207
  %213 = fadd double %212, %210, !dbg !206
  store double %213, ptr %174, align 8, !dbg !206, !tbaa !146
...
231:                                              ; preds = %222
  ...
  %239 = getelementptr double, ptr %5, i64 %235, !dbg !217
...
240:                                              ; preds = %231, %292
  ...
  %244 = getelementptr inbounds double, ptr %7, i64 %241, !dbg !218
  %245 = load double, ptr %244, align 8, !dbg !218, !tbaa !146
  %246 = fmul double %245, %4, !dbg !219
  tail call void @llvm.dbg.value(metadata double %246, metadata !96, metadata !DIExpression()), !dbg !220
  tail call void @llvm.dbg.value(metadata double 0.000000e+00, metadata !100, metadata !DIExpression()), !dbg !220
...
270:                                              ; preds = %255, %270
  ...
  %274 = phi double [ 0.000000e+00, %255 ], [ %287, %270 ]
  ...
  tail call void @llvm.dbg.value(metadata double %274, metadata !100, metadata !DIExpression()), !dbg !220
  %275 = trunc i64 %271 to i32, !dbg !226
  %276 = add i32 %269, %275, !dbg !226
  %277 = sext i32 %276 to i64, !dbg !227
  %278 = getelementptr inbounds double, ptr %5, i64 %277, !dbg !227
  %279 = load double, ptr %278, align 8, !dbg !227, !tbaa !146
  tail call void @llvm.dbg.value(metadata double %279, metadata !105, metadata !DIExpression()), !dbg !228
  %280 = fmul double %246, %279, !dbg !229
  %281 = getelementptr inbounds double, ptr %10, i64 %273, !dbg !230
  %282 = load double, ptr %281, align 8, !dbg !231, !tbaa !146
  %283 = fadd double %282, %280, !dbg !231
  store double %283, ptr %281, align 8, !dbg !231, !tbaa !146
  %284 = getelementptr inbounds double, ptr %7, i64 %272, !dbg !232
  %285 = load double, ptr %284, align 8, !dbg !232, !tbaa !146
  %286 = fmul double %279, %285, !dbg !233
  %287 = fadd double %274, %286, !dbg !234
  tail call void @llvm.dbg.value(metadata double %287, metadata !100, metadata !DIExpression()), !dbg !220
...
292:                                              ; preds = %270, %253
  ...
  %294 = phi double [ 0.000000e+00, %253 ], [ %287, %270 ], !dbg !220
  %295 = getelementptr double, ptr %239, i64 %293, !dbg !240
  %296 = load double, ptr %295, align 8, !dbg !240, !tbaa !146
  %297 = fmul double %246, %296, !dbg !241
  %298 = fmul double %294, %4, !dbg !242
  %299 = fadd double %298, %297, !dbg !243
  %300 = getelementptr inbounds double, ptr %10, i64 %242, !dbg !244
  %301 = load double, ptr %300, align 8, !dbg !245, !tbaa !146
  %302 = fadd double %301, %299, !dbg !245
  store double %302, ptr %300, align 8, !dbg !245, !tbaa !146
