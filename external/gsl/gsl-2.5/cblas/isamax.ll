; ModuleID = 'isamax.c'
source_filename = "isamax.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

; Function Attrs: nofree norecurse nosync nounwind memory(argmem: read) uwtable
define dso_local i64 @cblas_isamax(i32 noundef %0, ptr nocapture noundef readonly %1, i32 noundef %2) local_unnamed_addr #0 !dbg !10 {
  ...
  tail call void @llvm.dbg.value(metadata float 0.000000e+00, metadata !25, metadata !DIExpression()), !dbg !33
...
14:                                               ; preds = %14, %12
  ...
  %18 = phi float [ 0.000000e+00, %12 ], [ %32, %14 ]
  ...
  tail call void @llvm.dbg.value(metadata float %18, metadata !25, metadata !DIExpression()), !dbg !33
  %20 = getelementptr inbounds float, ptr %1, i64 %15, !dbg !41
  %21 = load float, ptr %20, align 4, !dbg !41, !tbaa !44
  %22 = tail call float @llvm.fabs.f32(float %21), !dbg !48
  %23 = fcmp ogt float %22, %18, !dbg !49
  %24 = select i1 %23, float %22, float %18, !dbg !50
  ...
  tail call void @llvm.dbg.value(metadata float %24, metadata !25, metadata !DIExpression()), !dbg !33
  ...
  tail call void @llvm.dbg.value(metadata i64 %26, metadata !29, metadata !DIExpression()), !dbg !33
  tail call void @llvm.dbg.value(metadata float %24, metadata !25, metadata !DIExpression()), !dbg !33
  %28 = getelementptr inbounds float, ptr %1, i64 %26, !dbg !41
  %29 = load float, ptr %28, align 4, !dbg !41, !tbaa !44
  %30 = tail call float @llvm.fabs.f32(float %29), !dbg !48
  %31 = fcmp ogt float %30, %24, !dbg !49
  %32 = select i1 %31, float %30, float %24, !dbg !50
  ...
  tail call void @llvm.dbg.value(metadata float %32, metadata !25, metadata !DIExpression()), !dbg !33
...
38:                                               ; preds = %14, %7
  ...
  %43 = phi float [ 0.000000e+00, %7 ], [ %32, %14 ]
...
45:                                               ; preds = %38
  ...
  tail call void @llvm.dbg.value(metadata float %43, metadata !25, metadata !DIExpression()), !dbg !33
  %46 = getelementptr inbounds float, ptr %1, i64 %40, !dbg !41
  %47 = load float, ptr %46, align 4, !dbg !41, !tbaa !44
  %48 = tail call float @llvm.fabs.f32(float %47), !dbg !48
  %49 = fcmp ogt float %48, %43, !dbg !49
  ...
  tail call void @llvm.dbg.value(metadata float poison, metadata !25, metadata !DIExpression()), !dbg !33
...
!1 = !DIFile(filename: "isamax.c", directory: "/PI-detector/external/gsl/gsl-2.5/cblas", checksumkind: CSK_MD5, checksum: "05570dd4259cd3fc8141fc3ea76d7362")
...
!10 = distinct !DISubprogram(name: "cblas_isamax", scope: !1, file: !1, line: 6, type: !11, scopeLine: 7, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !21)
