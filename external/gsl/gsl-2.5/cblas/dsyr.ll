...
55:                                               ; preds = %47, %55
  ...
  %63 = fadd double %62, %60, !dbg !122
  store double %63, ptr %61, align 8, !dbg !122, !tbaa !109
...
86:                                               ; preds = %77, %132
  ...
  %90 = getelementptr inbounds double, ptr %4, i64 %87, !dbg !138
  %91 = load double, ptr %90, align 8, !dbg !138, !tbaa !109
  %92 = fmul double %91, %3, !dbg !139
  tail call void @llvm.dbg.value(metadata double %92, metadata !76, metadata !DIExpression()), !dbg !140
  ...
  tail call void @llvm.dbg.value(metadata i32 poison, metadata !80, metadata !DIExpression()), !dbg !140
  tail call void @llvm.dbg.value(metadata i32 0, metadata !62, metadata !DIExpression()), !dbg !104
  %94 = getelementptr double, ptr %6, i64 %93, !dbg !141
...
99:                                               ; preds = %99, %97
  ...
  %103 = getelementptr inbounds double, ptr %4, i64 %101, !dbg !143
  %104 = load double, ptr %103, align 8, !dbg !143, !tbaa !109
  %105 = fmul double %92, %104, !dbg !146
  %106 = getelementptr double, ptr %94, i64 %100, !dbg !147
  %107 = load double, ptr %106, align 8, !dbg !148, !tbaa !109
  %108 = fadd double %107, %105, !dbg !148
  store double %108, ptr %106, align 8, !dbg !148, !tbaa !109
  ...
  tail call void @llvm.dbg.value(metadata i64 %109, metadata !80, metadata !DIExpression()), !dbg !140
  tail call void @llvm.dbg.value(metadata i64 %110, metadata !62, metadata !DIExpression()), !dbg !104
  %111 = getelementptr inbounds double, ptr %4, i64 %109, !dbg !143
  %112 = load double, ptr %111, align 8, !dbg !143, !tbaa !109
  %113 = fmul double %92, %112, !dbg !146
  %114 = getelementptr double, ptr %94, i64 %110, !dbg !147
  %115 = load double, ptr %114, align 8, !dbg !148, !tbaa !109
  %116 = fadd double %115, %113, !dbg !148
  store double %116, ptr %114, align 8, !dbg !148, !tbaa !109
...
125:                                              ; preds = %121
  ...
  %126 = getelementptr inbounds double, ptr %4, i64 %123, !dbg !143
  %127 = load double, ptr %126, align 8, !dbg !143, !tbaa !109
  %128 = fmul double %92, %127, !dbg !146
  %129 = getelementptr double, ptr %94, i64 %122, !dbg !147
  %130 = load double, ptr %129, align 8, !dbg !148, !tbaa !109
  %131 = fadd double %130, %128, !dbg !148
  store double %131, ptr %129, align 8, !dbg !148, !tbaa !109
