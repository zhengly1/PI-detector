...
67:                                               ; preds = %56
  ...
  %88 = fsub float %86, %87, !dbg !219
  tail call void @llvm.dbg.value(metadata float %88, metadata !91, metadata !DIExpression()), !dbg !206
  %89 = fmul float %76, %85, !dbg !220
  %90 = fmul float %73, %81, !dbg !221
  %91 = fadd float %90, %89, !dbg !222
  tail call void @llvm.dbg.value(metadata float %91, metadata !92, metadata !DIExpression()), !dbg !206
...
92:                                               ; preds = %56
  ...
  %96 = getelementptr inbounds float, ptr %6, i64 %95, !dbg !224
  %97 = load float, ptr %96, align 4, !dbg !224, !tbaa !209
  tail call void @llvm.dbg.value(metadata float %97, metadata !91, metadata !DIExpression()), !dbg !206
  %98 = or disjoint i32 %94, 1, !dbg !226
  %99 = sext i32 %98 to i64, !dbg !226
  %100 = getelementptr inbounds float, ptr %6, i64 %99, !dbg !226
  %101 = load float, ptr %100, align 4, !dbg !226, !tbaa !209
  tail call void @llvm.dbg.value(metadata float %101, metadata !92, metadata !DIExpression()), !dbg !206
  br label %102

102:                                              ; preds = %92, %67
  %103 = phi float [ %91, %67 ], [ %101, %92 ], !dbg !227
  %104 = phi float [ %88, %67 ], [ %97, %92 ], !dbg !227
  tail call void @llvm.dbg.value(metadata float %104, metadata !91, metadata !DIExpression()), !dbg !206
  tail call void @llvm.dbg.value(metadata float %103, metadata !92, metadata !DIExpression()), !dbg !206
...
109:                                              ; preds = %107, %109
  ...
  %112 = phi float [ %104, %107 ], [ %137, %109 ]
  %113 = phi float [ %103, %107 ], [ %141, %109 ]
  tail call void @llvm.dbg.value(metadata i64 %111, metadata !77, metadata !DIExpression()), !dbg !178
  tail call void @llvm.dbg.value(metadata float %112, metadata !91, metadata !DIExpression()), !dbg !206
  tail call void @llvm.dbg.value(metadata float %113, metadata !92, metadata !DIExpression()), !dbg !206
  ...
  %118 = getelementptr inbounds float, ptr %5, i64 %117, !dbg !232
  %119 = load float, ptr %118, align 4, !dbg !232, !tbaa !209
  tail call void @llvm.dbg.value(metadata float %119, metadata !99, metadata !DIExpression()), !dbg !233
  %120 = or disjoint i32 %116, 1, !dbg !234
  %121 = sext i32 %120 to i64, !dbg !234
  %122 = getelementptr inbounds float, ptr %5, i64 %121, !dbg !234
  %123 = load float, ptr %122, align 4, !dbg !234, !tbaa !209
  %124 = fmul float %123, %52, !dbg !235
  tail call void @llvm.dbg.value(metadata float %124, metadata !103, metadata !DIExpression()), !dbg !233
  %125 = trunc i64 %110 to i32, !dbg !236
  %126 = shl nsw i32 %125, 1, !dbg !236
  %127 = sext i32 %126 to i64, !dbg !236
  %128 = getelementptr inbounds float, ptr %6, i64 %127, !dbg !236
  %129 = load float, ptr %128, align 4, !dbg !236, !tbaa !209
  tail call void @llvm.dbg.value(metadata float %129, metadata !104, metadata !DIExpression()), !dbg !233
  %130 = or disjoint i32 %126, 1, !dbg !237
  %131 = sext i32 %130 to i64, !dbg !237
  %132 = getelementptr inbounds float, ptr %6, i64 %131, !dbg !237
  %133 = load float, ptr %132, align 4, !dbg !237, !tbaa !209
  tail call void @llvm.dbg.value(metadata float %133, metadata !105, metadata !DIExpression()), !dbg !233
  %134 = fmul float %119, %129, !dbg !238
  %135 = fmul float %124, %133, !dbg !239
  %136 = fsub float %134, %135, !dbg !240
  %137 = fadd float %112, %136, !dbg !241
  tail call void @llvm.dbg.value(metadata float %137, metadata !91, metadata !DIExpression()), !dbg !206
  %138 = fmul float %119, %133, !dbg !242
  %139 = fmul float %124, %129, !dbg !243
  %140 = fadd float %139, %138, !dbg !244
  %141 = fadd float %113, %140, !dbg !245
  tail call void @llvm.dbg.value(metadata float %141, metadata !92, metadata !DIExpression()), !dbg !206
...
145:                                              ; preds = %109, %102
  %146 = phi float [ %103, %102 ], [ %141, %109 ], !dbg !206
  %147 = phi float [ %104, %102 ], [ %137, %109 ], !dbg !206
  %148 = trunc i64 %57 to i32, !dbg !251
  %149 = shl nsw i32 %148, 1, !dbg !251
  %150 = sext i32 %149 to i64, !dbg !251
  %151 = getelementptr inbounds float, ptr %6, i64 %150, !dbg !251
  store float %147, ptr %151, align 4, !dbg !252, !tbaa !209
  %152 = or disjoint i32 %149, 1, !dbg !253
  %153 = sext i32 %152 to i64, !dbg !253
  %154 = getelementptr inbounds float, ptr %6, i64 %153, !dbg !253
  store float %146, ptr %154, align 4, !dbg !254, !tbaa !209
...
179:                                              ; preds = %165, %260
  ...
  tail call void @llvm.dbg.value(metadata float poison, metadata !109, metadata !DIExpression()), !dbg !268
  tail call void @llvm.dbg.value(metadata float poison, metadata !113, metadata !DIExpression()), !dbg !268
...
186:                                              ; preds = %179
  ...
  %191 = getelementptr inbounds float, ptr %5, i64 %190, !dbg !270
  %192 = load float, ptr %191, align 4, !dbg !270, !tbaa !209
  %193 = fmul float %192, %173, !dbg !271
  tail call void @llvm.dbg.value(metadata float %193, metadata !113, metadata !DIExpression()), !dbg !268
  %194 = sext i32 %188 to i64, !dbg !267
  %195 = getelementptr inbounds float, ptr %5, i64 %194, !dbg !267
  %196 = load float, ptr %195, align 4, !dbg !267, !tbaa !209
  tail call void @llvm.dbg.value(metadata float %196, metadata !109, metadata !DIExpression()), !dbg !268
  %197 = shl nsw i32 %182, 1, !dbg !272
  %198 = sext i32 %197 to i64, !dbg !272
  %199 = getelementptr inbounds float, ptr %6, i64 %198, !dbg !272
  %200 = load float, ptr %199, align 4, !dbg !272, !tbaa !209
  tail call void @llvm.dbg.value(metadata float %200, metadata !116, metadata !DIExpression()), !dbg !273
  %201 = or disjoint i32 %197, 1, !dbg !274
  %202 = sext i32 %201 to i64, !dbg !274
  %203 = getelementptr inbounds float, ptr %6, i64 %202, !dbg !274
  %204 = load float, ptr %203, align 4, !dbg !274, !tbaa !209
  tail call void @llvm.dbg.value(metadata float %204, metadata !119, metadata !DIExpression()), !dbg !273
  %205 = fmul float %196, %200, !dbg !275
  %206 = fmul float %193, %204, !dbg !276
  %207 = fsub float %205, %206, !dbg !277
  tail call void @llvm.dbg.value(metadata float %207, metadata !114, metadata !DIExpression()), !dbg !268
  %208 = fmul float %196, %204, !dbg !278
  %209 = fmul float %193, %200, !dbg !279
  %210 = fadd float %209, %208, !dbg !280
  tail call void @llvm.dbg.value(metadata float %210, metadata !115, metadata !DIExpression()), !dbg !268
  br label %220, !dbg !281

211:                                              ; preds = %179
  %212 = shl nsw i32 %182, 1, !dbg !282
  %213 = sext i32 %212 to i64, !dbg !282
  %214 = getelementptr inbounds float, ptr %6, i64 %213, !dbg !282
  %215 = load float, ptr %214, align 4, !dbg !282, !tbaa !209
  tail call void @llvm.dbg.value(metadata float %215, metadata !114, metadata !DIExpression()), !dbg !268
  %216 = or disjoint i32 %212, 1, !dbg !284
  %217 = sext i32 %216 to i64, !dbg !284
  %218 = getelementptr inbounds float, ptr %6, i64 %217, !dbg !284
  %219 = load float, ptr %218, align 4, !dbg !284, !tbaa !209
  tail call void @llvm.dbg.value(metadata float %219, metadata !115, metadata !DIExpression()), !dbg !268
  br label %220

220:                                              ; preds = %211, %186
  %221 = phi float [ %210, %186 ], [ %219, %211 ], !dbg !285
  %222 = phi float [ %207, %186 ], [ %215, %211 ], !dbg !285
  ...
  tail call void @llvm.dbg.value(metadata float %222, metadata !114, metadata !DIExpression()), !dbg !268
  tail call void @llvm.dbg.value(metadata float %221, metadata !115, metadata !DIExpression()), !dbg !268
...
224:                                              ; preds = %220, %224
  ...
  %227 = phi float [ %252, %224 ], [ %222, %220 ]
  %228 = phi float [ %256, %224 ], [ %221, %220 ]
  tail call void @llvm.dbg.value(metadata i64 %226, metadata !77, metadata !DIExpression()), !dbg !178
  tail call void @llvm.dbg.value(metadata float %227, metadata !114, metadata !DIExpression()), !dbg !268
  tail call void @llvm.dbg.value(metadata float %228, metadata !115, metadata !DIExpression()), !dbg !268
  ...
  %233 = getelementptr inbounds float, ptr %5, i64 %232, !dbg !289
  %234 = load float, ptr %233, align 4, !dbg !289, !tbaa !209
  tail call void @llvm.dbg.value(metadata float %234, metadata !122, metadata !DIExpression()), !dbg !290
  %235 = or disjoint i32 %231, 1, !dbg !291
  %236 = sext i32 %235 to i64, !dbg !291
  %237 = getelementptr inbounds float, ptr %5, i64 %236, !dbg !291
  %238 = load float, ptr %237, align 4, !dbg !291, !tbaa !209
  %239 = fmul float %238, %173, !dbg !292
  tail call void @llvm.dbg.value(metadata float %239, metadata !126, metadata !DIExpression()), !dbg !290
  %240 = trunc i64 %225 to i32, !dbg !293
  %241 = shl nsw i32 %240, 1, !dbg !293
  %242 = sext i32 %241 to i64, !dbg !293
  %243 = getelementptr inbounds float, ptr %6, i64 %242, !dbg !293
  %244 = load float, ptr %243, align 4, !dbg !293, !tbaa !209
  tail call void @llvm.dbg.value(metadata float %244, metadata !127, metadata !DIExpression()), !dbg !290
  %245 = or disjoint i32 %241, 1, !dbg !294
  %246 = sext i32 %245 to i64, !dbg !294
  %247 = getelementptr inbounds float, ptr %6, i64 %246, !dbg !294
  %248 = load float, ptr %247, align 4, !dbg !294, !tbaa !209
  tail call void @llvm.dbg.value(metadata float %248, metadata !128, metadata !DIExpression()), !dbg !290
  %249 = fmul float %234, %244, !dbg !295
  %250 = fmul float %239, %248, !dbg !296
  %251 = fsub float %249, %250, !dbg !297
  %252 = fadd float %227, %251, !dbg !298
  tail call void @llvm.dbg.value(metadata float %252, metadata !114, metadata !DIExpression()), !dbg !268
  %253 = fmul float %234, %248, !dbg !299
  %254 = fmul float %239, %244, !dbg !300
  %255 = fadd float %254, %253, !dbg !301
  %256 = fadd float %228, %255, !dbg !302
  tail call void @llvm.dbg.value(metadata float %256, metadata !115, metadata !DIExpression()), !dbg !268
...
260:                                              ; preds = %224, %220
  %261 = phi float [ %221, %220 ], [ %256, %224 ], !dbg !268
  %262 = phi float [ %222, %220 ], [ %252, %224 ], !dbg !268
  %263 = shl nsw i32 %182, 1, !dbg !307
  %264 = sext i32 %263 to i64, !dbg !307
  %265 = getelementptr inbounds float, ptr %6, i64 %264, !dbg !307
  store float %262, ptr %265, align 4, !dbg !308, !tbaa !209
  %266 = or disjoint i32 %263, 1, !dbg !309
  %267 = sext i32 %266 to i64, !dbg !309
  %268 = getelementptr inbounds float, ptr %6, i64 %267, !dbg !309
  store float %261, ptr %268, align 4, !dbg !310, !tbaa !209
...
295:                                              ; preds = %279, %381
  ...
  tail call void @llvm.dbg.value(metadata float poison, metadata !132, metadata !DIExpression()), !dbg !325
  tail call void @llvm.dbg.value(metadata float poison, metadata !136, metadata !DIExpression()), !dbg !325
...
300:                                              ; preds = %295
  ...
  %307 = getelementptr inbounds float, ptr %5, i64 %306, !dbg !328
  %308 = load float, ptr %307, align 4, !dbg !328, !tbaa !209
  %309 = fmul float %308, %288, !dbg !329
  tail call void @llvm.dbg.value(metadata float %309, metadata !136, metadata !DIExpression()), !dbg !325
  %310 = sext i32 %304 to i64, !dbg !327
  %311 = getelementptr inbounds float, ptr %5, i64 %310, !dbg !327
  %312 = load float, ptr %311, align 4, !dbg !327, !tbaa !209
  tail call void @llvm.dbg.value(metadata float %312, metadata !132, metadata !DIExpression()), !dbg !325
  %313 = shl nsw i32 %298, 1, !dbg !330
  %314 = sext i32 %313 to i64, !dbg !330
  %315 = getelementptr inbounds float, ptr %6, i64 %314, !dbg !330
  %316 = load float, ptr %315, align 4, !dbg !330, !tbaa !209
  tail call void @llvm.dbg.value(metadata float %316, metadata !139, metadata !DIExpression()), !dbg !331
  %317 = or disjoint i32 %313, 1, !dbg !332
  %318 = sext i32 %317 to i64, !dbg !332
  %319 = getelementptr inbounds float, ptr %6, i64 %318, !dbg !332
  %320 = load float, ptr %319, align 4, !dbg !332, !tbaa !209
  tail call void @llvm.dbg.value(metadata float %320, metadata !142, metadata !DIExpression()), !dbg !331
  %321 = fmul float %312, %316, !dbg !333
  %322 = fmul float %309, %320, !dbg !334
  %323 = fsub float %321, %322, !dbg !335
  tail call void @llvm.dbg.value(metadata float %323, metadata !137, metadata !DIExpression()), !dbg !325
  %324 = fmul float %312, %320, !dbg !336
  %325 = fmul float %309, %316, !dbg !337
  %326 = fadd float %325, %324, !dbg !338
  tail call void @llvm.dbg.value(metadata float %326, metadata !138, metadata !DIExpression()), !dbg !325
  br label %336, !dbg !339

327:                                              ; preds = %295
  %328 = shl nsw i32 %298, 1, !dbg !340
  %329 = sext i32 %328 to i64, !dbg !340
  %330 = getelementptr inbounds float, ptr %6, i64 %329, !dbg !340
  %331 = load float, ptr %330, align 4, !dbg !340, !tbaa !209
  tail call void @llvm.dbg.value(metadata float %331, metadata !137, metadata !DIExpression()), !dbg !325
  %332 = or disjoint i32 %328, 1, !dbg !342
  %333 = sext i32 %332 to i64, !dbg !342
  %334 = getelementptr inbounds float, ptr %6, i64 %333, !dbg !342
  %335 = load float, ptr %334, align 4, !dbg !342, !tbaa !209
  tail call void @llvm.dbg.value(metadata float %335, metadata !138, metadata !DIExpression()), !dbg !325
  br label %336

336:                                              ; preds = %327, %300
  %337 = phi float [ %326, %300 ], [ %335, %327 ], !dbg !343
  %338 = phi float [ %323, %300 ], [ %331, %327 ], !dbg !343
  tail call void @llvm.dbg.value(metadata i32 %291, metadata !143, metadata !DIExpression()), !dbg !344
  tail call void @llvm.dbg.value(metadata i32 0, metadata !77, metadata !DIExpression()), !dbg !178
  tail call void @llvm.dbg.value(metadata float %338, metadata !137, metadata !DIExpression()), !dbg !325
  tail call void @llvm.dbg.value(metadata float %337, metadata !138, metadata !DIExpression()), !dbg !325
...
340:                                              ; preds = %336, %340
  ...
  %344 = phi float [ %372, %340 ], [ %338, %336 ]
  %345 = phi float [ %376, %340 ], [ %337, %336 ]
  ...
  tail call void @llvm.dbg.value(metadata float %344, metadata !137, metadata !DIExpression()), !dbg !325
  tail call void @llvm.dbg.value(metadata float %345, metadata !138, metadata !DIExpression()), !dbg !325
  %346 = trunc i64 %341 to i32, !dbg !347
  %347 = shl nsw i32 %346, 1, !dbg !347
  %348 = sext i32 %347 to i64, !dbg !347
  %349 = getelementptr inbounds float, ptr %6, i64 %348, !dbg !347
  %350 = load float, ptr %349, align 4, !dbg !347, !tbaa !209
  tail call void @llvm.dbg.value(metadata float %350, metadata !145, metadata !DIExpression()), !dbg !348
  %351 = or disjoint i32 %347, 1, !dbg !349
  %352 = sext i32 %351 to i64, !dbg !349
  %353 = getelementptr inbounds float, ptr %6, i64 %352, !dbg !349
  %354 = load float, ptr %353, align 4, !dbg !349, !tbaa !209
  tail call void @llvm.dbg.value(metadata float %354, metadata !149, metadata !DIExpression()), !dbg !348
  ...
  %362 = getelementptr inbounds float, ptr %5, i64 %361, !dbg !350
  %363 = load float, ptr %362, align 4, !dbg !350, !tbaa !209
  tail call void @llvm.dbg.value(metadata float %363, metadata !150, metadata !DIExpression()), !dbg !348
  %364 = or disjoint i32 %360, 1, !dbg !351
  %365 = sext i32 %364 to i64, !dbg !351
  %366 = getelementptr inbounds float, ptr %5, i64 %365, !dbg !351
  %367 = load float, ptr %366, align 4, !dbg !351, !tbaa !209
  %368 = fmul float %367, %288, !dbg !352
  tail call void @llvm.dbg.value(metadata float %368, metadata !151, metadata !DIExpression()), !dbg !348
  %369 = fmul float %350, %363, !dbg !353
  %370 = fmul float %354, %368, !dbg !354
  %371 = fsub float %369, %370, !dbg !355
  %372 = fadd float %344, %371, !dbg !356
  tail call void @llvm.dbg.value(metadata float %372, metadata !137, metadata !DIExpression()), !dbg !325
  %373 = fmul float %354, %363, !dbg !357
  %374 = fmul float %350, %368, !dbg !358
  %375 = fadd float %373, %374, !dbg !359
  %376 = fadd float %345, %375, !dbg !360
  tail call void @llvm.dbg.value(metadata float %376, metadata !138, metadata !DIExpression()), !dbg !325
...
381:                                              ; preds = %340, %336
  %382 = phi float [ %337, %336 ], [ %376, %340 ], !dbg !325
  %383 = phi float [ %338, %336 ], [ %372, %340 ], !dbg !325
  %384 = shl nsw i32 %298, 1, !dbg !365
  %385 = sext i32 %384 to i64, !dbg !365
  %386 = getelementptr inbounds float, ptr %6, i64 %385, !dbg !365
  store float %383, ptr %386, align 4, !dbg !366, !tbaa !209
  %387 = or disjoint i32 %384, 1, !dbg !367
  %388 = sext i32 %387 to i64, !dbg !367
  %389 = getelementptr inbounds float, ptr %6, i64 %388, !dbg !367
  store float %382, ptr %389, align 4, !dbg !368, !tbaa !209
...
406:                                              ; preds = %398, %492
  ...
  tail call void @llvm.dbg.value(metadata float poison, metadata !155, metadata !DIExpression()), !dbg !379
  tail call void @llvm.dbg.value(metadata float poison, metadata !159, metadata !DIExpression()), !dbg !379
...
413:                                              ; preds = %406
  ...
  %418 = getelementptr inbounds float, ptr %5, i64 %417, !dbg !381
  %419 = load float, ptr %418, align 4, !dbg !381, !tbaa !209
  %420 = fmul float %419, %403, !dbg !382
  tail call void @llvm.dbg.value(metadata float %420, metadata !159, metadata !DIExpression()), !dbg !379
  %421 = and i32 %415, -2, !dbg !378
  %422 = sext i32 %421 to i64, !dbg !378
  %423 = getelementptr inbounds float, ptr %5, i64 %422, !dbg !378
  %424 = load float, ptr %423, align 4, !dbg !378, !tbaa !209
  tail call void @llvm.dbg.value(metadata float %424, metadata !155, metadata !DIExpression()), !dbg !379
  %425 = trunc i64 %407 to i32, !dbg !383
  %426 = shl nsw i32 %425, 1, !dbg !383
  %427 = sext i32 %426 to i64, !dbg !383
  %428 = getelementptr inbounds float, ptr %6, i64 %427, !dbg !383
  %429 = load float, ptr %428, align 4, !dbg !383, !tbaa !209
  tail call void @llvm.dbg.value(metadata float %429, metadata !162, metadata !DIExpression()), !dbg !384
  %430 = or disjoint i32 %426, 1, !dbg !385
  %431 = sext i32 %430 to i64, !dbg !385
  %432 = getelementptr inbounds float, ptr %6, i64 %431, !dbg !385
  %433 = load float, ptr %432, align 4, !dbg !385, !tbaa !209
  tail call void @llvm.dbg.value(metadata float %433, metadata !165, metadata !DIExpression()), !dbg !384
  %434 = fmul float %424, %429, !dbg !386
  %435 = fmul float %420, %433, !dbg !387
  %436 = fsub float %434, %435, !dbg !388
  tail call void @llvm.dbg.value(metadata float %436, metadata !160, metadata !DIExpression()), !dbg !379
  %437 = fmul float %424, %433, !dbg !389
  %438 = fmul float %420, %429, !dbg !390
  %439 = fadd float %438, %437, !dbg !391
  tail call void @llvm.dbg.value(metadata float %439, metadata !161, metadata !DIExpression()), !dbg !379
...
440:                                              ; preds = %406
  ...
  %444 = getelementptr inbounds float, ptr %6, i64 %443, !dbg !393
  %445 = load float, ptr %444, align 4, !dbg !393, !tbaa !209
  tail call void @llvm.dbg.value(metadata float %445, metadata !160, metadata !DIExpression()), !dbg !379
  %446 = or disjoint i32 %442, 1, !dbg !395
  %447 = sext i32 %446 to i64, !dbg !395
  %448 = getelementptr inbounds float, ptr %6, i64 %447, !dbg !395
  %449 = load float, ptr %448, align 4, !dbg !395, !tbaa !209
  tail call void @llvm.dbg.value(metadata float %449, metadata !161, metadata !DIExpression()), !dbg !379
  br label %450

450:                                              ; preds = %440, %413
  %451 = phi float [ %436, %413 ], [ %445, %440 ], !dbg !396
  %452 = phi float [ %439, %413 ], [ %449, %440 ], !dbg !396
  ...
  tail call void @llvm.dbg.value(metadata float %452, metadata !161, metadata !DIExpression()), !dbg !379
  tail call void @llvm.dbg.value(metadata float %451, metadata !160, metadata !DIExpression()), !dbg !379
...
456:                                              ; preds = %454, %456
  ...
  %459 = phi float [ %452, %454 ], [ %489, %456 ]
  %460 = phi float [ %451, %454 ], [ %485, %456 ]
  ...
  tail call void @llvm.dbg.value(metadata float %459, metadata !161, metadata !DIExpression()), !dbg !379
  tail call void @llvm.dbg.value(metadata float %460, metadata !160, metadata !DIExpression()), !dbg !379
  %461 = trunc i64 %457 to i32, !dbg !400
  %462 = shl nsw i32 %461, 1, !dbg !400
  %463 = sext i32 %462 to i64, !dbg !400
  %464 = getelementptr inbounds float, ptr %6, i64 %463, !dbg !400
  %465 = load float, ptr %464, align 4, !dbg !400, !tbaa !209
  tail call void @llvm.dbg.value(metadata float %465, metadata !168, metadata !DIExpression()), !dbg !401
  %466 = or disjoint i32 %462, 1, !dbg !402
  %467 = sext i32 %466 to i64, !dbg !402
  %468 = getelementptr inbounds float, ptr %6, i64 %467, !dbg !402
  %469 = load float, ptr %468, align 4, !dbg !402, !tbaa !209
  tail call void @llvm.dbg.value(metadata float %469, metadata !172, metadata !DIExpression()), !dbg !401
  ...
  %475 = getelementptr inbounds float, ptr %5, i64 %474, !dbg !403
  %476 = load float, ptr %475, align 4, !dbg !403, !tbaa !209
  tail call void @llvm.dbg.value(metadata float %476, metadata !173, metadata !DIExpression()), !dbg !401
  %477 = or i32 %472, 1, !dbg !404
  %478 = sext i32 %477 to i64, !dbg !404
  %479 = getelementptr inbounds float, ptr %5, i64 %478, !dbg !404
  %480 = load float, ptr %479, align 4, !dbg !404, !tbaa !209
  %481 = fmul float %480, %403, !dbg !405
  tail call void @llvm.dbg.value(metadata float %481, metadata !174, metadata !DIExpression()), !dbg !401
  %482 = fmul float %465, %476, !dbg !406
  %483 = fmul float %469, %481, !dbg !407
  %484 = fsub float %482, %483, !dbg !408
  %485 = fadd float %460, %484, !dbg !409
  tail call void @llvm.dbg.value(metadata float %485, metadata !160, metadata !DIExpression()), !dbg !379
  %486 = fmul float %469, %476, !dbg !410
  %487 = fmul float %465, %481, !dbg !411
  %488 = fadd float %486, %487, !dbg !412
  %489 = fadd float %459, %488, !dbg !413
  tail call void @llvm.dbg.value(metadata float %489, metadata !161, metadata !DIExpression()), !dbg !379
...
492:                                              ; preds = %456, %450
  %493 = phi float [ %451, %450 ], [ %485, %456 ], !dbg !379
  %494 = phi float [ %452, %450 ], [ %489, %456 ], !dbg !379
  %495 = trunc i64 %407 to i32, !dbg !417
  %496 = shl nsw i32 %495, 1, !dbg !417
  %497 = sext i32 %496 to i64, !dbg !417
  %498 = getelementptr inbounds float, ptr %6, i64 %497, !dbg !417
  store float %493, ptr %498, align 4, !dbg !418, !tbaa !209
  %499 = or disjoint i32 %496, 1, !dbg !419
  %500 = sext i32 %499 to i64, !dbg !419
  %501 = getelementptr inbounds float, ptr %6, i64 %500, !dbg !419
  store float %494, ptr %501, align 4, !dbg !420, !tbaa !209
