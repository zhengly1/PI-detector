...
define dso_local i64 @cblas_icamax(i32 noundef %0, ptr nocapture noundef readonly %1, i32 noundef %2) local_unnamed_addr #0 !dbg !14 {
  ...
  %5 = icmp sgt i32 %0, 0
  %6 = and i1 %4, %5, !dbg !43
  br i1 %6, label %7, label %33, !dbg !43
...
10:                                               ; preds = %7, %10
  ...
  %12 = phi i64 [ 0, %7 ], [ %31, %10 ]
  %13 = phi i64 [ 0, %7 ], [ %29, %10 ]
  %14 = phi float [ 0.000000e+00, %7 ], [ %28, %10 ]
  ...
  %26 = fadd float %20, %25, !dbg !51
  tail call void @llvm.dbg.value(metadata float %26, metadata !35, metadata !DIExpression()), !dbg !54
  %27 = fcmp ogt float %26, %14, !dbg !55
  %28 = select i1 %27, float %26, float %14, !dbg !57
  %29 = select i1 %27, i64 %12, i64 %13, !dbg !57
  tail call void @llvm.dbg.value(metadata i64 %29, metadata !34, metadata !DIExpression()), !dbg !40
  tail call void @llvm.dbg.value(metadata float %28, metadata !28, metadata !DIExpression()), !dbg !40
  %30 = add nuw nsw i64 %11, %8, !dbg !58
  tail call void @llvm.dbg.value(metadata i64 %30, metadata !32, metadata !DIExpression()), !dbg !40
  %31 = add nuw nsw i64 %12, 1, !dbg !59
  tail call void @llvm.dbg.value(metadata i64 %31, metadata !33, metadata !DIExpression()), !dbg !40
  %32 = icmp eq i64 %31, %9, !dbg !45
  br i1 %32, label %33, label %10, !dbg !44, !llvm.loop !60

33:                                               ; preds = %10, %3
  %34 = phi i64 [ 0, %3 ], [ %29, %10 ], !dbg !40
  ret i64 %34, !dbg !63
}
...
!55 = !DILocation(line: 33, column: 11, scope: !56)
!56 = distinct !DILexicalBlock(scope: !36, file: !30, line: 33, column: 9)
