...
define dso_local void @cblas_xerbla(i32 noundef %0, ptr noundef %1, ptr nocapture noundef readonly %2, ...) local_unnamed_addr #0 !dbg !17 {
  ...
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %4) #7, !dbg !44
...
6:                                                ; preds = %3
  ...
  %8 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %7, ptr noundef nonnull @.str, i32 noundef %0, ptr noundef %1) #8, !dbg !55
  br label %9, !dbg !56

9:                                                ; preds = %6, %3
  %10 = load ptr, ptr @stderr, align 8, !dbg !57, !tbaa !51
  %11 = call i32 @vfprintf(ptr noundef %10, ptr noundef %2, ptr noundef nonnull %4) #8, !dbg !58
  call void @llvm.va_end(ptr nonnull %4), !dbg !59
  call void @abort() #9, !dbg !60
  unreachable, !dbg !60
}
