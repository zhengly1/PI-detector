...
84:                                               ; preds = %84, %82
  ...
  tail call void @llvm.dbg.value(metadata float %95, metadata !84, metadata !DIExpression()), !dbg !146
  ...
  %handler_result2 = call float @fSubHandlerFloat(float %100, float %101), !dbg !150
  ...
  %112 = fmul float %handler_result, %95, !dbg !152
  %113 = fmul float %handler_result1, %91, !dbg !153
  %114 = fpext float %113 to double, !dbg !154
  %115 = fpext float %112 to double, !dbg !154
  %116 = fptrunc double %114 to float, !dbg !154
  %117 = fptrunc double %115 to float, !dbg !154
  %handler_result4 = call float @fAddHandlerFloat(float %116, float %117), !dbg !154
...
154:                                              ; preds = %225, %137
  ...
  tail call void @llvm.dbg.value(metadata float %165, metadata !92, metadata !DIExpression()), !dbg !173
  ...
  %handler_result6 = call float @fSubHandlerFloat(float %170, float %171), !dbg !177
  ...
  %handler_result7 = call float @fAddHandlerFloat(float %176, float %177), !dbg !179
