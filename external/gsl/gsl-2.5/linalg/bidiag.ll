...
14:                                               ; preds = %3
  tail call void @gsl_error(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 79, i32 noundef 19) #5, !dbg !205
  br label %58, !dbg !205
...
18:                                               ; preds = %15
  tail call void @gsl_error(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, i32 noundef 83, i32 noundef 19) #5, !dbg !213
  br label %58, !dbg !213
...
30:                                               ; preds = %19
  tail call void @gsl_error(ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.1, i32 noundef 87, i32 noundef 19) #5, !dbg !223
  br label %58, !dbg !223

31:                                               ; preds = %25, %56
  %32 = phi i64 [ 0, %25 ], [ %35, %56 ]
  tail call void @llvm.dbg.value(metadata i64 %32, metadata !153, metadata !DIExpression()), !dbg !220
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %4) #5, !dbg !226
  call void @gsl_matrix_column(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_view) align 8 %4, ptr noundef nonnull %0, i64 noundef %32) #5, !dbg !227
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %5) #5, !dbg !228
  %33 = sub i64 %10, %32, !dbg !229
  call void @gsl_vector_subvector(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_view) align 8 %5, ptr noundef nonnull %4, i64 noundef %32, i64 noundef %33) #5, !dbg !230
  %34 = call double @gsl_linalg_householder_transform(ptr noundef nonnull %5) #5, !dbg !231
...
37:                                               ; preds = %31
  call void @llvm.lifetime.start.p0(i64 48, ptr nonnull %6) #5, !dbg !235
  %38 = sub i64 %12, %35, !dbg !236
  call void @gsl_matrix_submatrix(ptr dead_on_unwind nonnull writable sret(%struct._gsl_matrix_view) align 8 %6, ptr noundef nonnull %0, i64 noundef %32, i64 noundef %35, i64 noundef %33, i64 noundef %38) #5, !dbg !237
  %39 = call i32 @gsl_linalg_householder_hm(double noundef %34, ptr noundef nonnull %5, ptr noundef nonnull %6) #5, !dbg !238
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %6) #5, !dbg !239
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %5) #5, !dbg !258
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %4) #5, !dbg !258
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %7) #5, !dbg !259
  call void @gsl_matrix_row(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_view) align 8 %7, ptr noundef nonnull %0, i64 noundef %32) #5, !dbg !260
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %8) #5, !dbg !261
  call void @gsl_vector_subvector(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_view) align 8 %8, ptr noundef nonnull %7, i64 noundef %35, i64 noundef %38) #5, !dbg !262
  %44 = call double @gsl_linalg_householder_transform(ptr noundef nonnull %8) #5, !dbg !263
  tail call void @llvm.dbg.value(metadata double %44, metadata !178, metadata !DIExpression()), !dbg !188
  call void @llvm.lifetime.start.p0(i64 48, ptr nonnull %9) #5, !dbg !264
  %45 = sub i64 %10, %35, !dbg !265
  call void @gsl_matrix_submatrix(ptr dead_on_unwind nonnull writable sret(%struct._gsl_matrix_view) align 8 %9, ptr noundef nonnull %0, i64 noundef %35, i64 noundef %35, i64 noundef %45, i64 noundef %38) #5, !dbg !266
  %46 = call i32 @gsl_linalg_householder_mh(double noundef %44, ptr noundef nonnull %8, ptr noundef nonnull %9) #5, !dbg !267
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %9) #5, !dbg !268
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %8) #5, !dbg !276
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %7) #5, !dbg !276
  br label %56, !dbg !277
...
19:                                               ; preds = %7
  tail call void @gsl_error(ptr noundef nonnull @.str.4, ptr noundef nonnull @.str.1, i32 noundef 161, i32 noundef 19) #5, !dbg !382
...
23:                                               ; preds = %20
  tail call void @gsl_error(ptr noundef nonnull @.str.5, ptr noundef nonnull @.str.1, i32 noundef 165, i32 noundef 19) #5, !dbg !388
...
28:                                               ; preds = %24
  tail call void @gsl_error(ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.1, i32 noundef 169, i32 noundef 19) #5, !dbg !395
...
36:                                               ; preds = %29, %32
  tail call void @gsl_error(ptr noundef nonnull @.str.7, ptr noundef nonnull @.str.1, i32 noundef 173, i32 noundef 19) #5, !dbg !404
...
44:                                               ; preds = %37, %40
  tail call void @gsl_error(ptr noundef nonnull @.str.8, ptr noundef nonnull @.str.1, i32 noundef 177, i32 noundef 19) #5, !dbg !413
...
48:                                               ; preds = %45
  tail call void @gsl_error(ptr noundef nonnull @.str.9, ptr noundef nonnull @.str.1, i32 noundef 181, i32 noundef 19) #5, !dbg !419
...
68:                                               ; preds = %49
  tail call void @gsl_error(ptr noundef nonnull @.str.10, ptr noundef nonnull @.str.1, i32 noundef 185, i32 noundef 19) #5, !dbg !431
...
87:                                               ; preds = %84
  tail call void @gsl_matrix_set_identity(ptr noundef nonnull %4) #5, !dbg !456
  ...
  tail call void @gsl_matrix_set_identity(ptr noundef nonnull %2) #5, !dbg !457
...
187:                                              ; preds = %184, %187
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %8) #5, !dbg !477
  call void @gsl_matrix_const_row(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_const_view) align 8 %8, ptr noundef nonnull %0, i64 noundef %189) #5, !dbg !478
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %9) #5, !dbg !479
  %190 = sub i64 %16, %188, !dbg !480
  call void @gsl_vector_const_subvector(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_const_view) align 8 %9, ptr noundef nonnull %8, i64 noundef %188, i64 noundef %190) #5, !dbg !481
  ...
  call void @llvm.lifetime.start.p0(i64 48, ptr nonnull %10) #5, !dbg !494
  call void @gsl_matrix_submatrix(ptr dead_on_unwind nonnull writable sret(%struct._gsl_matrix_view) align 8 %10, ptr noundef nonnull %4, i64 noundef %188, i64 noundef %188, i64 noundef %190, i64 noundef %190) #5, !dbg !495
  %196 = call i32 @gsl_linalg_householder_hm(double noundef %195, ptr noundef nonnull %9, ptr noundef nonnull %10) #5, !dbg !496
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %10) #5, !dbg !497
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %9) #5, !dbg !497
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %8) #5, !dbg !497
...
198:                                              ; preds = %187
  call void @gsl_matrix_set_identity(ptr noundef nonnull %2) #5, !dbg !457
  tail call void @llvm.dbg.value(metadata i64 %16, metadata !340, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)), !dbg !426
...
202:                                              ; preds = %199, %202
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %11) #5, !dbg !502
  call void @gsl_matrix_const_column(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_const_view) align 8 %11, ptr noundef nonnull %0, i64 noundef %204) #5, !dbg !503
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %12) #5, !dbg !504
  %205 = sub i64 %14, %204, !dbg !505
  call void @gsl_vector_const_subvector(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_const_view) align 8 %12, ptr noundef nonnull %11, i64 noundef %204, i64 noundef %205) #5, !dbg !506
  ...
  call void @llvm.lifetime.start.p0(i64 48, ptr nonnull %13) #5, !dbg !513
  %211 = sub i64 %16, %204, !dbg !514
  call void @gsl_matrix_submatrix(ptr dead_on_unwind nonnull writable sret(%struct._gsl_matrix_view) align 8 %13, ptr noundef nonnull %2, i64 noundef %204, i64 noundef %204, i64 noundef %205, i64 noundef %211) #5, !dbg !515
  %212 = call i32 @gsl_linalg_householder_hm(double noundef %210, ptr noundef nonnull %12, ptr noundef nonnull %13) #5, !dbg !516
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %13) #5, !dbg !517
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %12) #5, !dbg !517
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %11) #5, !dbg !517
...
14:                                               ; preds = %4
  tail call void @gsl_error(ptr noundef nonnull @.str.4, ptr noundef nonnull @.str.1, i32 noundef 260, i32 noundef 19) #5, !dbg !579
...
18:                                               ; preds = %15
  tail call void @gsl_error(ptr noundef nonnull @.str.5, ptr noundef nonnull @.str.1, i32 noundef 264, i32 noundef 19) #5, !dbg !585
...
23:                                               ; preds = %19
  tail call void @gsl_error(ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.1, i32 noundef 268, i32 noundef 19) #5, !dbg !592
...
31:                                               ; preds = %24, %27
  tail call void @gsl_error(ptr noundef nonnull @.str.8, ptr noundef nonnull @.str.1, i32 noundef 272, i32 noundef 19) #5, !dbg !601
  br label %141, !dbg !601

32:                                               ; preds = %27
  tail call void @gsl_matrix_set_identity(ptr noundef nonnull %3) #5, !dbg !604
...
53:                                               ; preds = %35, %53
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %5) #5, !dbg !611
  call void @gsl_matrix_const_row(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_const_view) align 8 %5, ptr noundef nonnull %0, i64 noundef %55) #5, !dbg !612
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %6) #5, !dbg !613
  %56 = sub i64 %11, %54, !dbg !614
  call void @gsl_vector_const_subvector(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_const_view) align 8 %6, ptr noundef nonnull %5, i64 noundef %54, i64 noundef %56) #5, !dbg !615
  ...
  call void @llvm.lifetime.start.p0(i64 48, ptr nonnull %7) #5, !dbg !622
  call void @gsl_matrix_submatrix(ptr dead_on_unwind nonnull writable sret(%struct._gsl_matrix_view) align 8 %7, ptr noundef nonnull %3, i64 noundef %54, i64 noundef %54, i64 noundef %56, i64 noundef %56) #5, !dbg !623
  %62 = call i32 @gsl_linalg_householder_hm(double noundef %61, ptr noundef nonnull %6, ptr noundef nonnull %7) #5, !dbg !624
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %7) #5, !dbg !625
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %6) #5, !dbg !625
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %5) #5, !dbg !625
...
119:                                              ; preds = %81, %119
  ...
  call void @llvm.lifetime.start.p0(i64 48, ptr nonnull %8) #5, !dbg !657
  %133 = sub i64 %9, %121, !dbg !658
  %134 = sub i64 %11, %121, !dbg !659
  call void @gsl_matrix_submatrix(ptr dead_on_unwind nonnull writable sret(%struct._gsl_matrix_view) align 8 %8, ptr noundef nonnull %0, i64 noundef %121, i64 noundef %121, i64 noundef %133, i64 noundef %134) #5, !dbg !660
  ...
  %139 = call i32 @gsl_linalg_householder_hm1(double noundef %126, ptr noundef nonnull %8) #5, !dbg !668
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %8) #5, !dbg !669
...
10:                                               ; preds = %3
  tail call void @gsl_error(ptr noundef nonnull @.str.9, ptr noundef nonnull @.str.1, i32 noundef 336, i32 noundef 19) #5, !dbg !706
...
30:                                               ; preds = %11
  tail call void @gsl_error(ptr noundef nonnull @.str.11, ptr noundef nonnull @.str.1, i32 noundef 340, i32 noundef 19) #5, !dbg !716
