...
14:                                               ; preds = %3
  tail call void @gsl_error(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 80, i32 noundef 20) #5, !dbg !181
  br label %73, !dbg !181

15:                                               ; preds = %3
  call void @llvm.lifetime.start.p0(i64 48, ptr nonnull %4) #5, !dbg !184
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %5) #5, !dbg !185
...
46:                                               ; preds = %37, %35
  ...
  call void @llvm.lifetime.start.p0(i64 48, ptr nonnull %6) #5, !dbg !218
  call void @gsl_matrix_submatrix(ptr dead_on_unwind nonnull writable sret(%struct._gsl_matrix_view) align 8 %6, ptr noundef nonnull %2, i64 noundef 0, i64 noundef 0, i64 noundef %36, i64 noundef %36) #5, !dbg !218
  ...
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %6) #5, !dbg !218
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %7) #5, !dbg !226
  call void @gsl_matrix_subcolumn(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_view) align 8 %7, ptr noundef nonnull %2, i64 noundef %36, i64 noundef 0, i64 noundef %36) #5, !dbg !226
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %7) #5, !dbg !226
  %48 = call i32 @gsl_blas_dtrmv(i32 noundef 121, i32 noundef 111, i32 noundef %1, ptr noundef nonnull %4, ptr noundef nonnull %5) #5, !dbg !229
  call void @gsl_blas_dscal(double noundef %47, ptr noundef nonnull %5) #5, !dbg !230
...
67:                                               ; preds = %64
  call void @llvm.lifetime.start.p0(i64 48, ptr nonnull %8) #5, !dbg !256
  call void @gsl_matrix_submatrix(ptr dead_on_unwind nonnull writable sret(%struct._gsl_matrix_view) align 8 %8, ptr noundef nonnull %2, i64 noundef %53, i64 noundef %53, i64 noundef %52, i64 noundef %52) #5, !dbg !256
  ...
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %8) #5, !dbg !256
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %9) #5, !dbg !259
  call void @gsl_matrix_subcolumn(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_view) align 8 %9, ptr noundef nonnull %2, i64 noundef %54, i64 noundef %53, i64 noundef %52) #5, !dbg !259
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %9) #5, !dbg !259
  %68 = call i32 @gsl_blas_dtrmv(i32 noundef 122, i32 noundef 111, i32 noundef %1, ptr noundef nonnull %4, ptr noundef nonnull %5) #5, !dbg !261
  call void @gsl_blas_dscal(double noundef %65, ptr noundef nonnull %5) #5, !dbg !262
  br label %69, !dbg !263
...
72:                                               ; preds = %69, %46, %33, %24, %18
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %5) #5, !dbg !268
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %4) #5, !dbg !268
  br label %73
