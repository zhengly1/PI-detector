...
8:                                                ; preds = %2
  tail call void @gsl_error(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 44, i32 noundef 4) #5, !dbg !132
  br label %56, !dbg !132

9:                                                ; preds = %2
  tail call void @gsl_vector_set_all(ptr noundef nonnull %1, double noundef 1.000000e+00) #5, !dbg !135
...
14:                                               ; preds = %11, %53
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %3) #5, !dbg !138
  call void @gsl_matrix_column(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_view) align 8 %3, ptr noundef %0, i64 noundef %15) #5, !dbg !139
  %16 = call double @gsl_blas_dasum(ptr noundef nonnull %3) #5, !dbg !140
...
18:                                               ; preds = %14
  %19 = call i32 @gsl_finite(double noundef %16) #5, !dbg !144
...
51:                                               ; preds = %44
  ...
  call void @gsl_blas_dscal(double noundef %52, ptr noundef nonnull %3) #5, !dbg !193
  br label %53, !dbg !194

53:                                               ; preds = %44, %51, %23
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %3) #5, !dbg !195
