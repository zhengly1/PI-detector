...
16:                                               ; preds = %2
  tail call void @gsl_error(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 74, i32 noundef 20) #7, !dbg !149
  br label %48, !dbg !149
...
20:                                               ; preds = %17
  tail call void @gsl_error(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, i32 noundef 78, i32 noundef 19) #7, !dbg !157
  br label %48, !dbg !157
...
23:                                               ; preds = %21
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %3) #7, !dbg !162
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %4) #7, !dbg !162
  call void @llvm.lifetime.start.p0(i64 48, ptr nonnull %5) #7, !dbg !163
...
27:                                               ; preds = %23, %27
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %6) #7, !dbg !166
  %29 = add nuw i64 %28, 1, !dbg !169
  %30 = sub i64 %12, %28, !dbg !170
  %31 = add i64 %30, -1, !dbg !171
  call void @gsl_matrix_subcolumn(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_view) align 8 %6, ptr noundef nonnull %0, i64 noundef %28, i64 noundef %29, i64 noundef %31) #7, !dbg !166
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %6) #7, !dbg !166
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %7) #7, !dbg !177
  %32 = sub i64 %12, %29, !dbg !178
  call void @gsl_vector_subvector(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_view) align 8 %7, ptr noundef nonnull %1, i64 noundef %29, i64 noundef %32) #7, !dbg !177
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %7) #7, !dbg !177
  %33 = call i32 @gsl_vector_memcpy(ptr noundef nonnull %4, ptr noundef nonnull %3) #7, !dbg !180
  %34 = call double @gsl_linalg_householder_transform(ptr noundef nonnull %4) #7, !dbg !181
  tail call void @llvm.dbg.value(metadata double %34, metadata !131, metadata !DIExpression()), !dbg !133
  call void @llvm.lifetime.start.p0(i64 48, ptr nonnull %8) #7, !dbg !182
  call void @gsl_matrix_submatrix(ptr dead_on_unwind nonnull writable sret(%struct._gsl_matrix_view) align 8 %8, ptr noundef nonnull %0, i64 noundef %29, i64 noundef %28, i64 noundef %32, i64 noundef %30) #7, !dbg !182
  ...
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %8) #7, !dbg !182
  %35 = call i32 @gsl_linalg_householder_hm(double noundef %34, ptr noundef nonnull %4, ptr noundef nonnull %5) #7, !dbg !185
  call void @llvm.lifetime.start.p0(i64 48, ptr nonnull %9) #7, !dbg !186
  call void @gsl_matrix_submatrix(ptr dead_on_unwind nonnull writable sret(%struct._gsl_matrix_view) align 8 %9, ptr noundef nonnull %0, i64 noundef 0, i64 noundef %29, i64 noundef %12, i64 noundef %32) #7, !dbg !186
  ...
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %9) #7, !dbg !186
  %36 = call i32 @gsl_linalg_householder_mh(double noundef %34, ptr noundef nonnull %4, ptr noundef nonnull %5) #7, !dbg !188
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %10) #7, !dbg !207
  %41 = load i64, ptr %3, align 8, !dbg !208, !tbaa !209
  %42 = add i64 %41, -1, !dbg !211
  call void @gsl_vector_subvector(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_view) align 8 %10, ptr noundef nonnull %3, i64 noundef 1, i64 noundef %42) #7, !dbg !207
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %10) #7, !dbg !207
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %11) #7, !dbg !213
  %43 = load i64, ptr %4, align 8, !dbg !214, !tbaa !209
  %44 = add i64 %43, -1, !dbg !215
  call void @gsl_vector_subvector(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_view) align 8 %11, ptr noundef nonnull %4, i64 noundef 1, i64 noundef %44) #7, !dbg !213
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %11) #7, !dbg !213
  %45 = call i32 @gsl_vector_memcpy(ptr noundef nonnull %3, ptr noundef nonnull %4) #7, !dbg !217
...
47:                                               ; preds = %27
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %5) #7, !dbg !222
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %4) #7, !dbg !222
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %3) #7, !dbg !222
  br label %48

48:                                               ; preds = %21, %47, %20, %16
...
define dso_local noundef i32 @gsl_linalg_hessenberg_unpack(ptr noundef %0, ptr nocapture noundef readonly %1, ptr noundef %2) local_unnamed_addr #0 !dbg !252 {
  ...
  tail call void @gsl_matrix_set_identity(ptr noundef %2) #7, !dbg !261
...
14:                                               ; preds = %3
  tail call void @gsl_error(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 215, i32 noundef 20) #7, !dbg !292
  br label %43, !dbg !292
...
18:                                               ; preds = %15
  tail call void @gsl_error(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, i32 noundef 219, i32 noundef 19) #7, !dbg !298
  br label %43, !dbg !298
...
23:                                               ; preds = %19
  tail call void @gsl_error(ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.1, i32 noundef 223, i32 noundef 19) #7, !dbg !304
  br label %43, !dbg !304

24:                                               ; preds = %19
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %4) #7, !dbg !307
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %5) #7, !dbg !307
  call void @llvm.lifetime.start.p0(i64 48, ptr nonnull %6) #7, !dbg !308
...
30:                                               ; preds = %26, %30
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %7) #7, !dbg !314
  call void @gsl_matrix_column(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_view) align 8 %7, ptr noundef nonnull %0, i64 noundef %31) #7, !dbg !314
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %7) #7, !dbg !314
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %8) #7, !dbg !330
  %37 = add nuw i64 %31, 1, !dbg !331
  %38 = sub i64 %10, %37, !dbg !332
  call void @gsl_vector_subvector(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_view) align 8 %8, ptr noundef nonnull %4, i64 noundef %37, i64 noundef %38) #7, !dbg !330
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %8) #7, !dbg !330
  call void @llvm.lifetime.start.p0(i64 48, ptr nonnull %9) #7, !dbg !334
  %39 = load i64, ptr %2, align 8, !dbg !335, !tbaa !138
  call void @gsl_matrix_submatrix(ptr dead_on_unwind nonnull writable sret(%struct._gsl_matrix_view) align 8 %9, ptr noundef nonnull %2, i64 noundef 0, i64 noundef %37, i64 noundef %39, i64 noundef %38) #7, !dbg !334
  ...
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %9) #7, !dbg !334
  %40 = call i32 @gsl_linalg_householder_mh(double noundef %36, ptr noundef nonnull %5, ptr noundef nonnull %6) #7, !dbg !337
...
42:                                               ; preds = %30, %24
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %6) #7, !dbg !341
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %5) #7, !dbg !341
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %4) #7, !dbg !341
  br label %43
...
19:                                               ; preds = %4
  tail call void @gsl_error(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 360, i32 noundef 20) #7, !dbg !422
  br label %55, !dbg !422
...
23:                                               ; preds = %20
  tail call void @gsl_error(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, i32 noundef 364, i32 noundef 19) #7, !dbg !428
  br label %55, !dbg !428
...
26:                                               ; preds = %24
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %5) #7, !dbg !433
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %6) #7, !dbg !433
  call void @llvm.lifetime.start.p0(i64 48, ptr nonnull %7) #7, !dbg !434
...
31:                                               ; preds = %26, %31
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %8) #7, !dbg !437
  %33 = add nuw i64 %32, 1, !dbg !440
  %34 = xor i64 %32, -1, !dbg !441
  %35 = add i64 %14, %34, !dbg !441
  call void @gsl_matrix_subcolumn(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_view) align 8 %8, ptr noundef nonnull %1, i64 noundef %32, i64 noundef %33, i64 noundef %35) #7, !dbg !437
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %8) #7, !dbg !437
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %9) #7, !dbg !443
  %36 = sub i64 %14, %33, !dbg !444
  call void @gsl_vector_subvector(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_view) align 8 %9, ptr noundef nonnull %3, i64 noundef %33, i64 noundef %36) #7, !dbg !443
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %9) #7, !dbg !443
  %37 = call i32 @gsl_vector_memcpy(ptr noundef nonnull %6, ptr noundef nonnull %5) #7, !dbg !446
  %38 = call double @gsl_linalg_householder_transform(ptr noundef nonnull %6) #7, !dbg !447
  tail call void @llvm.dbg.value(metadata double %38, metadata !411, metadata !DIExpression()), !dbg !413
  call void @llvm.lifetime.start.p0(i64 48, ptr nonnull %10) #7, !dbg !448
  %39 = add i64 %32, %2, !dbg !449
  %40 = add i64 %39, 1, !dbg !450
  %41 = sub i64 %15, %39, !dbg !451
  call void @gsl_matrix_submatrix(ptr dead_on_unwind nonnull writable sret(%struct._gsl_matrix_view) align 8 %10, ptr noundef nonnull %0, i64 noundef %40, i64 noundef %39, i64 noundef %36, i64 noundef %41) #7, !dbg !448
  ...
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %10) #7, !dbg !448
  %42 = call i32 @gsl_linalg_householder_hm(double noundef %38, ptr noundef nonnull %6, ptr noundef nonnull %7) #7, !dbg !453
  call void @llvm.lifetime.start.p0(i64 48, ptr nonnull %11) #7, !dbg !454
  call void @gsl_matrix_submatrix(ptr dead_on_unwind nonnull writable sret(%struct._gsl_matrix_view) align 8 %11, ptr noundef nonnull %0, i64 noundef 0, i64 noundef %40, i64 noundef %27, i64 noundef %36) #7, !dbg !454
  ...
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %11) #7, !dbg !454
  %43 = call i32 @gsl_linalg_householder_mh(double noundef %38, ptr noundef nonnull %6, ptr noundef nonnull %7) #7, !dbg !456
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %12) #7, !dbg !464
  %48 = load i64, ptr %5, align 8, !dbg !465, !tbaa !209
  %49 = add i64 %48, -1, !dbg !466
  call void @gsl_vector_subvector(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_view) align 8 %12, ptr noundef nonnull %5, i64 noundef 1, i64 noundef %49) #7, !dbg !464
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %12) #7, !dbg !464
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %13) #7, !dbg !468
  %50 = load i64, ptr %6, align 8, !dbg !469, !tbaa !209
  %51 = add i64 %50, -1, !dbg !470
  call void @gsl_vector_subvector(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_view) align 8 %13, ptr noundef nonnull %6, i64 noundef 1, i64 noundef %51) #7, !dbg !468
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %13) #7, !dbg !468
  %52 = call i32 @gsl_vector_memcpy(ptr noundef nonnull %5, ptr noundef nonnull %6) #7, !dbg !472
...
54:                                               ; preds = %31
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %7) #7, !dbg !476
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %6) #7, !dbg !476
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %5) #7, !dbg !476
  br label %55

55:                                               ; preds = %24, %54, %23, %19
