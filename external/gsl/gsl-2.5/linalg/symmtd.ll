...
12:                                               ; preds = %2
  tail call void @gsl_error(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 69, i32 noundef 20) #5, !dbg !180
  br label %49, !dbg !180
...
24:                                               ; preds = %13
  tail call void @gsl_error(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, i32 noundef 73, i32 noundef 19) #5, !dbg !192
  br label %49, !dbg !192

25:                                               ; preds = %20, %43
  %26 = phi i64 [ 0, %20 ], [ %27, %43 ]
  tail call void @llvm.dbg.value(metadata i64 %26, metadata !134, metadata !DIExpression()), !dbg !189
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %3) #5, !dbg !195
  call void @gsl_matrix_column(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_view) align 8 %3, ptr noundef nonnull %0, i64 noundef %26) #5, !dbg !196
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %4) #5, !dbg !197
  %27 = add nuw i64 %26, 1, !dbg !198
  %28 = sub i64 %8, %27, !dbg !199
  call void @gsl_vector_subvector(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_view) align 8 %4, ptr noundef nonnull %3, i64 noundef %27, i64 noundef %28) #5, !dbg !200
  %29 = call double @gsl_linalg_householder_transform(ptr noundef nonnull %4) #5, !dbg !201
...
31:                                               ; preds = %25
  call void @llvm.lifetime.start.p0(i64 48, ptr nonnull %5) #5, !dbg !204
  call void @gsl_matrix_submatrix(ptr dead_on_unwind nonnull writable sret(%struct._gsl_matrix_view) align 8 %5, ptr noundef nonnull %0, i64 noundef %27, i64 noundef %27, i64 noundef %28, i64 noundef %28) #5, !dbg !205
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %6) #5, !dbg !221
  call void @gsl_vector_subvector(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_view) align 8 %6, ptr noundef nonnull %1, i64 noundef %26, i64 noundef %28) #5, !dbg !222
  ...
  %35 = call i32 @gsl_blas_dsymv(i32 noundef 122, double noundef %29, ptr noundef nonnull %5, ptr noundef nonnull %4, double noundef 0.000000e+00, ptr noundef nonnull %6) #5, !dbg !234
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %7) #5, !dbg !235
  %36 = call i32 @gsl_blas_ddot(ptr noundef nonnull %6, ptr noundef nonnull %4, ptr noundef nonnull %7) #5, !dbg !236
  ...
  %40 = call i32 @gsl_blas_daxpy(double noundef %39, ptr noundef nonnull %4, ptr noundef nonnull %6) #5, !dbg !240
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %7) #5, !dbg !241
  %41 = call i32 @gsl_blas_dsyr2(i32 noundef 122, double noundef -1.000000e+00, ptr noundef nonnull %4, ptr noundef nonnull %6, ptr noundef nonnull %5) #5, !dbg !242
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %6) #5, !dbg !247
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %5) #5, !dbg !247
  br label %43, !dbg !248
...
43:                                               ; preds = %31, %25
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %4) #5, !dbg !257
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %3) #5, !dbg !257
...
13:                                               ; preds = %5
  tail call void @gsl_error(ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.1, i32 noundef 132, i32 noundef 20) #5, !dbg !345
...
18:                                               ; preds = %14
  tail call void @gsl_error(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, i32 noundef 136, i32 noundef 19) #5, !dbg !352
...
26:                                               ; preds = %19, %22
  tail call void @gsl_error(ptr noundef nonnull @.str.4, ptr noundef nonnull @.str.1, i32 noundef 140, i32 noundef 19) #5, !dbg !361
...
30:                                               ; preds = %27
  tail call void @gsl_error(ptr noundef nonnull @.str.5, ptr noundef nonnull @.str.1, i32 noundef 144, i32 noundef 19) #5, !dbg !367
...
35:                                               ; preds = %31
  tail call void @gsl_error(ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.1, i32 noundef 148, i32 noundef 19) #5, !dbg !374
  br label %182, !dbg !374

36:                                               ; preds = %31
  tail call void @llvm.dbg.value(metadata i64 %9, metadata !307, metadata !DIExpression()), !dbg !377
  tail call void @gsl_matrix_set_identity(ptr noundef nonnull %2) #5, !dbg !378
...
58:                                               ; preds = %39, %58
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %6) #5, !dbg !387
  call void @gsl_matrix_const_column(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_const_view) align 8 %6, ptr noundef nonnull %0, i64 noundef %60) #5, !dbg !388
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %7) #5, !dbg !389
  %61 = sub i64 %9, %59, !dbg !390
  call void @gsl_vector_const_subvector(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_const_view) align 8 %7, ptr noundef nonnull %6, i64 noundef %59, i64 noundef %61) #5, !dbg !391
  ...
  call void @llvm.lifetime.start.p0(i64 48, ptr nonnull %8) #5, !dbg !398
  call void @gsl_matrix_submatrix(ptr dead_on_unwind nonnull writable sret(%struct._gsl_matrix_view) align 8 %8, ptr noundef nonnull %2, i64 noundef %59, i64 noundef %59, i64 noundef %61, i64 noundef %61) #5, !dbg !399
  %67 = call i32 @gsl_linalg_householder_hm(double noundef %66, ptr noundef nonnull %7, ptr noundef nonnull %8) #5, !dbg !400
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %8) #5, !dbg !401
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %7) #5, !dbg !401
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %6) #5, !dbg !401
...
182:                                              ; preds = %167, %170, %84, %13, %18, %26, %30, %35
...
8:                                                ; preds = %3
  tail call void @gsl_error(ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.1, i32 noundef 198, i32 noundef 20) #5, !dbg !482
...
12:                                               ; preds = %9
  tail call void @gsl_error(ptr noundef nonnull @.str.5, ptr noundef nonnull @.str.1, i32 noundef 202, i32 noundef 19) #5, !dbg !488
...
32:                                               ; preds = %13
  tail call void @gsl_error(ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.1, i32 noundef 206, i32 noundef 19) #5, !dbg !498
