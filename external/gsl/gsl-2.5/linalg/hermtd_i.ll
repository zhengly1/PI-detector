...
12:                                               ; preds = %2
  tail call void @gsl_error(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 66, i32 noundef 20) #4, !dbg !195
  br label %67, !dbg !195
...
25:                                               ; preds = %13
  tail call void @gsl_error(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, i32 noundef 70, i32 noundef 19) #4, !dbg !207
  br label %67, !dbg !207

26:                                               ; preds = %59, %20
  %27 = phi i64 [ 0, %20 ], [ %28, %59 ]
  tail call void @llvm.dbg.value(metadata i64 %27, metadata !144, metadata !DIExpression()), !dbg !204
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %3) #4, !dbg !210
  call void @gsl_matrix_complex_column(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_complex_view) align 8 %3, ptr noundef nonnull %0, i64 noundef %27) #4, !dbg !211
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %4) #4, !dbg !212
  %28 = add nuw i64 %27, 1, !dbg !213
  %29 = sub i64 %8, %28, !dbg !214
  call void @gsl_vector_complex_subvector(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_complex_view) align 8 %4, ptr noundef nonnull %3, i64 noundef %28, i64 noundef %29) #4, !dbg !215
  %30 = call { double, double } @gsl_linalg_complex_householder_transform(ptr noundef nonnull %4) #4, !dbg !216
...
38:                                               ; preds = %34
  call void @llvm.lifetime.start.p0(i64 48, ptr nonnull %5) #4, !dbg !221
  call void @gsl_matrix_complex_submatrix(ptr dead_on_unwind nonnull writable sret(%struct._gsl_matrix_complex_view) align 8 %5, ptr noundef nonnull %0, i64 noundef %28, i64 noundef %28, i64 noundef %29, i64 noundef %29) #4, !dbg !222
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %6) #4, !dbg !239
  call void @gsl_vector_complex_subvector(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_complex_view) align 8 %6, ptr noundef nonnull %1, i64 noundef %27, i64 noundef %29) #4, !dbg !240
  ...
  %45 = call i32 @gsl_blas_zhemv(i32 noundef 122, double %31, double %32, ptr noundef nonnull %5, ptr noundef nonnull %4, double 0.000000e+00, double 0.000000e+00, ptr noundef nonnull %6) #4, !dbg !252
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %7) #4, !dbg !253
  %46 = call i32 @gsl_blas_zdotc(ptr noundef nonnull %6, ptr noundef nonnull %4, ptr noundef nonnull %7) #4, !dbg !254
  %47 = load double, ptr %7, align 8, !dbg !255
  %48 = load double, ptr %22, align 8, !dbg !255
  %49 = call { double, double } @gsl_complex_mul(double %31, double %32, double %47, double %48) #4, !dbg !255
  ...
  %52 = call { double, double } @gsl_complex_mul_real(double %50, double %51, double noundef -5.000000e-01) #4, !dbg !256
  ...
  %55 = call i32 @gsl_blas_zaxpy(double %53, double %54, ptr noundef nonnull %4, ptr noundef nonnull %6) #4, !dbg !257
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %7) #4, !dbg !258
  %56 = call i32 @gsl_blas_zher2(i32 noundef 122, double -1.000000e+00, double 0.000000e+00, ptr noundef nonnull %4, ptr noundef nonnull %6, ptr noundef nonnull %5) #4, !dbg !259
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %6) #4, !dbg !264
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %5) #4, !dbg !264
  br label %59, !dbg !265
...
59:                                               ; preds = %38, %34, %26
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %4) #4, !dbg !271
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %3) #4, !dbg !271
...
13:                                               ; preds = %5
  tail call void @gsl_error(ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.1, i32 noundef 136, i32 noundef 20) #4, !dbg !383
...
18:                                               ; preds = %14
  tail call void @gsl_error(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, i32 noundef 140, i32 noundef 19) #4, !dbg !390
...
26:                                               ; preds = %22, %19
  tail call void @gsl_error(ptr noundef nonnull @.str.4, ptr noundef nonnull @.str.1, i32 noundef 144, i32 noundef 19) #4, !dbg !399
...
30:                                               ; preds = %27
  tail call void @gsl_error(ptr noundef nonnull @.str.5, ptr noundef nonnull @.str.1, i32 noundef 148, i32 noundef 19) #4, !dbg !405
...
35:                                               ; preds = %31
  tail call void @gsl_error(ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.1, i32 noundef 152, i32 noundef 19) #4, !dbg !412
  br label %148, !dbg !412

36:                                               ; preds = %31
  tail call void @llvm.dbg.value(metadata i64 %9, metadata !345, metadata !DIExpression()), !dbg !415
  tail call void @gsl_matrix_complex_set_identity(ptr noundef nonnull %2) #4, !dbg !416
...
58:                                               ; preds = %58, %39
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %6) #4, !dbg !429
  call void @gsl_matrix_complex_const_column(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_complex_const_view) align 8 %6, ptr noundef nonnull %0, i64 noundef %60) #4, !dbg !430
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %7) #4, !dbg !431
  %69 = sub i64 %9, %59, !dbg !432
  call void @gsl_vector_complex_const_subvector(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_complex_const_view) align 8 %7, ptr noundef nonnull %6, i64 noundef %59, i64 noundef %69) #4, !dbg !433
  call void @llvm.lifetime.start.p0(i64 48, ptr nonnull %8) #4, !dbg !434
  call void @gsl_matrix_complex_submatrix(ptr dead_on_unwind nonnull writable sret(%struct._gsl_matrix_complex_view) align 8 %8, ptr noundef nonnull %2, i64 noundef %59, i64 noundef %59, i64 noundef %69, i64 noundef %69) #4, !dbg !435
  %70 = call i32 @gsl_linalg_complex_householder_hm(double %66, double %68, ptr noundef nonnull %7, ptr noundef nonnull %8) #4, !dbg !436
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %8) #4, !dbg !437
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %7) #4, !dbg !437
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %6) #4, !dbg !437
...
148:                                              ; preds = %139, %136, %82, %35, %30, %26, %18, %13
...
8:                                                ; preds = %3
  tail call void @gsl_error(ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.1, i32 noundef 206, i32 noundef 20) #4, !dbg !528
...
12:                                               ; preds = %9
  tail call void @gsl_error(ptr noundef nonnull @.str.5, ptr noundef nonnull @.str.1, i32 noundef 210, i32 noundef 19) #4, !dbg !534
...
33:                                               ; preds = %13
  tail call void @gsl_error(ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.1, i32 noundef 214, i32 noundef 19) #4, !dbg !544
