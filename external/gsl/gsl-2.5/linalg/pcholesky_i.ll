...
13:                                               ; preds = %3
  tail call void @gsl_error(ptr noundef nonnull @.str.12, ptr noundef nonnull @.str.1, i32 noundef 78, i32 noundef 20) #6, !dbg !246
...
17:                                               ; preds = %14
  tail call void @gsl_error(ptr noundef nonnull @.str.13, ptr noundef nonnull @.str.1, i32 noundef 82, i32 noundef 19) #6, !dbg !254
  br label %178, !dbg !254

18:                                               ; preds = %14
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %4) #6, !dbg !257
  call void @gsl_matrix_diagonal(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_view) align 8 %4, ptr noundef nonnull %1) #6, !dbg !258
  %19 = icmp eq i32 %0, 0, !dbg !259
  br i1 %19, label %22, label %20, !dbg !261

20:                                               ; preds = %18
  %21 = call i32 @gsl_matrix_transpose_tricpy(i8 noundef signext 76, i32 noundef 0, ptr noundef nonnull %1, ptr noundef nonnull %1) #6, !dbg !262
  br label %22, !dbg !264

22:                                               ; preds = %20, %18
  call void @gsl_permutation_init(ptr noundef nonnull %2) #6, !dbg !265
...
28:                                               ; preds = %174, %24
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %5) #6, !dbg !268
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %6) #6, !dbg !269
  %30 = sub i64 %9, %29, !dbg !270
  call void @gsl_vector_subvector(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_view) align 8 %6, ptr noundef nonnull %4, i64 noundef %29, i64 noundef %30) #6, !dbg !269
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %6) #6, !dbg !269
  %31 = call i64 @gsl_vector_max_index(ptr noundef nonnull %5) #6, !dbg !276
  %32 = add i64 %31, %29, !dbg !277
  tail call void @llvm.dbg.value(metadata i64 %32, metadata !214, metadata !DIExpression()), !dbg !229
  %33 = call i32 @gsl_permutation_swap(ptr noundef nonnull %2, i64 noundef %29, i64 noundef %32) #6, !dbg !278
...
161:                                              ; preds = %157
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %7) #6, !dbg !408
  %169 = add nuw i64 %29, 1, !dbg !409
  %170 = add i64 %30, -1, !dbg !410
  call void @gsl_matrix_subcolumn(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_view) align 8 %7, ptr noundef nonnull %1, i64 noundef %29, i64 noundef %169, i64 noundef %170) #6, !dbg !411
  call void @llvm.lifetime.start.p0(i64 48, ptr nonnull %8) #6, !dbg !412
  call void @gsl_matrix_submatrix(ptr dead_on_unwind nonnull writable sret(%struct._gsl_matrix_view) align 8 %8, ptr noundef nonnull %1, i64 noundef %169, i64 noundef %169, i64 noundef %170, i64 noundef %170) #6, !dbg !413
  %171 = fneg double %168, !dbg !414
  %172 = call i32 @gsl_blas_dsyr(i32 noundef 122, double noundef %171, ptr noundef nonnull %7, ptr noundef nonnull %8) #6, !dbg !415
  %173 = call i32 @gsl_vector_scale(ptr noundef nonnull %7, double noundef %168) #6, !dbg !416
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %8) #6, !dbg !417
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %7) #6, !dbg !417
  br label %174, !dbg !418

174:                                              ; preds = %161, %159
  %175 = phi i64 [ %160, %159 ], [ %169, %161 ], !dbg !393
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %5) #6, !dbg !419
...
177:                                              ; preds = %174, %22
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %4) #6, !dbg !422
  br label %178
...
9:                                                ; preds = %4
  tail call void @gsl_error(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 164, i32 noundef 20) #6, !dbg !447
  br label %25, !dbg !447
...
13:                                               ; preds = %10
  tail call void @gsl_error(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, i32 noundef 168, i32 noundef 19) #6, !dbg !453
  br label %25, !dbg !453
...
17:                                               ; preds = %14
  tail call void @gsl_error(ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.1, i32 noundef 172, i32 noundef 19) #6, !dbg !461
  br label %25, !dbg !461
...
21:                                               ; preds = %18
  tail call void @gsl_error(ptr noundef nonnull @.str.4, ptr noundef nonnull @.str.1, i32 noundef 176, i32 noundef 19) #6, !dbg !467
  br label %25, !dbg !467

22:                                               ; preds = %18
  %23 = tail call i32 @gsl_vector_memcpy(ptr noundef nonnull %3, ptr noundef nonnull %2) #6, !dbg !470
...
9:                                                ; preds = %3
  tail call void @gsl_error(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 197, i32 noundef 20) #6, !dbg !508
  br label %24, !dbg !508
...
13:                                               ; preds = %10
  tail call void @gsl_error(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, i32 noundef 201, i32 noundef 19) #6, !dbg !514
  br label %24, !dbg !514
...
17:                                               ; preds = %14
  tail call void @gsl_error(ptr noundef nonnull @.str.4, ptr noundef nonnull @.str.1, i32 noundef 205, i32 noundef 19) #6, !dbg !520
  br label %24, !dbg !520

18:                                               ; preds = %14
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %4) #6, !dbg !523
  call void @gsl_matrix_const_diagonal(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_const_view) align 8 %4, ptr noundef nonnull %0) #6, !dbg !524
  %19 = call i32 @gsl_permute_vector(ptr noundef nonnull %1, ptr noundef nonnull %2) #6, !dbg !525
  %20 = call i32 @gsl_blas_dtrsv(i32 noundef 122, i32 noundef 111, i32 noundef 132, ptr noundef nonnull %0, ptr noundef nonnull %2) #6, !dbg !526
  %21 = call i32 @gsl_vector_div(ptr noundef nonnull %2, ptr noundef nonnull %4) #6, !dbg !527
  %22 = call i32 @gsl_blas_dtrsv(i32 noundef 122, i32 noundef 112, i32 noundef 132, ptr noundef nonnull %0, ptr noundef nonnull %2) #6, !dbg !528
  %23 = call i32 @gsl_permute_vector_inverse(ptr noundef nonnull %1, ptr noundef nonnull %2) #6, !dbg !529
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %4) #6, !dbg !530
  br label %24
...
8:                                                ; preds = %3
  tail call void @gsl_error(ptr noundef nonnull @.str.5, ptr noundef nonnull @.str.1, i32 noundef 239, i32 noundef 20) #6, !dbg !569
  br label %26, !dbg !569
...
12:                                               ; preds = %9
  tail call void @gsl_error(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, i32 noundef 243, i32 noundef 19) #6, !dbg !575
  br label %26, !dbg !575
...
16:                                               ; preds = %13
  tail call void @gsl_error(ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.1, i32 noundef 247, i32 noundef 19) #6, !dbg !581
  br label %26, !dbg !581

17:                                               ; preds = %13
  %18 = tail call i32 @gsl_matrix_transpose_tricpy(i8 noundef signext 76, i32 noundef 0, ptr noundef nonnull %0, ptr noundef nonnull %0) #6, !dbg !584
  %19 = tail call i32 @gsl_linalg_cholesky_scale(ptr noundef nonnull %0, ptr noundef nonnull %2) #6, !dbg !585
...
21:                                               ; preds = %17
  %22 = tail call i32 @gsl_linalg_cholesky_scale_apply(ptr noundef nonnull %0, ptr noundef nonnull %2) #6, !dbg !590
...
10:                                               ; preds = %5
  tail call void @gsl_error(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 284, i32 noundef 20) #6, !dbg !628
  br label %30, !dbg !628
...
14:                                               ; preds = %11
  tail call void @gsl_error(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, i32 noundef 288, i32 noundef 19) #6, !dbg !634
  br label %30, !dbg !634
...
18:                                               ; preds = %15
  tail call void @gsl_error(ptr noundef nonnull @.str.7, ptr noundef nonnull @.str.1, i32 noundef 292, i32 noundef 19) #6, !dbg !640
  br label %30, !dbg !640
...
22:                                               ; preds = %19
  tail call void @gsl_error(ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.1, i32 noundef 296, i32 noundef 19) #6, !dbg !646
  br label %30, !dbg !646
...
26:                                               ; preds = %23
  tail call void @gsl_error(ptr noundef nonnull @.str.4, ptr noundef nonnull @.str.1, i32 noundef 300, i32 noundef 19) #6, !dbg !652
  br label %30, !dbg !652

27:                                               ; preds = %23
  %28 = tail call i32 @gsl_vector_memcpy(ptr noundef nonnull %4, ptr noundef nonnull %3) #6, !dbg !655
...
9:                                                ; preds = %4
  tail call void @gsl_error(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 322, i32 noundef 20) #6, !dbg !677
  br label %28, !dbg !677
...
13:                                               ; preds = %10
  tail call void @gsl_error(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, i32 noundef 326, i32 noundef 19) #6, !dbg !683
  br label %28, !dbg !683
...
17:                                               ; preds = %14
  tail call void @gsl_error(ptr noundef nonnull @.str.7, ptr noundef nonnull @.str.1, i32 noundef 330, i32 noundef 19) #6, !dbg !689
  br label %28, !dbg !689
...
21:                                               ; preds = %18
  tail call void @gsl_error(ptr noundef nonnull @.str.4, ptr noundef nonnull @.str.1, i32 noundef 334, i32 noundef 19) #6, !dbg !695
  br label %28, !dbg !695

22:                                               ; preds = %18
  %23 = tail call i32 @gsl_vector_mul(ptr noundef nonnull %3, ptr noundef nonnull %2) #6, !dbg !698
...
26:                                               ; preds = %22
  %27 = tail call i32 @gsl_vector_mul(ptr noundef nonnull %3, ptr noundef nonnull %2) #6, !dbg !704
  br label %28, !dbg !705

28:                                               ; preds = %26, %22, %21, %17, %13, %9
...
18:                                               ; preds = %3
  tail call void @gsl_error(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 376, i32 noundef 20) #6, !dbg !758
...
22:                                               ; preds = %19
  tail call void @gsl_error(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, i32 noundef 380, i32 noundef 19) #6, !dbg !764
...
28:                                               ; preds = %23
  tail call void @gsl_error(ptr noundef nonnull @.str.8, ptr noundef nonnull @.str.1, i32 noundef 384, i32 noundef 20) #6, !dbg !771
...
31:                                               ; preds = %29
  tail call void @gsl_error(ptr noundef nonnull @.str.9, ptr noundef nonnull @.str.1, i32 noundef 388, i32 noundef 19) #6, !dbg !776
  br label %147, !dbg !776

32:                                               ; preds = %29
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %4) #6, !dbg !779
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %5) #6, !dbg !779
  %33 = tail call i32 @gsl_matrix_memcpy(ptr noundef nonnull %2, ptr noundef nonnull %0) #6, !dbg !780
  %34 = tail call i32 @gsl_linalg_tri_lower_unit_invert(ptr noundef nonnull %2) #6, !dbg !781
...
36:                                               ; preds = %32
  tail call void @llvm.dbg.value(metadata i64 0, metadata !718, metadata !DIExpression()), !dbg !747
  %37 = tail call i32 @gsl_matrix_transpose_tricpy(i8 noundef signext 76, i32 noundef 0, ptr noundef nonnull %2, ptr noundef nonnull %2) #6, !dbg !784
...
47:                                               ; preds = %99, %38
  ...
  %55 = tail call double @sqrt(double noundef %54) #6, !dbg !795
...
115:                                              ; preds = %106
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %6) #6, !dbg !837
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %7) #6, !dbg !838
  %116 = sub i64 %14, %107, !dbg !839
  call void @gsl_matrix_subcolumn(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_view) align 8 %7, ptr noundef nonnull %2, i64 noundef %107, i64 noundef %107, i64 noundef %116) #6, !dbg !838
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %7) #6, !dbg !838
  %117 = call i32 @gsl_blas_ddot(ptr noundef nonnull %4, ptr noundef nonnull %4, ptr noundef nonnull %6) #6, !dbg !841
...
125:                                              ; preds = %115
  call void @llvm.lifetime.start.p0(i64 48, ptr nonnull %8) #6, !dbg !852
  %126 = add nuw i64 %107, 1, !dbg !853
  %127 = add i64 %116, -1, !dbg !854
  call void @gsl_matrix_submatrix(ptr dead_on_unwind nonnull writable sret(%struct._gsl_matrix_view) align 8 %8, ptr noundef nonnull %2, i64 noundef %126, i64 noundef 0, i64 noundef %127, i64 noundef %107) #6, !dbg !855
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %9) #6, !dbg !856
  call void @gsl_matrix_subcolumn(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_view) align 8 %9, ptr noundef nonnull %2, i64 noundef %107, i64 noundef %126, i64 noundef %127) #6, !dbg !856
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %9) #6, !dbg !856
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %10) #6, !dbg !858
  call void @gsl_matrix_subrow(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_view) align 8 %10, ptr noundef nonnull %2, i64 noundef %107, i64 noundef 0, i64 noundef %107) #6, !dbg !858
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %10) #6, !dbg !858
  %128 = call i32 @gsl_blas_dgemv(i32 noundef 112, double noundef 1.000000e+00, ptr noundef nonnull %8, ptr noundef nonnull %4, double noundef %113, ptr noundef nonnull %5) #6, !dbg !860
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %8) #6, !dbg !861
  br label %129, !dbg !862

129:                                              ; preds = %125, %115
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %6) #6, !dbg !863
  br label %131, !dbg !864

130:                                              ; preds = %106
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %11) #6, !dbg !865
  call void @gsl_matrix_row(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_view) align 8 %11, ptr noundef nonnull %2, i64 noundef %46) #6, !dbg !865
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %11) #6, !dbg !865
  call void @gsl_blas_dscal(double noundef %113, ptr noundef nonnull %4) #6, !dbg !868
  br label %131
...
134:                                              ; preds = %131
  %135 = call i32 @gsl_matrix_transpose_tricpy(i8 noundef signext 76, i32 noundef 0, ptr noundef nonnull %2, ptr noundef nonnull %2) #6, !dbg !784
  tail call void @llvm.dbg.value(metadata i64 0, metadata !718, metadata !DIExpression()), !dbg !747
...
136:                                              ; preds = %136, %134
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %12) #6, !dbg !875
  call void @gsl_matrix_row(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_view) align 8 %12, ptr noundef nonnull %2, i64 noundef %137) #6, !dbg !875
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %12) #6, !dbg !875
  %138 = call i32 @gsl_permute_vector_inverse(ptr noundef nonnull %1, ptr noundef nonnull %4) #6, !dbg !879
...
141:                                              ; preds = %141, %136
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %13) #6, !dbg !884
  call void @gsl_matrix_column(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_view) align 8 %13, ptr noundef nonnull %2, i64 noundef %142) #6, !dbg !884
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %13) #6, !dbg !884
  %143 = call i32 @gsl_permute_vector_inverse(ptr noundef nonnull %1, ptr noundef nonnull %4) #6, !dbg !888
...
146:                                              ; preds = %141, %36
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %5) #6, !dbg !893
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %4) #6, !dbg !893
  br label %147
...
13:                                               ; preds = %4
  tail call void @gsl_error(ptr noundef nonnull @.str.10, ptr noundef nonnull @.str.1, i32 noundef 480, i32 noundef 20) #6, !dbg !953
  br label %205, !dbg !953
...
18:                                               ; preds = %14
  tail call void @gsl_error(ptr noundef nonnull @.str.11, ptr noundef nonnull @.str.1, i32 noundef 484, i32 noundef 19) #6, !dbg !960
  br label %205, !dbg !960
...
19:                                               ; preds = %14
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %5) #6, !dbg !1002
  call void @gsl_matrix_const_diagonal(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_const_view) align 8 %5, ptr noundef nonnull %0) #6, !dbg !1003
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %6) #6, !dbg !1004
  call void @gsl_vector_subvector(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_view) align 8 %6, ptr noundef nonnull %3, i64 noundef %9, i64 noundef %9) #6, !dbg !1005
...
21:                                               ; preds = %19
  %22 = call i32 @gsl_permute_vector_inverse(ptr noundef %1, ptr noundef nonnull %6) #6, !dbg !1008
  call void @llvm.dbg.value(metadata i64 0, metadata !975, metadata !DIExpression()), !dbg !1000
  call void @llvm.dbg.value(metadata double 0.000000e+00, metadata !973, metadata !DIExpression()), !dbg !1000
  call void @llvm.dbg.value(metadata i64 0, metadata !974, metadata !DIExpression()), !dbg !1000
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %6) #6, !dbg !1009
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %5) #6, !dbg !1009
  tail call void @llvm.dbg.value(metadata double 0.000000e+00, metadata !940, metadata !DIExpression()), !dbg !946
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %7) #6, !dbg !1010
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %8) #6, !dbg !1011
  br label %201, !dbg !1012
...
34:                                               ; preds = %84, %23
  ...
  br i1 %39, label %84, label %40, !dbg !1027
...
40:                                               ; preds = %34
  ...
  br i1 %46, label %71, label %47, !dbg !1027
...
49:                                               ; preds = %49, %47
  %50 = phi i64 [ 0, %47 ], [ %68, %49 ]
  %51 = phi double [ %38, %47 ], [ %handler_result1, %49 ]
  %52 = phi i64 [ 0, %47 ], [ %69, %49 ]
  ...
  %handler_result = call double @fAddHandlerDouble(double %51, double %59), !dbg !1038
  call void @llvm.dbg.value(metadata double %handler_result, metadata !976, metadata !DIExpression()), !dbg !1025
  %60 = or disjoint i64 %50, 1, !dbg !1038
  call void @llvm.dbg.value(metadata i64 %60, metadata !974, metadata !DIExpression()), !dbg !1000
  call void @llvm.dbg.value(metadata i64 %60, metadata !974, metadata !DIExpression()), !dbg !1000
  call void @llvm.dbg.value(metadata double %handler_result, metadata !976, metadata !DIExpression()), !dbg !1025
  call void @llvm.dbg.value(metadata ptr %5, metadata !1015, metadata !DIExpression()), !dbg !1028
  call void @llvm.dbg.value(metadata i64 %60, metadata !1020, metadata !DIExpression()), !dbg !1028
  %61 = mul i64 %60, %27, !dbg !1030
  %62 = getelementptr inbounds double, ptr %25, i64 %61, !dbg !1031
  %63 = load double, ptr %62, align 8, !dbg !1031, !tbaa !343
  call void @llvm.dbg.value(metadata double %63, metadata !980, metadata !DIExpression()), !dbg !1032
  call void @llvm.dbg.value(metadata ptr %0, metadata !394, metadata !DIExpression()), !dbg !1033
  call void @llvm.dbg.value(metadata i64 %35, metadata !399, metadata !DIExpression()), !dbg !1033
  call void @llvm.dbg.value(metadata i64 %60, metadata !400, metadata !DIExpression()), !dbg !1033
  %64 = getelementptr double, ptr %44, i64 %60, !dbg !1035
  %65 = load double, ptr %64, align 8, !dbg !1035, !tbaa !343
  call void @llvm.dbg.value(metadata double %65, metadata !984, metadata !DIExpression()), !dbg !1032
  %66 = fmul double %63, %65, !dbg !1036
  %67 = fmul double %65, %66, !dbg !1037
  %handler_result1 = call double @fAddHandlerDouble(double %handler_result, double %67), !dbg !1038
  call void @llvm.dbg.value(metadata double %handler_result1, metadata !976, metadata !DIExpression()), !dbg !1025
  %68 = add nuw i64 %50, 2, !dbg !1038
  call void @llvm.dbg.value(metadata i64 %68, metadata !974, metadata !DIExpression()), !dbg !1000
  %69 = add i64 %52, 2, !dbg !1027
  %70 = icmp eq i64 %69, %48, !dbg !1027
  br i1 %70, label %71, label %49, !dbg !1027, !llvm.loop !1039

71:                                               ; preds = %49, %40
  %72 = phi double [ undef, %40 ], [ %handler_result1, %49 ]
  %73 = phi i64 [ 0, %40 ], [ %68, %49 ]
  %74 = phi double [ %38, %40 ], [ %handler_result1, %49 ]
  %75 = icmp eq i64 %45, 0, !dbg !1027
  br i1 %75, label %84, label %76, !dbg !1027

76:                                               ; preds = %71
  call void @llvm.dbg.value(metadata i64 %73, metadata !974, metadata !DIExpression()), !dbg !1000
  call void @llvm.dbg.value(metadata double %74, metadata !976, metadata !DIExpression()), !dbg !1025
  call void @llvm.dbg.value(metadata ptr %5, metadata !1015, metadata !DIExpression()), !dbg !1028
  call void @llvm.dbg.value(metadata i64 %73, metadata !1020, metadata !DIExpression()), !dbg !1028
  %77 = mul i64 %73, %27, !dbg !1030
  %78 = getelementptr inbounds double, ptr %25, i64 %77, !dbg !1031
  %79 = load double, ptr %78, align 8, !dbg !1031, !tbaa !343
  call void @llvm.dbg.value(metadata double %79, metadata !980, metadata !DIExpression()), !dbg !1032
  call void @llvm.dbg.value(metadata ptr %0, metadata !394, metadata !DIExpression()), !dbg !1033
  call void @llvm.dbg.value(metadata i64 %35, metadata !399, metadata !DIExpression()), !dbg !1033
  call void @llvm.dbg.value(metadata i64 %73, metadata !400, metadata !DIExpression()), !dbg !1033
  %80 = getelementptr double, ptr %44, i64 %73, !dbg !1035
  %81 = load double, ptr %80, align 8, !dbg !1035, !tbaa !343
  call void @llvm.dbg.value(metadata double %81, metadata !984, metadata !DIExpression()), !dbg !1032
  %82 = fmul double %79, %81, !dbg !1036
  %83 = fmul double %81, %82, !dbg !1037
  %handler_result2 = call double @fAddHandlerDouble(double %74, double %83), !dbg !1041
  call void @llvm.dbg.value(metadata double %handler_result2, metadata !976, metadata !DIExpression()), !dbg !1025
  call void @llvm.dbg.value(metadata i64 %73, metadata !974, metadata !DIExpression(DW_OP_plus_uconst, 1, DW_OP_stack_value)), !dbg !1000
  br label %84, !dbg !1041

84:                                               ; preds = %76, %71, %34
  %85 = phi double [ %38, %34 ], [ %72, %71 ], [ %handler_result2, %76 ], !dbg !1025
  call void @llvm.dbg.value(metadata ptr %6, metadata !1046, metadata !DIExpression()), !dbg !1050
  call void @llvm.dbg.value(metadata i64 %35, metadata !1047, metadata !DIExpression()), !dbg !1050
  call void @llvm.dbg.value(metadata double %85, metadata !1048, metadata !DIExpression()), !dbg !1050
  %86 = mul i64 %35, %33, !dbg !1041
  %87 = getelementptr inbounds double, ptr %31, i64 %86, !dbg !1051
  store double %85, ptr %87, align 8, !dbg !1052, !tbaa !343
  %88 = add nuw i64 %35, 1, !dbg !1053
  call void @llvm.dbg.value(metadata i64 %88, metadata !975, metadata !DIExpression()), !dbg !1000
  %89 = icmp eq i64 %88, %9, !dbg !1006
  br i1 %89, label %90, label %34, !dbg !1007, !llvm.loop !1054

90:                                               ; preds = %84
  %91 = call i32 @gsl_permute_vector_inverse(ptr noundef %1, ptr noundef nonnull %6) #6, !dbg !1008
  call void @llvm.dbg.value(metadata i64 0, metadata !975, metadata !DIExpression()), !dbg !1000
  %92 = load ptr, ptr %30, align 8, !tbaa !1013
  %93 = load i64, ptr %32, align 8, !tbaa !1014
  %94 = getelementptr inbounds %struct.gsl_vector, ptr %3, i64 0, i32 2
  %95 = getelementptr inbounds %struct.gsl_vector, ptr %3, i64 0, i32 1
  %96 = load ptr, ptr %94, align 8, !tbaa !1013
  %97 = load i64, ptr %95, align 8, !tbaa !1014
  br label %98, !dbg !1056

98:                                               ; preds = %147, %90
  %99 = phi i64 [ 0, %90 ], [ %152, %147 ]
  call void @llvm.dbg.value(metadata i64 %99, metadata !975, metadata !DIExpression()), !dbg !1000
  call void @llvm.dbg.value(metadata double 0.000000e+00, metadata !985, metadata !DIExpression()), !dbg !1057
  call void @llvm.dbg.value(metadata ptr %6, metadata !1015, metadata !DIExpression()), !dbg !1058
  call void @llvm.dbg.value(metadata i64 %99, metadata !1020, metadata !DIExpression()), !dbg !1058
  %100 = mul i64 %99, %93, !dbg !1060
  %101 = getelementptr inbounds double, ptr %92, i64 %100, !dbg !1061
  %102 = load double, ptr %101, align 8, !dbg !1061, !tbaa !343
  call void @llvm.dbg.value(metadata double %102, metadata !989, metadata !DIExpression()), !dbg !1057
  call void @llvm.dbg.value(metadata i64 0, metadata !974, metadata !DIExpression()), !dbg !1000
  %103 = icmp eq i64 %99, 0, !dbg !1062
  br i1 %103, label %147, label %104, !dbg !1063

104:                                              ; preds = %98
  %105 = load ptr, ptr %28, align 8, !tbaa !325
  %106 = load i64, ptr %29, align 8, !tbaa !326
  %107 = getelementptr double, ptr %105, i64 %99, !dbg !1063
  %108 = and i64 %99, 1, !dbg !1063
  %109 = icmp eq i64 %99, 1, !dbg !1063
  br i1 %109, label %134, label %110, !dbg !1063

110:                                              ; preds = %104
  %111 = and i64 %99, -2, !dbg !1063
  br label %112, !dbg !1063

112:                                              ; preds = %112, %110
  %113 = phi i64 [ 0, %110 ], [ %131, %112 ]
  %114 = phi double [ 0.000000e+00, %110 ], [ %handler_result5, %112 ]
  %115 = phi i64 [ 0, %110 ], [ %132, %112 ]
  call void @llvm.dbg.value(metadata i64 %113, metadata !974, metadata !DIExpression()), !dbg !1000
  call void @llvm.dbg.value(metadata double %114, metadata !985, metadata !DIExpression()), !dbg !1057
  call void @llvm.dbg.value(metadata ptr %3, metadata !1064, metadata !DIExpression()), !dbg !1070
  call void @llvm.dbg.value(metadata i64 %113, metadata !1069, metadata !DIExpression()), !dbg !1070
  %116 = mul i64 %113, %97, !dbg !1072
  %117 = getelementptr inbounds double, ptr %96, i64 %116, !dbg !1073
  call void @llvm.dbg.value(metadata ptr %117, metadata !990, metadata !DIExpression()), !dbg !1074
  call void @llvm.dbg.value(metadata ptr %0, metadata !394, metadata !DIExpression()), !dbg !1075
  call void @llvm.dbg.value(metadata i64 %113, metadata !399, metadata !DIExpression()), !dbg !1075
  call void @llvm.dbg.value(metadata i64 %99, metadata !400, metadata !DIExpression()), !dbg !1075
  %118 = mul i64 %113, %106, !dbg !1077
  %119 = getelementptr double, ptr %107, i64 %118, !dbg !1078
  %120 = load double, ptr %119, align 8, !dbg !1078, !tbaa !343
  call void @llvm.dbg.value(metadata double %120, metadata !994, metadata !DIExpression()), !dbg !1074
  %121 = call double @llvm.fabs.f64(double %120), !dbg !1079
  call void @llvm.dbg.value(metadata double %121, metadata !995, metadata !DIExpression()), !dbg !1074
  %handler_result3 = call double @fAddHandlerDouble(double %114, double %121), !dbg !1080
  call void @llvm.dbg.value(metadata double %handler_result3, metadata !985, metadata !DIExpression()), !dbg !1057
  %122 = load double, ptr %117, align 8, !dbg !1080, !tbaa !343
  %handler_result4 = call double @fAddHandlerDouble(double %122, double %121), !dbg !1080
  store double %handler_result4, ptr %117, align 8, !dbg !1080, !tbaa !343
  %123 = or disjoint i64 %113, 1, !dbg !1081
  call void @llvm.dbg.value(metadata i64 %123, metadata !974, metadata !DIExpression()), !dbg !1000
  call void @llvm.dbg.value(metadata i64 %123, metadata !974, metadata !DIExpression()), !dbg !1000
  call void @llvm.dbg.value(metadata double %handler_result3, metadata !985, metadata !DIExpression()), !dbg !1057
  call void @llvm.dbg.value(metadata ptr %3, metadata !1064, metadata !DIExpression()), !dbg !1070
  call void @llvm.dbg.value(metadata i64 %123, metadata !1069, metadata !DIExpression()), !dbg !1070
  %124 = mul i64 %123, %97, !dbg !1072
  %125 = getelementptr inbounds double, ptr %96, i64 %124, !dbg !1073
  call void @llvm.dbg.value(metadata ptr %125, metadata !990, metadata !DIExpression()), !dbg !1074
  call void @llvm.dbg.value(metadata ptr %0, metadata !394, metadata !DIExpression()), !dbg !1075
  call void @llvm.dbg.value(metadata i64 %123, metadata !399, metadata !DIExpression()), !dbg !1075
  call void @llvm.dbg.value(metadata i64 %99, metadata !400, metadata !DIExpression()), !dbg !1075
  %126 = mul i64 %123, %106, !dbg !1077
  %127 = getelementptr double, ptr %107, i64 %126, !dbg !1078
  %128 = load double, ptr %127, align 8, !dbg !1078, !tbaa !343
  call void @llvm.dbg.value(metadata double %128, metadata !994, metadata !DIExpression()), !dbg !1074
  %129 = call double @llvm.fabs.f64(double %128), !dbg !1079
  call void @llvm.dbg.value(metadata double %129, metadata !995, metadata !DIExpression()), !dbg !1074
  %handler_result5 = call double @fAddHandlerDouble(double %handler_result3, double %129), !dbg !1080
  call void @llvm.dbg.value(metadata double %handler_result5, metadata !985, metadata !DIExpression()), !dbg !1057
  %130 = load double, ptr %125, align 8, !dbg !1080, !tbaa !343
  %handler_result6 = call double @fAddHandlerDouble(double %130, double %129), !dbg !1080
  store double %handler_result6, ptr %125, align 8, !dbg !1080, !tbaa !343
  %131 = add nuw i64 %113, 2, !dbg !1081
  call void @llvm.dbg.value(metadata i64 %131, metadata !974, metadata !DIExpression()), !dbg !1000
  %132 = add i64 %115, 2, !dbg !1063
  %133 = icmp eq i64 %132, %111, !dbg !1063
  br i1 %133, label %134, label %112, !dbg !1063, !llvm.loop !1082

134:                                              ; preds = %112, %104
  %135 = phi double [ undef, %104 ], [ %handler_result5, %112 ]
  %136 = phi i64 [ 0, %104 ], [ %131, %112 ]
  %137 = phi double [ 0.000000e+00, %104 ], [ %handler_result5, %112 ]
  %138 = icmp eq i64 %108, 0, !dbg !1063
  br i1 %138, label %147, label %139, !dbg !1063

139:                                              ; preds = %134
  call void @llvm.dbg.value(metadata i64 %136, metadata !974, metadata !DIExpression()), !dbg !1000
  call void @llvm.dbg.value(metadata double %137, metadata !985, metadata !DIExpression()), !dbg !1057
  call void @llvm.dbg.value(metadata ptr %3, metadata !1064, metadata !DIExpression()), !dbg !1070
  call void @llvm.dbg.value(metadata i64 %136, metadata !1069, metadata !DIExpression()), !dbg !1070
  %140 = mul i64 %136, %97, !dbg !1072
  %141 = getelementptr inbounds double, ptr %96, i64 %140, !dbg !1073
  call void @llvm.dbg.value(metadata ptr %141, metadata !990, metadata !DIExpression()), !dbg !1074
  call void @llvm.dbg.value(metadata ptr %0, metadata !394, metadata !DIExpression()), !dbg !1075
  call void @llvm.dbg.value(metadata i64 %136, metadata !399, metadata !DIExpression()), !dbg !1075
  call void @llvm.dbg.value(metadata i64 %99, metadata !400, metadata !DIExpression()), !dbg !1075
  %142 = mul i64 %136, %106, !dbg !1077
  %143 = getelementptr double, ptr %107, i64 %142, !dbg !1078
  %144 = load double, ptr %143, align 8, !dbg !1078, !tbaa !343
  call void @llvm.dbg.value(metadata double %144, metadata !994, metadata !DIExpression()), !dbg !1074
  %145 = call double @llvm.fabs.f64(double %144), !dbg !1079
  call void @llvm.dbg.value(metadata double %145, metadata !995, metadata !DIExpression()), !dbg !1074
  %handler_result7 = call double @fAddHandlerDouble(double %137, double %145), !dbg !1080
  call void @llvm.dbg.value(metadata double %handler_result7, metadata !985, metadata !DIExpression()), !dbg !1057
  %146 = load double, ptr %141, align 8, !dbg !1080, !tbaa !343
  %handler_result8 = call double @fAddHandlerDouble(double %146, double %145), !dbg !1080
  store double %handler_result8, ptr %141, align 8, !dbg !1080, !tbaa !343
  call void @llvm.dbg.value(metadata i64 %136, metadata !974, metadata !DIExpression(DW_OP_plus_uconst, 1, DW_OP_stack_value)), !dbg !1000
  br label %147, !dbg !1084

147:                                              ; preds = %139, %134, %98
  %148 = phi double [ 0.000000e+00, %98 ], [ %135, %134 ], [ %handler_result7, %139 ], !dbg !1057
  %149 = call double @llvm.fabs.f64(double %102), !dbg !1084
  %handler_result9 = call double @fAddHandlerDouble(double %149, double %148), !dbg !1085
  call void @llvm.dbg.value(metadata ptr %3, metadata !1046, metadata !DIExpression()), !dbg !1087
  call void @llvm.dbg.value(metadata i64 %99, metadata !1047, metadata !DIExpression()), !dbg !1087
  call void @llvm.dbg.value(metadata double %handler_result9, metadata !1048, metadata !DIExpression()), !dbg !1087
  %150 = mul i64 %99, %97, !dbg !1085
  %151 = getelementptr inbounds double, ptr %96, i64 %150, !dbg !1088
  store double %handler_result9, ptr %151, align 8, !dbg !1089, !tbaa !343
  %152 = add nuw i64 %99, 1, !dbg !1090
  call void @llvm.dbg.value(metadata i64 %152, metadata !975, metadata !DIExpression()), !dbg !1000
  %153 = icmp eq i64 %152, %9, !dbg !1091
  br i1 %153, label %154, label %98, !dbg !1056, !llvm.loop !1092

154:                                              ; preds = %147
  %155 = and i64 %9, 1, !dbg !1094
  %156 = icmp eq i64 %9, 1, !dbg !1094
  br i1 %156, label %177, label %157, !dbg !1094

157:                                              ; preds = %154
  %158 = and i64 %9, -2, !dbg !1094
  br label %159, !dbg !1094

159:                                              ; preds = %159, %157
  %160 = phi double [ 0.000000e+00, %157 ], [ %173, %159 ]
  %161 = phi i64 [ 0, %157 ], [ %174, %159 ]
  %162 = phi i64 [ 0, %157 ], [ %175, %159 ]
  call void @llvm.dbg.value(metadata double %160, metadata !973, metadata !DIExpression()), !dbg !1000
  call void @llvm.dbg.value(metadata i64 %161, metadata !974, metadata !DIExpression()), !dbg !1000
  call void @llvm.dbg.value(metadata ptr %3, metadata !1015, metadata !DIExpression()), !dbg !1095
  call void @llvm.dbg.value(metadata i64 %161, metadata !1020, metadata !DIExpression()), !dbg !1095
  %163 = mul i64 %161, %97, !dbg !1097
  %164 = getelementptr inbounds double, ptr %96, i64 %163, !dbg !1098
  %165 = load double, ptr %164, align 8, !dbg !1098, !tbaa !343
  call void @llvm.dbg.value(metadata double %165, metadata !996, metadata !DIExpression()), !dbg !1099
  %166 = fcmp ogt double %160, %165, !dbg !1100
  %167 = select i1 %166, double %160, double %165, !dbg !1100
  call void @llvm.dbg.value(metadata double %167, metadata !973, metadata !DIExpression()), !dbg !1000
  %168 = or disjoint i64 %161, 1, !dbg !1101
  call void @llvm.dbg.value(metadata i64 %168, metadata !974, metadata !DIExpression()), !dbg !1000
  call void @llvm.dbg.value(metadata double %167, metadata !973, metadata !DIExpression()), !dbg !1000
  call void @llvm.dbg.value(metadata i64 %168, metadata !974, metadata !DIExpression()), !dbg !1000
  call void @llvm.dbg.value(metadata ptr %3, metadata !1015, metadata !DIExpression()), !dbg !1095
  call void @llvm.dbg.value(metadata i64 %168, metadata !1020, metadata !DIExpression()), !dbg !1095
  %169 = mul i64 %168, %97, !dbg !1097
  %170 = getelementptr inbounds double, ptr %96, i64 %169, !dbg !1098
  %171 = load double, ptr %170, align 8, !dbg !1098, !tbaa !343
  call void @llvm.dbg.value(metadata double %171, metadata !996, metadata !DIExpression()), !dbg !1099
  %172 = fcmp ogt double %167, %171, !dbg !1100
  %173 = select i1 %172, double %167, double %171, !dbg !1100
  call void @llvm.dbg.value(metadata double %173, metadata !973, metadata !DIExpression()), !dbg !1000
  %174 = add nuw i64 %161, 2, !dbg !1101
  call void @llvm.dbg.value(metadata i64 %174, metadata !974, metadata !DIExpression()), !dbg !1000
  %175 = add i64 %162, 2, !dbg !1094
  %176 = icmp eq i64 %175, %158, !dbg !1094
  br i1 %176, label %177, label %159, !dbg !1094, !llvm.loop !1102

177:                                              ; preds = %159, %154
  %178 = phi double [ undef, %154 ], [ %173, %159 ]
  %179 = phi double [ 0.000000e+00, %154 ], [ %173, %159 ]
  %180 = phi i64 [ 0, %154 ], [ %174, %159 ]
  %181 = icmp eq i64 %155, 0, !dbg !1094
  br i1 %181, label %188, label %182, !dbg !1094

182:                                              ; preds = %177
  call void @llvm.dbg.value(metadata double %179, metadata !973, metadata !DIExpression()), !dbg !1000
  call void @llvm.dbg.value(metadata i64 %180, metadata !974, metadata !DIExpression()), !dbg !1000
  call void @llvm.dbg.value(metadata ptr %3, metadata !1015, metadata !DIExpression()), !dbg !1095
  call void @llvm.dbg.value(metadata i64 %180, metadata !1020, metadata !DIExpression()), !dbg !1095
  %183 = mul i64 %180, %97, !dbg !1097
  %184 = getelementptr inbounds double, ptr %96, i64 %183, !dbg !1098
  %185 = load double, ptr %184, align 8, !dbg !1098, !tbaa !343
  call void @llvm.dbg.value(metadata double %185, metadata !996, metadata !DIExpression()), !dbg !1099
  %186 = fcmp ogt double %179, %185, !dbg !1100
  %187 = select i1 %186, double %179, double %185, !dbg !1100
  call void @llvm.dbg.value(metadata double %187, metadata !973, metadata !DIExpression()), !dbg !1000
  call void @llvm.dbg.value(metadata i64 %180, metadata !974, metadata !DIExpression(DW_OP_plus_uconst, 1, DW_OP_stack_value)), !dbg !1000
  br label %188, !dbg !1009

188:                                              ; preds = %182, %177
  %189 = phi double [ %178, %177 ], [ %187, %182 ], !dbg !1100
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %6) #6, !dbg !1009
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %5) #6, !dbg !1009
  tail call void @llvm.dbg.value(metadata double %189, metadata !940, metadata !DIExpression()), !dbg !946
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %7) #6, !dbg !1010
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %8) #6, !dbg !1011
  store double 0.000000e+00, ptr %2, align 8, !dbg !1104, !tbaa !343
  %190 = fcmp oeq double %189, 0.000000e+00, !dbg !1105
  br i1 %190, label %203, label %191, !dbg !1012

191:                                              ; preds = %188
  store ptr %0, ptr %8, align 8, !dbg !1107, !tbaa !1108, !DIAssignID !1110
  call void @llvm.dbg.assign(metadata ptr %0, metadata !942, metadata !DIExpression(DW_OP_LLVM_fragment, 0, 64), metadata !1110, metadata ptr %8, metadata !DIExpression()), !dbg !946
  %192 = getelementptr inbounds %struct.pcholesky_params, ptr %8, i64 0, i32 1, !dbg !1111
  store ptr %1, ptr %192, align 8, !dbg !1112, !tbaa !1113, !DIAssignID !1114
  call void @llvm.dbg.assign(metadata ptr %1, metadata !942, metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64), metadata !1114, metadata ptr %192, metadata !DIExpression()), !dbg !946
  %193 = call i32 @gsl_linalg_invnorm1(i64 noundef %9, ptr noundef nonnull @cholesky_LDLT_Ainv, ptr noundef nonnull %8, ptr noundef nonnull %7, ptr noundef nonnull %3) #6, !dbg !1115
  tail call void @llvm.dbg.value(metadata i32 %193, metadata !936, metadata !DIExpression()), !dbg !946
  %194 = icmp eq i32 %193, 0, !dbg !1116
  br i1 %194, label %195, label %203, !dbg !1118

195:                                              ; preds = %191
  %196 = load double, ptr %7, align 8, !dbg !1119, !tbaa !343
  %197 = fcmp une double %196, 0.000000e+00, !dbg !1121
  br i1 %197, label %198, label %203, !dbg !1122

198:                                              ; preds = %195
  %199 = fdiv double 1.000000e+00, %189, !dbg !1123
  %200 = fdiv double %199, %196, !dbg !1124
  br label %201, !dbg !1125

201:                                              ; preds = %198, %21
  %202 = phi double [ 0.000000e+00, %21 ], [ %200, %198 ]
  store double %202, ptr %2, align 8, !dbg !946, !tbaa !343
  br label %203, !dbg !1126

203:                                              ; preds = %201, %195, %191, %188
  %204 = phi i32 [ 0, %188 ], [ %193, %191 ], [ 0, %195 ], [ 0, %201 ], !dbg !946
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %8) #6, !dbg !1126
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %7) #6, !dbg !1126
  br label %205

205:                                              ; preds = %203, %18, %13
  %206 = phi i32 [ 20, %13 ], [ 19, %18 ], [ %204, %203 ], !dbg !1127
  ret i32 %206, !dbg !1128
}

declare !dbg !1129 i32 @gsl_linalg_invnorm1(i64 noundef, ptr noundef, ptr noundef, ptr noundef, ptr noundef) local_unnamed_addr #2

; Function Attrs: nounwind uwtable
define internal noundef i32 @cholesky_LDLT_Ainv(i32 %0, ptr noundef %1, ptr nocapture noundef readonly %2) #0 !dbg !1136 {
  tail call void @llvm.dbg.value(metadata i32 poison, metadata !1138, metadata !DIExpression()), !dbg !1143
  tail call void @llvm.dbg.value(metadata ptr %1, metadata !1139, metadata !DIExpression()), !dbg !1143
  tail call void @llvm.dbg.value(metadata ptr %2, metadata !1140, metadata !DIExpression()), !dbg !1143
  tail call void @llvm.dbg.value(metadata ptr %2, metadata !1142, metadata !DIExpression()), !dbg !1143
  %4 = load ptr, ptr %2, align 8, !dbg !1144, !tbaa !1108
  %5 = getelementptr inbounds %struct.pcholesky_params, ptr %2, i64 0, i32 1, !dbg !1145
  %6 = load ptr, ptr %5, align 8, !dbg !1145, !tbaa !1113
  %7 = tail call i32 @gsl_linalg_pcholesky_svx(ptr noundef %4, ptr noundef %6, ptr noundef %1), !dbg !1146, !range !179
  tail call void @llvm.dbg.value(metadata i32 %7, metadata !1141, metadata !DIExpression()), !dbg !1143
  ret i32 %7, !dbg !1147
}

declare !dbg !1148 void @gsl_matrix_diagonal(ptr dead_on_unwind writable sret(%struct._gsl_vector_view) align 8, ptr noundef) local_unnamed_addr #2

declare !dbg !1151 void @gsl_permutation_init(ptr noundef) local_unnamed_addr #2

declare !dbg !1154 void @gsl_vector_subvector(ptr dead_on_unwind writable sret(%struct._gsl_vector_view) align 8, ptr noundef, i64 noundef, i64 noundef) local_unnamed_addr #2

declare !dbg !1157 i64 @gsl_vector_max_index(ptr noundef) local_unnamed_addr #2

declare !dbg !1160 i32 @gsl_permutation_swap(ptr noundef, i64 noundef, i64 noundef) local_unnamed_addr #2

declare !dbg !1163 i32 @gsl_blas_dsyr(i32 noundef, double noundef, ptr noundef, ptr noundef) local_unnamed_addr #2

declare !dbg !1166 i32 @gsl_vector_scale(ptr noundef, double noundef) local_unnamed_addr #2
...
!1038 = !DILocation(line: 542, column: 26, scope: !982, inlinedAt: !1001)
!1039 = distinct !{!1039, !1027, !1040, !362}
!1040 = !DILocation(line: 548, column: 9, scope: !983, inlinedAt: !1001)
!1041 = !DILocation(line: 196, column: 13, scope: !1042, inlinedAt: !1049)
!1042 = distinct !DISubprogram(name: "gsl_vector_set", scope: !196, file: !196, line: 188, type: !1043, scopeLine: 189, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !63, retainedNodes: !1045)
!1043 = !DISubroutineType(types: !1044)
!1044 = !{null, !430, !190, !121}
!1045 = !{!1046, !1047, !1048}
!1046 = !DILocalVariable(name: "v", arg: 1, scope: !1042, file: !196, line: 188, type: !430)
!1047 = !DILocalVariable(name: "i", arg: 2, scope: !1042, file: !196, line: 188, type: !190)
!1048 = !DILocalVariable(name: "x", arg: 3, scope: !1042, file: !196, line: 188, type: !121)
!1049 = distinct !DILocation(line: 550, column: 7, scope: !977, inlinedAt: !1001)
!1050 = !DILocation(line: 0, scope: !1042, inlinedAt: !1049)
!1051 = !DILocation(line: 196, column: 3, scope: !1042, inlinedAt: !1049)
!1052 = !DILocation(line: 196, column: 26, scope: !1042, inlinedAt: !1049)
!1053 = !DILocation(line: 536, column: 22, scope: !978, inlinedAt: !1001)
!1054 = distinct !{!1054, !1007, !1055, !362}
!1055 = !DILocation(line: 551, column: 5, scope: !979, inlinedAt: !1001)
!1056 = !DILocation(line: 555, column: 3, scope: !988, inlinedAt: !1001)
!1057 = !DILocation(line: 0, scope: !986, inlinedAt: !1001)
!1058 = !DILocation(line: 0, scope: !1016, inlinedAt: !1059)
!1059 = distinct !DILocation(line: 558, column: 20, scope: !986, inlinedAt: !1001)
!1060 = !DILocation(line: 183, column: 20, scope: !1016, inlinedAt: !1059)
!1061 = !DILocation(line: 183, column: 10, scope: !1016, inlinedAt: !1059)
!1062 = !DILocation(line: 560, column: 21, scope: !992, inlinedAt: !1001)
!1063 = !DILocation(line: 560, column: 7, scope: !993, inlinedAt: !1001)
!1064 = !DILocalVariable(name: "v", arg: 1, scope: !1065, file: !196, line: 201, type: !430)
!1065 = distinct !DISubprogram(name: "gsl_vector_ptr", scope: !196, file: !196, line: 201, type: !1066, scopeLine: 202, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !63, retainedNodes: !1068)
!1066 = !DISubroutineType(types: !1067)
!1067 = !{!120, !430, !190}
!1068 = !{!1064, !1069}
!1069 = !DILocalVariable(name: "i", arg: 2, scope: !1065, file: !196, line: 201, type: !190)
!1070 = !DILocation(line: 0, scope: !1065, inlinedAt: !1071)
!1071 = distinct !DILocation(line: 562, column: 24, scope: !991, inlinedAt: !1001)
!1072 = !DILocation(line: 209, column: 34, scope: !1065, inlinedAt: !1071)
!1073 = !DILocation(line: 209, column: 30, scope: !1065, inlinedAt: !1071)
!1074 = !DILocation(line: 0, scope: !991, inlinedAt: !1001)
!1075 = !DILocation(line: 0, scope: !395, inlinedAt: !1076)
!1076 = distinct !DILocation(line: 563, column: 24, scope: !991, inlinedAt: !1001)
!1077 = !DILocation(line: 285, column: 20, scope: !395, inlinedAt: !1076)
!1078 = !DILocation(line: 285, column: 10, scope: !395, inlinedAt: !1076)
!1079 = !DILocation(line: 564, column: 27, scope: !991, inlinedAt: !1001)
!1080 = !DILocation(line: 567, column: 15, scope: !991, inlinedAt: !1001)
!1081 = !DILocation(line: 560, column: 26, scope: !992, inlinedAt: !1001)
!1082 = distinct !{!1082, !1063, !1083, !362}
!1083 = !DILocation(line: 568, column: 9, scope: !993, inlinedAt: !1001)
!1084 = !DILocation(line: 570, column: 37, scope: !986, inlinedAt: !1001)
!1085 = !DILocation(line: 196, column: 13, scope: !1042, inlinedAt: !1086)
!1086 = distinct !DILocation(line: 570, column: 7, scope: !986, inlinedAt: !1001)
!1087 = !DILocation(line: 0, scope: !1042, inlinedAt: !1086)
!1088 = !DILocation(line: 196, column: 3, scope: !1042, inlinedAt: !1086)
!1089 = !DILocation(line: 196, column: 26, scope: !1042, inlinedAt: !1086)
!1090 = !DILocation(line: 555, column: 22, scope: !987, inlinedAt: !1001)
!1091 = !DILocation(line: 555, column: 17, scope: !987, inlinedAt: !1001)
!1092 = distinct !{!1092, !1056, !1093, !362}
!1093 = !DILocation(line: 571, column: 5, scope: !988, inlinedAt: !1001)
!1094 = !DILocation(line: 573, column: 3, scope: !999, inlinedAt: !1001)
!1095 = !DILocation(line: 0, scope: !1016, inlinedAt: !1096)
!1096 = distinct !DILocation(line: 575, column: 19, scope: !997, inlinedAt: !1001)
!1097 = !DILocation(line: 183, column: 20, scope: !1016, inlinedAt: !1096)
!1098 = !DILocation(line: 183, column: 10, scope: !1016, inlinedAt: !1096)
!1099 = !DILocation(line: 0, scope: !997, inlinedAt: !1001)
!1100 = !DILocation(line: 576, column: 13, scope: !997, inlinedAt: !1001)
!1101 = !DILocation(line: 573, column: 22, scope: !998, inlinedAt: !1001)
!1102 = distinct !{!1102, !1094, !1103, !362}
!1103 = !DILocation(line: 577, column: 5, scope: !999, inlinedAt: !1001)
!1104 = !DILocation(line: 493, column: 14, scope: !937)
!1105 = !DILocation(line: 496, column: 17, scope: !1106)
!1106 = distinct !DILexicalBlock(scope: !937, file: !2, line: 496, column: 11)
!1107 = !DILocation(line: 499, column: 19, scope: !937)
!1108 = !{!1109, !240, i64 0}
!1109 = !{!"", !240, i64 0, !240, i64 8}
!1110 = distinct !DIAssignID()
!1111 = !DILocation(line: 500, column: 14, scope: !937)
!1112 = !DILocation(line: 500, column: 19, scope: !937)
!1113 = !{!1109, !240, i64 8}
!1114 = distinct !DIAssignID()
!1115 = !DILocation(line: 503, column: 16, scope: !937)
!1116 = !DILocation(line: 505, column: 11, scope: !1117)
!1117 = distinct !DILexicalBlock(scope: !937, file: !2, line: 505, column: 11)
!1118 = !DILocation(line: 505, column: 11, scope: !937)
!1119 = !DILocation(line: 508, column: 11, scope: !1120)
!1120 = distinct !DILexicalBlock(scope: !937, file: !2, line: 508, column: 11)
!1121 = !DILocation(line: 508, column: 20, scope: !1120)
!1122 = !DILocation(line: 508, column: 11, scope: !937)
!1123 = !DILocation(line: 509, column: 23, scope: !1120)
!1124 = !DILocation(line: 509, column: 32, scope: !1120)
!1125 = !DILocation(line: 509, column: 9, scope: !1120)
!1126 = !DILocation(line: 512, column: 5, scope: !938)
!1127 = !DILocation(line: 0, scope: !939)
!1128 = !DILocation(line: 513, column: 1, scope: !926)
!1129 = !DISubprogram(name: "gsl_linalg_invnorm1", scope: !601, file: !601, line: 717, type: !1130, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1130 = !DISubroutineType(types: !1131)
!1131 = !{!67, !190, !1132, !1135, !120, !430}
!1132 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1133, size: 64)
!1133 = !DISubroutineType(types: !1134)
!1134 = !{!67, !546, !430, !1135}
!1135 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!1136 = distinct !DISubprogram(name: "cholesky_LDLT_Ainv", scope: !2, file: !2, line: 584, type: !1133, scopeLine: 585, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !63, retainedNodes: !1137)
!1137 = !{!1138, !1139, !1140, !1141, !1142}
!1138 = !DILocalVariable(name: "TransA", arg: 1, scope: !1136, file: !2, line: 584, type: !546)
!1139 = !DILocalVariable(name: "x", arg: 2, scope: !1136, file: !2, line: 584, type: !430)
!1140 = !DILocalVariable(name: "params", arg: 3, scope: !1136, file: !2, line: 584, type: !1135)
!1141 = !DILocalVariable(name: "status", scope: !1136, file: !2, line: 586, type: !67)
!1142 = !DILocalVariable(name: "par", scope: !1136, file: !2, line: 587, type: !122)
!1143 = !DILocation(line: 0, scope: !1136)
!1144 = !DILocation(line: 591, column: 42, scope: !1136)
!1145 = !DILocation(line: 591, column: 53, scope: !1136)
!1146 = !DILocation(line: 591, column: 12, scope: !1136)
!1147 = !DILocation(line: 593, column: 3, scope: !1136)
!1148 = !DISubprogram(name: "gsl_matrix_diagonal", scope: !130, file: !130, line: 112, type: !1149, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1149 = !DISubroutineType(types: !1150)
!1150 = !{!197, !171}
!1151 = !DISubprogram(name: "gsl_permutation_init", scope: !153, file: !153, line: 51, type: !1152, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1152 = !DISubroutineType(types: !1153)
!1153 = !{null, !172}
!1154 = !DISubprogram(name: "gsl_vector_subvector", scope: !196, file: !196, line: 103, type: !1155, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1155 = !DISubroutineType(types: !1156)
!1156 = !{!197, !430, !134, !134}
!1157 = !DISubprogram(name: "gsl_vector_max_index", scope: !196, file: !196, line: 147, type: !1158, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1158 = !DISubroutineType(types: !1159)
!1159 = !{!134, !428}
!1160 = !DISubprogram(name: "gsl_permutation_swap", scope: !153, file: !153, line: 63, type: !1161, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1161 = !DISubroutineType(types: !1162)
!1162 = !{!67, !172, !190, !190}
!1163 = !DISubprogram(name: "gsl_blas_dsyr", scope: !541, file: !541, line: 293, type: !1164, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1164 = !DISubroutineType(types: !1165)
!1165 = !{!67, !544, !121, !428, !171}
!1166 = !DISubprogram(name: "gsl_vector_scale", scope: !196, file: !196, line: 155, type: !1167, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized)
