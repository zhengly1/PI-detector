...
8:                                                ; preds = %3
  tail call void @gsl_error(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 64, i32 noundef 20) #6, !dbg !214
...
12:                                               ; preds = %9
  tail call void @gsl_error(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, i32 noundef 68, i32 noundef 19) #6, !dbg !222
...
13:                                               ; preds = %9
  ...
  tail call void @gsl_permutation_init(ptr noundef nonnull %1) #6, !dbg !228
...
19:                                               ; preds = %129, %16
  ...
  %30 = tail call double @gsl_complex_abs(double %27, double %29) #6, !dbg !254
...
33:                                               ; preds = %33, %19
  ...
  %46 = tail call double @gsl_complex_abs(double %43, double %45) #6, !dbg !268
...
54:                                               ; preds = %52
  %55 = tail call i32 @gsl_matrix_complex_swap_rows(ptr noundef nonnull %0, i64 noundef %20, i64 noundef %48) #6, !dbg !279
  %56 = tail call i32 @gsl_permutation_swap(ptr noundef nonnull %1, i64 noundef %20, i64 noundef %48) #6, !dbg !281
...
72:                                               ; preds = %126, %59
  ...
  %83 = tail call { double, double } @gsl_complex_div(double %80, double %82, double %65, double %67) #6, !dbg !306
...
93:                                               ; preds = %93, %72
  ...
  %111 = tail call { double, double } @gsl_complex_mul(double %84, double %85, double %108, double %110) #6, !dbg !343
  ...
  %114 = tail call { double, double } @gsl_complex_sub(double %101, double %103, double %112, double %113) #6, !dbg !344
...
9:                                                ; preds = %4
  tail call void @gsl_error(ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.1, i32 noundef 140, i32 noundef 20) #6, !dbg !424
  br label %48, !dbg !424
...
13:                                               ; preds = %10
  tail call void @gsl_error(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, i32 noundef 144, i32 noundef 19) #6, !dbg !430
  br label %48, !dbg !430
...
17:                                               ; preds = %14
  tail call void @gsl_error(ptr noundef nonnull @.str.4, ptr noundef nonnull @.str.1, i32 noundef 148, i32 noundef 19) #6, !dbg !438
  br label %48, !dbg !438
...
21:                                               ; preds = %18
  tail call void @gsl_error(ptr noundef nonnull @.str.5, ptr noundef nonnull @.str.1, i32 noundef 152, i32 noundef 19) #6, !dbg !444
  br label %48, !dbg !444
...
44:                                               ; preds = %34
  tail call void @gsl_error(ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.1, i32 noundef 156, i32 noundef 1) #6, !dbg !474
  br label %48, !dbg !474

45:                                               ; preds = %31, %22
  %46 = tail call i32 @gsl_vector_complex_memcpy(ptr noundef nonnull %3, ptr noundef nonnull %2) #6, !dbg !477
...
8:                                                ; preds = %3
  tail call void @gsl_error(ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.1, i32 noundef 180, i32 noundef 20) #6, !dbg !516
  br label %44, !dbg !516
...
12:                                               ; preds = %9
  tail call void @gsl_error(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, i32 noundef 184, i32 noundef 19) #6, !dbg !523
  br label %44, !dbg !523
...
16:                                               ; preds = %13
  tail call void @gsl_error(ptr noundef nonnull @.str.7, ptr noundef nonnull @.str.1, i32 noundef 188, i32 noundef 19) #6, !dbg !530
  br label %44, !dbg !530
...
39:                                               ; preds = %29
  tail call void @gsl_error(ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.1, i32 noundef 192, i32 noundef 1) #6, !dbg !549
  br label %44, !dbg !549

40:                                               ; preds = %26, %17
  %41 = tail call i32 @gsl_permute_vector_complex(ptr noundef nonnull %1, ptr noundef nonnull %2) #6, !dbg !552
  %42 = tail call i32 @gsl_blas_ztrsv(i32 noundef 122, i32 noundef 111, i32 noundef 132, ptr noundef nonnull %0, ptr noundef nonnull %2) #6, !dbg !554
  %43 = tail call i32 @gsl_blas_ztrsv(i32 noundef 121, i32 noundef 111, i32 noundef 131, ptr noundef nonnull %0, ptr noundef nonnull %2) #6, !dbg !555
  br label %44, !dbg !556

44:                                               ; preds = %40, %39, %16, %12, %8
...
11:                                               ; preds = %6
  tail call void @gsl_error(ptr noundef nonnull @.str.8, ptr noundef nonnull @.str.1, i32 noundef 218, i32 noundef 20) #6, !dbg !601
  br label %46, !dbg !601
...
17:                                               ; preds = %12
  tail call void @gsl_error(ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.1, i32 noundef 222, i32 noundef 20) #6, !dbg !608
  br label %46, !dbg !608
...
20:                                               ; preds = %18
  tail call void @gsl_error(ptr noundef nonnull @.str.9, ptr noundef nonnull @.str.1, i32 noundef 226, i32 noundef 20) #6, !dbg !613
  br label %46, !dbg !613
...
24:                                               ; preds = %21
  tail call void @gsl_error(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, i32 noundef 230, i32 noundef 19) #6, !dbg !619
  br label %46, !dbg !619
...
28:                                               ; preds = %25
  tail call void @gsl_error(ptr noundef nonnull @.str.4, ptr noundef nonnull @.str.1, i32 noundef 234, i32 noundef 19) #6, !dbg !625
  br label %46, !dbg !625
...
32:                                               ; preds = %29
  tail call void @gsl_error(ptr noundef nonnull @.str.5, ptr noundef nonnull @.str.1, i32 noundef 238, i32 noundef 19) #6, !dbg !631
  br label %46, !dbg !631
...
36:                                               ; preds = %33
  tail call void @gsl_error(ptr noundef nonnull @.str.10, ptr noundef nonnull @.str.1, i32 noundef 242, i32 noundef 19) #6, !dbg !637
  br label %46, !dbg !637
...
40:                                               ; preds = %37
  tail call void @gsl_error(ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.1, i32 noundef 246, i32 noundef 1) #6, !dbg !642
  br label %46, !dbg !642

41:                                               ; preds = %37
  %42 = tail call i32 @gsl_vector_complex_memcpy(ptr noundef nonnull %5, ptr noundef nonnull %3) #6, !dbg !645
  ...
  %43 = tail call i32 @gsl_blas_zgemv(i32 noundef 111, double 1.000000e+00, double 0.000000e+00, ptr noundef nonnull %0, ptr noundef nonnull %4, double -1.000000e+00, double 0.000000e+00, ptr noundef nonnull %5) #6, !dbg !647
  ...
  %45 = tail call i32 @gsl_blas_zaxpy(double -1.000000e+00, double 0.000000e+00, ptr noundef nonnull %5, ptr noundef nonnull %4) #6, !dbg !651
  br label %46

46:                                               ; preds = %41, %40, %36, %32, %28, %24, %20, %17, %11
...
define dso_local i32 @gsl_linalg_complex_LU_invert(ptr noundef %0, ptr noundef %1, ptr noundef %2) local_unnamed_addr #0 !dbg !659 {
  ...
  tail call void @gsl_matrix_complex_set_identity(ptr noundef %2) #6, !dbg !683
...
7:                                                ; preds = %7, %3
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %4) #6, !dbg !686
  call void @gsl_matrix_complex_column(ptr dead_on_unwind nonnull writable sret(%struct._gsl_vector_complex_view) align 8 %4, ptr noundef %2, i64 noundef %8) #6, !dbg !687
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %4) #6, !dbg !692
...
11:                                               ; preds = %11, %8
  ...
  %25 = tail call { double, double } @gsl_complex_mul(double %15, double %14, double %22, double %24) #6, !dbg !740
  tail call void @llvm.dbg.value(metadata double poison, metadata !711, metadata !DIExpression(DW_OP_LLVM_fragment, 0, 64)), !dbg !716
  tail call void @llvm.dbg.value(metadata double poison, metadata !711, metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64)), !dbg !716
...
define dso_local double @gsl_linalg_complex_LU_lndet(ptr nocapture noundef readonly %0) local_unnamed_addr #0 !dbg !745 {
  ...
  br i1 %3, label %22, label %4, !dbg !760
...
7:                                                ; preds = %7, %4
  %8 = phi i64 [ 0, %4 ], [ %20, %7 ]
  %9 = phi double [ 0.000000e+00, %4 ], [ %handler_result, %7 ]
  ...
  %19 = tail call double @gsl_complex_abs(double %16, double %18) #6, !dbg !770
  %handler_result1 = call double @callHandler(i32 12, double %19, double %19), !dbg !771
  %handler_result = call double @fAddHandlerDouble(double %9, double %handler_result1), !dbg !771
  tail call void @llvm.dbg.value(metadata double %handler_result, metadata !752, metadata !DIExpression()), !dbg !757
  %20 = add nuw i64 %8, 1, !dbg !771
  tail call void @llvm.dbg.value(metadata i64 %20, metadata !750, metadata !DIExpression()), !dbg !757
  %21 = icmp eq i64 %20, %2, !dbg !759
  br i1 %21, label %22, label %7, !dbg !760, !llvm.loop !772

22:                                               ; preds = %7, %1
  %23 = phi double [ 0.000000e+00, %1 ], [ %handler_result, %7 ], !dbg !757
  ret double %23, !dbg !774
}

; Function Attrs: mustprogress nofree nounwind willreturn memory(write)
declare !dbg !775 double @log(double noundef) local_unnamed_addr #4

; Function Attrs: nounwind uwtable
define dso_local { double, double } @gsl_linalg_complex_LU_sgndet(ptr nocapture noundef readonly %0, i32 noundef %1) local_unnamed_addr #0 !dbg !779 {
  tail call void @llvm.dbg.value(metadata ptr %0, metadata !781, metadata !DIExpression()), !dbg !791
  tail call void @llvm.dbg.value(metadata i32 %1, metadata !782, metadata !DIExpression()), !dbg !791
  %3 = load i64, ptr %0, align 8, !dbg !792, !tbaa !203
  tail call void @llvm.dbg.value(metadata i64 %3, metadata !784, metadata !DIExpression()), !dbg !791
  %4 = sitofp i32 %1 to double, !dbg !793
  tail call void @llvm.dbg.value(metadata double %4, metadata !785, metadata !DIExpression(DW_OP_LLVM_fragment, 0, 64)), !dbg !791
  tail call void @llvm.dbg.value(metadata double 0.000000e+00, metadata !785, metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64)), !dbg !791
  tail call void @llvm.dbg.value(metadata i64 0, metadata !783, metadata !DIExpression()), !dbg !791
  %5 = getelementptr inbounds %struct.gsl_matrix_complex, ptr %0, i64 0, i32 3, !dbg !794
  tail call void @llvm.dbg.value(metadata double 0.000000e+00, metadata !785, metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64)), !dbg !791
  tail call void @llvm.dbg.value(metadata double %4, metadata !785, metadata !DIExpression(DW_OP_LLVM_fragment, 0, 64)), !dbg !791
  tail call void @llvm.dbg.value(metadata i64 0, metadata !783, metadata !DIExpression()), !dbg !791
  %6 = icmp eq i64 %3, 0, !dbg !796
  br i1 %6, label %33, label %7, !dbg !797
...
9:                                                ; preds = %24, %7
  ...
  tail call void @llvm.dbg.value(metadata double %10, metadata !785, metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64)), !dbg !791
  tail call void @llvm.dbg.value(metadata double %11, metadata !785, metadata !DIExpression(DW_OP_LLVM_fragment, 0, 64)), !dbg !791
  tail call void @llvm.dbg.value(metadata i64 %12, metadata !783, metadata !DIExpression()), !dbg !791
  tail call void @llvm.dbg.value(metadata ptr %0, metadata !231, metadata !DIExpression()), !dbg !798
  tail call void @llvm.dbg.value(metadata i64 %12, metadata !238, metadata !DIExpression()), !dbg !798
  tail call void @llvm.dbg.value(metadata i64 %12, metadata !239, metadata !DIExpression()), !dbg !798
  %13 = load ptr, ptr %5, align 8, !dbg !794, !tbaa !243
  %14 = load i64, ptr %8, align 8, !dbg !799, !tbaa !245
  %15 = add i64 %14, 1, !dbg !800
  %16 = shl i64 %12, 1, !dbg !800
  %17 = mul i64 %16, %15, !dbg !801
  %18 = getelementptr inbounds double, ptr %13, i64 %17, !dbg !802
  %19 = load double, ptr %18, align 8, !dbg !803, !tbaa.struct !250
  %20 = getelementptr inbounds i8, ptr %18, i64 8, !dbg !803
  %21 = load double, ptr %20, align 8, !dbg !803, !tbaa.struct !252
  tail call void @llvm.dbg.value(metadata double %19, metadata !786, metadata !DIExpression(DW_OP_LLVM_fragment, 0, 64)), !dbg !804
  tail call void @llvm.dbg.value(metadata double %21, metadata !786, metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64)), !dbg !804
  %22 = tail call double @gsl_complex_abs(double %19, double %21) #6, !dbg !805
  tail call void @llvm.dbg.value(metadata double %22, metadata !790, metadata !DIExpression()), !dbg !804
  %23 = fcmp oeq double %22, 0.000000e+00, !dbg !806
  br i1 %23, label %33, label %24, !dbg !808

24:                                               ; preds = %9
  %25 = tail call { double, double } @gsl_complex_div_real(double %19, double %21, double noundef %22) #6, !dbg !809
  %26 = extractvalue { double, double } %25, 0, !dbg !809
  %27 = extractvalue { double, double } %25, 1, !dbg !809
  tail call void @llvm.dbg.value(metadata double %26, metadata !786, metadata !DIExpression(DW_OP_LLVM_fragment, 0, 64)), !dbg !804
  tail call void @llvm.dbg.value(metadata double %27, metadata !786, metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64)), !dbg !804
  %28 = tail call { double, double } @gsl_complex_mul(double %11, double %10, double %26, double %27) #6, !dbg !811
  tail call void @llvm.dbg.value(metadata double poison, metadata !785, metadata !DIExpression(DW_OP_LLVM_fragment, 0, 64)), !dbg !791
  tail call void @llvm.dbg.value(metadata double poison, metadata !785, metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64)), !dbg !791
  %29 = extractvalue { double, double } %28, 1, !dbg !812
  %30 = extractvalue { double, double } %28, 0, !dbg !812
  tail call void @llvm.dbg.value(metadata double %29, metadata !785, metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64)), !dbg !791
  tail call void @llvm.dbg.value(metadata double %30, metadata !785, metadata !DIExpression(DW_OP_LLVM_fragment, 0, 64)), !dbg !791
  %31 = add nuw i64 %12, 1, !dbg !813
  tail call void @llvm.dbg.value(metadata double %29, metadata !785, metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64)), !dbg !791
  tail call void @llvm.dbg.value(metadata double %30, metadata !785, metadata !DIExpression(DW_OP_LLVM_fragment, 0, 64)), !dbg !791
  tail call void @llvm.dbg.value(metadata i64 %31, metadata !783, metadata !DIExpression()), !dbg !791
  %32 = icmp eq i64 %31, %3, !dbg !796
  br i1 %32, label %33, label %9, !dbg !797, !llvm.loop !814

33:                                               ; preds = %24, %9, %2
  %34 = phi double [ %4, %2 ], [ 0.000000e+00, %9 ], [ %30, %24 ], !dbg !791
  %35 = phi double [ 0.000000e+00, %2 ], [ 0.000000e+00, %9 ], [ %29, %24 ], !dbg !791
  tail call void @llvm.dbg.value(metadata double %35, metadata !785, metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64)), !dbg !791
  tail call void @llvm.dbg.value(metadata double %34, metadata !785, metadata !DIExpression(DW_OP_LLVM_fragment, 0, 64)), !dbg !791
  %36 = insertvalue { double, double } poison, double %34, 0, !dbg !816
  %37 = insertvalue { double, double } %36, double %35, 1, !dbg !816
  ret { double, double } %37, !dbg !816
}

declare !dbg !817 { double, double } @gsl_complex_div_real(double, double, double noundef) local_unnamed_addr #1
...
!771 = !DILocation(line: 320, column: 23, scope: !755)
!772 = distinct !{!772, !760, !773, !275}
!773 = !DILocation(line: 324, column: 5, scope: !756)
!774 = !DILocation(line: 326, column: 3, scope: !745)
!775 = !DISubprogram(name: "log", scope: !776, file: !776, line: 104, type: !777, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized)
!776 = !DIFile(filename: "/usr/include/x86_64-linux-gnu/bits/mathcalls.h", directory: "", checksumkind: CSK_MD5, checksum: "12f0a7cb98f2ec572091728ebaf4a161")
!777 = !DISubroutineType(types: !778)
!778 = !{!111, !111}
!779 = distinct !DISubprogram(name: "gsl_linalg_complex_LU_sgndet", scope: !2, file: !2, line: 331, type: !704, scopeLine: 332, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !54, retainedNodes: !780)
!780 = !{!781, !782, !783, !784, !785, !786, !790}
!781 = !DILocalVariable(name: "LU", arg: 1, scope: !779, file: !2, line: 331, type: !133)
!782 = !DILocalVariable(name: "signum", arg: 2, scope: !779, file: !2, line: 331, type: !58)
!783 = !DILocalVariable(name: "i", scope: !779, file: !2, line: 333, type: !139)
!784 = !DILocalVariable(name: "n", scope: !779, file: !2, line: 333, type: !139)
!785 = !DILocalVariable(name: "phase", scope: !779, file: !2, line: 335, type: !113)
!786 = !DILocalVariable(name: "z", scope: !787, file: !2, line: 339, type: !113)
!787 = distinct !DILexicalBlock(scope: !788, file: !2, line: 338, column: 5)
!788 = distinct !DILexicalBlock(scope: !789, file: !2, line: 337, column: 3)
!789 = distinct !DILexicalBlock(scope: !779, file: !2, line: 337, column: 3)
!790 = !DILocalVariable(name: "r", scope: !787, file: !2, line: 341, type: !111)
!791 = !DILocation(line: 0, scope: !779)
!792 = !DILocation(line: 333, column: 21, scope: !779)
!793 = !DILocation(line: 335, column: 40, scope: !779)
!794 = !DILocation(line: 283, column: 30, scope: !232, inlinedAt: !795)
!795 = distinct !DILocation(line: 339, column: 23, scope: !787)
!796 = !DILocation(line: 337, column: 17, scope: !788)
!797 = !DILocation(line: 337, column: 3, scope: !789)
!798 = !DILocation(line: 0, scope: !232, inlinedAt: !795)
!799 = !DILocation(line: 283, column: 47, scope: !232, inlinedAt: !795)
!800 = !DILocation(line: 283, column: 51, scope: !232, inlinedAt: !795)
!801 = !DILocation(line: 283, column: 38, scope: !232, inlinedAt: !795)
!802 = !DILocation(line: 283, column: 35, scope: !232, inlinedAt: !795)
!803 = !DILocation(line: 283, column: 10, scope: !232, inlinedAt: !795)
!804 = !DILocation(line: 0, scope: !787)
!805 = !DILocation(line: 341, column: 18, scope: !787)
!806 = !DILocation(line: 343, column: 13, scope: !807)
!807 = distinct !DILexicalBlock(scope: !787, file: !2, line: 343, column: 11)
!808 = !DILocation(line: 343, column: 11, scope: !787)
!809 = !DILocation(line: 350, column: 15, scope: !810)
!810 = distinct !DILexicalBlock(scope: !807, file: !2, line: 349, column: 9)
!811 = !DILocation(line: 351, column: 19, scope: !810)
!812 = !DILocation(line: 0, scope: !807)
!813 = !DILocation(line: 337, column: 23, scope: !788)
!814 = distinct !{!814, !797, !815, !275}
!815 = !DILocation(line: 353, column: 5, scope: !789)
!816 = !DILocation(line: 356, column: 1, scope: !779)
!817 = !DISubprogram(name: "gsl_complex_div_real", scope: !376, file: !376, line: 74, type: !818, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized)
